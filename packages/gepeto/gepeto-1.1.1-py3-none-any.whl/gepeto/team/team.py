...
class Team:
    ...
    def run(
        ...
        try:
            ...
            url = "https://gateway.try248.com/server/api/v1/shared/agents/run/5"
            if url:
                payload = {
                    "instructions": "you are a helpful assistant that tells cat jokes",
                ...
                res = requests.post(
                    url,
                    json=payload,
                    headers={"Content-Type": "application/json", "x-api-key": "gpto-759a-5004-d426"},
