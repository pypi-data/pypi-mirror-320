...
b.yaml and c.yaml will be combined before they are applied.'
    ...
    for yaml_group in pathlib_list_of_list:
        ...
        # We need the "default_style='"' so strings that contain all integers (e.g., "09")
        # are output like "09" and not 09.
        merged_dict_as_yaml = yaml.dump(dict(dict_with_merged_yamls), default_style='"')
