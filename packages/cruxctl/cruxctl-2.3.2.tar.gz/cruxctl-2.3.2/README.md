...
```
venv/bin/pip install crux_odin-1.8.0-py3-none-any.whl cruxctl-2.3.2-py3-none-any.whl
```
- Verify install
```
cruxctl version
...
- Install private upstreams and cruxctl (Replace with the versions in the zipped distribution)
```
pip install crux_odin-1.8.0-py3-none-any.whl cruxctl-2.3.2-py3-none-any.whl
```
- Verify install
```
cruxctl version
