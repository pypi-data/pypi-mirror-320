...
class TestBeatsFoundation:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/songs").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/songs").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/songs").mock(side_effect=retry_handler)

        response = client.songs.with_raw_response.create(prompt="prompt")
...
class TestAsyncBeatsFoundation:
    ...
    async def test_retries_taken(
        ...
        response = await client.songs.with_raw_response.create(prompt="prompt")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.songs.with_raw_response.create(
            prompt="prompt", extra_headers={"x-stainless-retry-count": Omit()}
        )
