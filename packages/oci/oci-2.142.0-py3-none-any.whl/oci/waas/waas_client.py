...
class WaasClient(object):
    ...
    def accept_recommendations(self, waas_policy_id, protection_rule_keys, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/accept_recommendations.py.html>`__ to see an example of how to use accept_recommendations API.
        """
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_address_list_compartment(self, address_list_id, change_address_list_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/change_address_list_compartment.py.html>`__ to see an example of how to use change_address_list_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_certificate_compartment(self, certificate_id, change_certificate_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/change_certificate_compartment.py.html>`__ to see an example of how to use change_certificate_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_custom_protection_rule_compartment(self, custom_protection_rule_id, change_custom_protection_rule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/change_custom_protection_rule_compartment.py.html>`__ to see an example of how to use change_custom_protection_rule_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_waas_policy_compartment(self, waas_policy_id, change_waas_policy_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/change_waas_policy_compartment.py.html>`__ to see an example of how to use change_waas_policy_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def create_address_list(self, create_address_list_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/create_address_list.py.html>`__ to see an example of how to use create_address_list API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_certificate(self, create_certificate_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/create_certificate.py.html>`__ to see an example of how to use create_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_custom_protection_rule(self, create_custom_protection_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/create_custom_protection_rule.py.html>`__ to see an example of how to use create_custom_protection_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_waas_policy(self, create_waas_policy_details, **kwargs):
        ...
        **Note:** After sending the POST request, the new object's state will temporarily be `CREATING`. Ensure that the resource's state has changed to `ACTIVE` before use.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/create_waas_policy.py.html>`__ to see an example of how to use create_waas_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_address_list(self, address_list_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/delete_address_list.py.html>`__ to see an example of how to use delete_address_list API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['addressListId']
    ...
    def delete_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/delete_certificate.py.html>`__ to see an example of how to use delete_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
    ...
    def delete_custom_protection_rule(self, custom_protection_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/delete_custom_protection_rule.py.html>`__ to see an example of how to use delete_custom_protection_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customProtectionRuleId']
    ...
    def delete_waas_policy(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/delete_waas_policy.py.html>`__ to see an example of how to use delete_waas_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_address_list(self, address_list_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_address_list.py.html>`__ to see an example of how to use get_address_list API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['addressListId']
        resource_path = "/addressLists/{addressListId}"
    ...
    def get_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_certificate.py.html>`__ to see an example of how to use get_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
        resource_path = "/certificates/{certificateId}"
    ...
    def get_custom_protection_rule(self, custom_protection_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_custom_protection_rule.py.html>`__ to see an example of how to use get_custom_protection_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customProtectionRuleId']
        resource_path = "/customProtectionRules/{customProtectionRuleId}"
    ...
    def get_device_fingerprint_challenge(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_device_fingerprint_challenge.py.html>`__ to see an example of how to use get_device_fingerprint_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_human_interaction_challenge(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_human_interaction_challenge.py.html>`__ to see an example of how to use get_human_interaction_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_js_challenge(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_js_challenge.py.html>`__ to see an example of how to use get_js_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_policy_config(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_policy_config.py.html>`__ to see an example of how to use get_policy_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_protection_rule(self, waas_policy_id, protection_rule_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_protection_rule.py.html>`__ to see an example of how to use get_protection_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_protection_settings(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_protection_settings.py.html>`__ to see an example of how to use get_protection_settings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_waas_policy(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_waas_policy.py.html>`__ to see an example of how to use get_waas_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}"
    ...
    def get_waf_address_rate_limiting(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_waf_address_rate_limiting.py.html>`__ to see an example of how to use get_waf_address_rate_limiting API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_waf_config(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_waf_config.py.html>`__ to see an example of how to use get_waf_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_access_rules(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_access_rules.py.html>`__ to see an example of how to use list_access_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_address_lists(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_address_lists.py.html>`__ to see an example of how to use list_address_lists API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_caching_rules(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_caching_rules.py.html>`__ to see an example of how to use list_caching_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_captchas(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_captchas.py.html>`__ to see an example of how to use list_captchas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_certificates(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_certificates.py.html>`__ to see an example of how to use list_certificates API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/certificates"
    ...
    def list_custom_protection_rules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_custom_protection_rules.py.html>`__ to see an example of how to use list_custom_protection_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/customProtectionRules"
    ...
    def list_edge_subnets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_edge_subnets.py.html>`__ to see an example of how to use list_edge_subnets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_good_bots(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_good_bots.py.html>`__ to see an example of how to use list_good_bots API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_protection_rules(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_protection_rules.py.html>`__ to see an example of how to use list_protection_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_recommendations(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_recommendations.py.html>`__ to see an example of how to use list_recommendations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_threat_feeds(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_threat_feeds.py.html>`__ to see an example of how to use list_threat_feeds API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_waas_policies(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waas_policies.py.html>`__ to see an example of how to use list_waas_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/waasPolicies"
    ...
    def list_waas_policy_custom_protection_rules(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waas_policy_custom_protection_rules.py.html>`__ to see an example of how to use list_waas_policy_custom_protection_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_waf_blocked_requests(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waf_blocked_requests.py.html>`__ to see an example of how to use list_waf_blocked_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_waf_logs(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waf_logs.py.html>`__ to see an example of how to use list_waf_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_waf_requests(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waf_requests.py.html>`__ to see an example of how to use list_waf_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_waf_traffic(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_waf_traffic.py.html>`__ to see an example of how to use list_waf_traffic API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_whitelists(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_whitelists.py.html>`__ to see an example of how to use list_whitelists API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def list_work_requests(self, waas_policy_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def purge_cache(self, waas_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/purge_cache.py.html>`__ to see an example of how to use purge_cache API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
    ...
    def update_access_rules(self, waas_policy_id, access_rules, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_access_rules.py.html>`__ to see an example of how to use update_access_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/accessRules"
    ...
    def update_address_list(self, address_list_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_address_list.py.html>`__ to see an example of how to use update_address_list API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['addressListId']
        resource_path = "/addressLists/{addressListId}"
    ...
    def update_caching_rules(self, waas_policy_id, caching_rules_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_caching_rules.py.html>`__ to see an example of how to use update_caching_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/cachingRules"
    ...
    def update_captchas(self, waas_policy_id, captchas, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_captchas.py.html>`__ to see an example of how to use update_captchas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/captchas"
    ...
    def update_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_certificate.py.html>`__ to see an example of how to use update_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
        resource_path = "/certificates/{certificateId}"
    ...
    def update_custom_protection_rule(self, custom_protection_rule_id, update_custom_protection_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_custom_protection_rule.py.html>`__ to see an example of how to use update_custom_protection_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customProtectionRuleId']
        resource_path = "/customProtectionRules/{customProtectionRuleId}"
    ...
    def update_device_fingerprint_challenge(self, waas_policy_id, update_device_fingerprint_challenge_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_device_fingerprint_challenge.py.html>`__ to see an example of how to use update_device_fingerprint_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/deviceFingerprintChallenge"
    ...
    def update_good_bots(self, waas_policy_id, good_bots, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_good_bots.py.html>`__ to see an example of how to use update_good_bots API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/goodBots"
    ...
    def update_human_interaction_challenge(self, waas_policy_id, update_human_interaction_challenge_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_human_interaction_challenge.py.html>`__ to see an example of how to use update_human_interaction_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/humanInteractionChallenge"
    ...
    def update_js_challenge(self, waas_policy_id, update_js_challenge_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_js_challenge.py.html>`__ to see an example of how to use update_js_challenge API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/jsChallenge"
    ...
    def update_policy_config(self, waas_policy_id, update_policy_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_policy_config.py.html>`__ to see an example of how to use update_policy_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/policyConfig"
    ...
    def update_protection_rules(self, waas_policy_id, protection_rules, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_protection_rules.py.html>`__ to see an example of how to use update_protection_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/protectionRules"
    ...
    def update_protection_settings(self, waas_policy_id, update_protection_settings_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_protection_settings.py.html>`__ to see an example of how to use update_protection_settings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/protectionSettings"
    ...
    def update_threat_feeds(self, waas_policy_id, threat_feeds, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_threat_feeds.py.html>`__ to see an example of how to use update_threat_feeds API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/threatFeeds"
    ...
    def update_waas_policy(self, waas_policy_id, update_waas_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_waas_policy.py.html>`__ to see an example of how to use update_waas_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}"
    ...
    def update_waas_policy_custom_protection_rules(self, waas_policy_id, update_custom_protection_rules_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_waas_policy_custom_protection_rules.py.html>`__ to see an example of how to use update_waas_policy_custom_protection_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/customProtectionRules"
    ...
    def update_waf_address_rate_limiting(self, waas_policy_id, update_waf_address_rate_limiting_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_waf_address_rate_limiting.py.html>`__ to see an example of how to use update_waf_address_rate_limiting API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/addressRateLimiting"
    ...
    def update_waf_config(self, waas_policy_id, update_waf_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_waf_config.py.html>`__ to see an example of how to use update_waf_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig"
    ...
    def update_whitelists(self, waas_policy_id, whitelists, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/waas/update_whitelists.py.html>`__ to see an example of how to use update_whitelists API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['waasPolicyId']
        resource_path = "/waasPolicies/{waasPolicyId}/wafConfig/whitelists"
