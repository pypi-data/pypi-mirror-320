...
class ZprClient(object):
    ...
    def create_configuration(self, create_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/create_configuration.py.html>`__ to see an example of how to use create_configuration API.
        """
    ...
    def create_zpr_policy(self, create_zpr_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/create_zpr_policy.py.html>`__ to see an example of how to use create_zpr_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_zpr_policy(self, zpr_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/delete_zpr_policy.py.html>`__ to see an example of how to use delete_zpr_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_configuration(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/get_configuration.py.html>`__ to see an example of how to use get_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/configuration"
    ...
    def get_zpr_configuration_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/get_zpr_configuration_work_request.py.html>`__ to see an example of how to use get_zpr_configuration_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_zpr_policy(self, zpr_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/get_zpr_policy.py.html>`__ to see an example of how to use get_zpr_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zprPolicyId']
        resource_path = "/zprPolicies/{zprPolicyId}"
    ...
    def get_zpr_policy_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/get_zpr_policy_work_request.py.html>`__ to see an example of how to use get_zpr_policy_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_zpr_configuration_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_configuration_work_request_errors.py.html>`__ to see an example of how to use list_zpr_configuration_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_zpr_configuration_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_configuration_work_request_logs.py.html>`__ to see an example of how to use list_zpr_configuration_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_zpr_configuration_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_configuration_work_requests.py.html>`__ to see an example of how to use list_zpr_configuration_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_zpr_policies(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_policies.py.html>`__ to see an example of how to use list_zpr_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/zprPolicies"
    ...
    def list_zpr_policy_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_policy_work_request_errors.py.html>`__ to see an example of how to use list_zpr_policy_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_zpr_policy_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_policy_work_request_logs.py.html>`__ to see an example of how to use list_zpr_policy_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_zpr_policy_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/list_zpr_policy_work_requests.py.html>`__ to see an example of how to use list_zpr_policy_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_zpr_policy(self, zpr_policy_id, update_zpr_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/zpr/update_zpr_policy.py.html>`__ to see an example of how to use update_zpr_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['zprPolicyId']
        resource_path = "/zprPolicies/{zprPolicyId}"
