...
class OccMetricsClient(object):
    ...
    def list_metric_properties(self, namespace_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocicontrolcenter/list_metric_properties.py.html>`__ to see an example of how to use list_metric_properties API.
        """
    ...
    def list_namespaces(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocicontrolcenter/list_namespaces.py.html>`__ to see an example of how to use list_namespaces API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def request_summarized_metric_data(self, request_summarized_metric_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocicontrolcenter/request_summarized_metric_data.py.html>`__ to see an example of how to use request_summarized_metric_data API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
