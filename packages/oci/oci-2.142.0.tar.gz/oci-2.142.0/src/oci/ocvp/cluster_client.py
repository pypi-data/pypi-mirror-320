...
class ClusterClient(object):
    ...
    def create_cluster(self, create_cluster_details, **kwargs):
        ...
        **Important:** You must configure the Cluster's networking resources with the security rules detailed in `Security Rules for Oracle Cloud VMware Solution SDDCs`__. Otherwise, provisioning the SDDC will fail. The rules are based on the requirements set by VMware.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocvp/create_cluster.py.html>`__ to see an example of how to use create_cluster API.
        """
    ...
    def delete_cluster(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocvp/delete_cluster.py.html>`__ to see an example of how to use delete_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_cluster(self, cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocvp/get_cluster.py.html>`__ to see an example of how to use get_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}"
    ...
    def list_clusters(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocvp/list_clusters.py.html>`__ to see an example of how to use list_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/clusters"
    ...
    def update_cluster(self, cluster_id, update_cluster_details, **kwargs):
        ...
        **Important:** Updating a Cluster affects only certain attributes in the `Cluster`
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/ocvp/update_cluster.py.html>`__ to see an example of how to use update_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterId']
        resource_path = "/clusters/{clusterId}"
