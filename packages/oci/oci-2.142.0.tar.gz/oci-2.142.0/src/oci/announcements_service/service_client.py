...
class ServiceClient(object):
    ...
    def list_services(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/announcementsservice/list_services.py.html>`__ to see an example of how to use list_services API.
        """
