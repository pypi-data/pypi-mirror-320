...
class BlockstorageClient(object):
    ...
    def change_boot_volume_backup_compartment(self, boot_volume_backup_id, change_boot_volume_backup_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_boot_volume_backup_compartment.py.html>`__ to see an example of how to use change_boot_volume_backup_compartment API.
        """
    ...
    def change_boot_volume_compartment(self, boot_volume_id, change_boot_volume_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_boot_volume_compartment.py.html>`__ to see an example of how to use change_boot_volume_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_volume_backup_compartment(self, volume_backup_id, change_volume_backup_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_volume_backup_compartment.py.html>`__ to see an example of how to use change_volume_backup_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_volume_compartment(self, volume_id, change_volume_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_volume_compartment.py.html>`__ to see an example of how to use change_volume_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_volume_group_backup_compartment(self, volume_group_backup_id, change_volume_group_backup_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_volume_group_backup_compartment.py.html>`__ to see an example of how to use change_volume_group_backup_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_volume_group_compartment(self, volume_group_id, change_volume_group_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/change_volume_group_compartment.py.html>`__ to see an example of how to use change_volume_group_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def copy_boot_volume_backup(self, boot_volume_backup_id, copy_boot_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/copy_boot_volume_backup.py.html>`__ to see an example of how to use copy_boot_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeBackupId']
    ...
    def copy_volume_backup(self, volume_backup_id, copy_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/copy_volume_backup.py.html>`__ to see an example of how to use copy_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeBackupId']
    ...
    def copy_volume_group_backup(self, volume_group_backup_id, copy_volume_group_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/copy_volume_group_backup.py.html>`__ to see an example of how to use copy_volume_group_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupBackupId']
    ...
    def create_boot_volume(self, create_boot_volume_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_boot_volume.py.html>`__ to see an example of how to use create_boot_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_boot_volume_backup(self, create_boot_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_boot_volume_backup.py.html>`__ to see an example of how to use create_boot_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume(self, create_volume_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume.py.html>`__ to see an example of how to use create_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume_backup(self, create_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume_backup.py.html>`__ to see an example of how to use create_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume_backup_policy(self, create_volume_backup_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume_backup_policy.py.html>`__ to see an example of how to use create_volume_backup_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume_backup_policy_assignment(self, create_volume_backup_policy_assignment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume_backup_policy_assignment.py.html>`__ to see an example of how to use create_volume_backup_policy_assignment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume_group(self, create_volume_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume_group.py.html>`__ to see an example of how to use create_volume_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_volume_group_backup(self, create_volume_group_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/create_volume_group_backup.py.html>`__ to see an example of how to use create_volume_group_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_boot_volume(self, boot_volume_id, **kwargs):
        ...
        **Warning:** All data on the boot volume will be permanently lost when the boot volume is deleted.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_boot_volume.py.html>`__ to see an example of how to use delete_boot_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
    ...
    def delete_boot_volume_backup(self, boot_volume_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_boot_volume_backup.py.html>`__ to see an example of how to use delete_boot_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeBackupId']
    ...
    def delete_boot_volume_kms_key(self, boot_volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_boot_volume_kms_key.py.html>`__ to see an example of how to use delete_boot_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
    ...
    def delete_volume(self, volume_id, **kwargs):
        ...
        **Warning:** All data on the volume will be permanently lost when the volume is deleted.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume.py.html>`__ to see an example of how to use delete_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
    ...
    def delete_volume_backup(self, volume_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_backup.py.html>`__ to see an example of how to use delete_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeBackupId']
    ...
    def delete_volume_backup_policy(self, policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_backup_policy.py.html>`__ to see an example of how to use delete_volume_backup_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_volume_backup_policy_assignment(self, policy_assignment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_backup_policy_assignment.py.html>`__ to see an example of how to use delete_volume_backup_policy_assignment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_volume_group(self, volume_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_group.py.html>`__ to see an example of how to use delete_volume_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupId']
    ...
    def delete_volume_group_backup(self, volume_group_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_group_backup.py.html>`__ to see an example of how to use delete_volume_group_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupBackupId']
    ...
    def delete_volume_kms_key(self, volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/delete_volume_kms_key.py.html>`__ to see an example of how to use delete_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
    ...
    def get_block_volume_replica(self, block_volume_replica_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_block_volume_replica.py.html>`__ to see an example of how to use get_block_volume_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_boot_volume(self, boot_volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_boot_volume.py.html>`__ to see an example of how to use get_boot_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
        resource_path = "/bootVolumes/{bootVolumeId}"
    ...
    def get_boot_volume_backup(self, boot_volume_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_boot_volume_backup.py.html>`__ to see an example of how to use get_boot_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeBackupId']
        resource_path = "/bootVolumeBackups/{bootVolumeBackupId}"
    ...
    def get_boot_volume_kms_key(self, boot_volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_boot_volume_kms_key.py.html>`__ to see an example of how to use get_boot_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
        resource_path = "/bootVolumes/{bootVolumeId}/kmsKey"
    ...
    def get_boot_volume_replica(self, boot_volume_replica_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_boot_volume_replica.py.html>`__ to see an example of how to use get_boot_volume_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_volume(self, volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume.py.html>`__ to see an example of how to use get_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
        resource_path = "/volumes/{volumeId}"
    ...
    def get_volume_backup(self, volume_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_backup.py.html>`__ to see an example of how to use get_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeBackupId']
        resource_path = "/volumeBackups/{volumeBackupId}"
    ...
    def get_volume_backup_policy(self, policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_backup_policy.py.html>`__ to see an example of how to use get_volume_backup_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['policyId']
        resource_path = "/volumeBackupPolicies/{policyId}"
    ...
    def get_volume_backup_policy_asset_assignment(self, asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_backup_policy_asset_assignment.py.html>`__ to see an example of how to use get_volume_backup_policy_asset_assignment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_volume_backup_policy_assignment(self, policy_assignment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_backup_policy_assignment.py.html>`__ to see an example of how to use get_volume_backup_policy_assignment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['policyAssignmentId']
        resource_path = "/volumeBackupPolicyAssignments/{policyAssignmentId}"
    ...
    def get_volume_group(self, volume_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_group.py.html>`__ to see an example of how to use get_volume_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupId']
        resource_path = "/volumeGroups/{volumeGroupId}"
    ...
    def get_volume_group_backup(self, volume_group_backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_group_backup.py.html>`__ to see an example of how to use get_volume_group_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupBackupId']
        resource_path = "/volumeGroupBackups/{volumeGroupBackupId}"
    ...
    def get_volume_group_replica(self, volume_group_replica_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_group_replica.py.html>`__ to see an example of how to use get_volume_group_replica API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_volume_kms_key(self, volume_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/get_volume_kms_key.py.html>`__ to see an example of how to use get_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
        resource_path = "/volumes/{volumeId}/kmsKey"
    ...
    def list_block_volume_replicas(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_block_volume_replicas.py.html>`__ to see an example of how to use list_block_volume_replicas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_boot_volume_backups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_boot_volume_backups.py.html>`__ to see an example of how to use list_boot_volume_backups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_boot_volume_replicas(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_boot_volume_replicas.py.html>`__ to see an example of how to use list_boot_volume_replicas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_boot_volumes(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_boot_volumes.py.html>`__ to see an example of how to use list_boot_volumes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/bootVolumes"
    ...
    def list_volume_backup_policies(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volume_backup_policies.py.html>`__ to see an example of how to use list_volume_backup_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/volumeBackupPolicies"
    ...
    def list_volume_backups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volume_backups.py.html>`__ to see an example of how to use list_volume_backups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/volumeBackups"
    ...
    def list_volume_group_backups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volume_group_backups.py.html>`__ to see an example of how to use list_volume_group_backups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/volumeGroupBackups"
    ...
    def list_volume_group_replicas(self, availability_domain, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volume_group_replicas.py.html>`__ to see an example of how to use list_volume_group_replicas API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_volume_groups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volume_groups.py.html>`__ to see an example of how to use list_volume_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/volumeGroups"
    ...
    def list_volumes(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/list_volumes.py.html>`__ to see an example of how to use list_volumes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/volumes"
    ...
    def update_boot_volume(self, boot_volume_id, update_boot_volume_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_boot_volume.py.html>`__ to see an example of how to use update_boot_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
        resource_path = "/bootVolumes/{bootVolumeId}"
    ...
    def update_boot_volume_backup(self, boot_volume_backup_id, update_boot_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_boot_volume_backup.py.html>`__ to see an example of how to use update_boot_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeBackupId']
        resource_path = "/bootVolumeBackups/{bootVolumeBackupId}"
    ...
    def update_boot_volume_kms_key(self, boot_volume_id, update_boot_volume_kms_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_boot_volume_kms_key.py.html>`__ to see an example of how to use update_boot_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['bootVolumeId']
        resource_path = "/bootVolumes/{bootVolumeId}/kmsKey"
    ...
    def update_volume(self, volume_id, update_volume_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume.py.html>`__ to see an example of how to use update_volume API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
        resource_path = "/volumes/{volumeId}"
    ...
    def update_volume_backup(self, volume_backup_id, update_volume_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume_backup.py.html>`__ to see an example of how to use update_volume_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeBackupId']
        resource_path = "/volumeBackups/{volumeBackupId}"
    ...
    def update_volume_backup_policy(self, policy_id, update_volume_backup_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume_backup_policy.py.html>`__ to see an example of how to use update_volume_backup_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['policyId']
        resource_path = "/volumeBackupPolicies/{policyId}"
    ...
    def update_volume_group(self, volume_group_id, update_volume_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume_group.py.html>`__ to see an example of how to use update_volume_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupId']
        resource_path = "/volumeGroups/{volumeGroupId}"
    ...
    def update_volume_group_backup(self, volume_group_backup_id, update_volume_group_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume_group_backup.py.html>`__ to see an example of how to use update_volume_group_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeGroupBackupId']
        resource_path = "/volumeGroupBackups/{volumeGroupBackupId}"
    ...
    def update_volume_kms_key(self, volume_id, update_volume_kms_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/core/update_volume_kms_key.py.html>`__ to see an example of how to use update_volume_kms_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['volumeId']
        resource_path = "/volumes/{volumeId}/kmsKey"
