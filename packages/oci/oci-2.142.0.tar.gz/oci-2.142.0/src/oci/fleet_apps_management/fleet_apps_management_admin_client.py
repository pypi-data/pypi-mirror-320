...
class FleetAppsManagementAdminClient(object):
    ...
    def create_compliance_policy_rule(self, create_compliance_policy_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_compliance_policy_rule.py.html>`__ to see an example of how to use create_compliance_policy_rule API.
        """
    ...
    def create_onboarding(self, create_onboarding_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_onboarding.py.html>`__ to see an example of how to use create_onboarding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_platform_configuration(self, create_platform_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_platform_configuration.py.html>`__ to see an example of how to use create_platform_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_property(self, create_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_property.py.html>`__ to see an example of how to use create_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_compliance_policy_rule(self, compliance_policy_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_compliance_policy_rule.py.html>`__ to see an example of how to use delete_compliance_policy_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_onboarding(self, onboarding_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_onboarding.py.html>`__ to see an example of how to use delete_onboarding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_platform_configuration(self, platform_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_platform_configuration.py.html>`__ to see an example of how to use delete_platform_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_property(self, property_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_property.py.html>`__ to see an example of how to use delete_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def enable_latest_policy(self, onboarding_id, enable_latest_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/enable_latest_policy.py.html>`__ to see an example of how to use enable_latest_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onboardingId']
    ...
    def get_compliance_policy(self, compliance_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_compliance_policy.py.html>`__ to see an example of how to use get_compliance_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_compliance_policy_rule(self, compliance_policy_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_compliance_policy_rule.py.html>`__ to see an example of how to use get_compliance_policy_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compliancePolicyRuleId']
        resource_path = "/compliancePolicyRules/{compliancePolicyRuleId}"
    ...
    def get_onboarding(self, onboarding_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_onboarding.py.html>`__ to see an example of how to use get_onboarding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onboardingId']
        resource_path = "/Onboardings/{onboardingId}"
    ...
    def get_platform_configuration(self, platform_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_platform_configuration.py.html>`__ to see an example of how to use get_platform_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['platformConfigurationId']
        resource_path = "/platformConfigurations/{platformConfigurationId}"
    ...
    def get_property(self, property_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_property.py.html>`__ to see an example of how to use get_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['propertyId']
        resource_path = "/properties/{propertyId}"
    ...
    def list_compliance_policies(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_compliance_policies.py.html>`__ to see an example of how to use list_compliance_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_compliance_policy_rules(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_compliance_policy_rules.py.html>`__ to see an example of how to use list_compliance_policy_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/compliancePolicyRules"
    ...
    def list_onboarding_policies(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_onboarding_policies.py.html>`__ to see an example of how to use list_onboarding_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_onboardings(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_onboardings.py.html>`__ to see an example of how to use list_onboardings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/Onboardings"
    ...
    def list_platform_configurations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_platform_configurations.py.html>`__ to see an example of how to use list_platform_configurations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/platformConfigurations"
    ...
    def list_properties(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_properties.py.html>`__ to see an example of how to use list_properties API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/properties"
    ...
    def manage_settings(self, onboarding_id, manage_settings_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/manage_settings.py.html>`__ to see an example of how to use manage_settings API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onboardingId']
    ...
    def update_compliance_policy_rule(self, compliance_policy_rule_id, update_compliance_policy_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_compliance_policy_rule.py.html>`__ to see an example of how to use update_compliance_policy_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compliancePolicyRuleId']
        resource_path = "/compliancePolicyRules/{compliancePolicyRuleId}"
    ...
    def update_onboarding(self, onboarding_id, update_onboarding_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_onboarding.py.html>`__ to see an example of how to use update_onboarding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['onboardingId']
        resource_path = "/Onboardings/{onboardingId}"
    ...
    def update_platform_configuration(self, platform_configuration_id, update_platform_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_platform_configuration.py.html>`__ to see an example of how to use update_platform_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['platformConfigurationId']
        resource_path = "/platformConfigurations/{platformConfigurationId}"
    ...
    def update_property(self, property_id, update_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_property.py.html>`__ to see an example of how to use update_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['propertyId']
        resource_path = "/properties/{propertyId}"
