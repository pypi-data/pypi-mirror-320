...
class FleetAppsManagementMaintenanceWindowClient(object):
    ...
    def create_maintenance_window(self, create_maintenance_window_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_maintenance_window.py.html>`__ to see an example of how to use create_maintenance_window API.
        """
    ...
    def delete_maintenance_window(self, maintenance_window_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_maintenance_window.py.html>`__ to see an example of how to use delete_maintenance_window API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_maintenance_window(self, maintenance_window_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_maintenance_window.py.html>`__ to see an example of how to use get_maintenance_window API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['maintenanceWindowId']
        resource_path = "/maintenanceWindows/{maintenanceWindowId}"
    ...
    def list_maintenance_windows(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_maintenance_windows.py.html>`__ to see an example of how to use list_maintenance_windows API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/maintenanceWindows"
    ...
    def update_maintenance_window(self, maintenance_window_id, update_maintenance_window_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_maintenance_window.py.html>`__ to see an example of how to use update_maintenance_window API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['maintenanceWindowId']
        resource_path = "/maintenanceWindows/{maintenanceWindowId}"
