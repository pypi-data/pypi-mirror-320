...
class FleetAppsManagementRunbooksClient(object):
    ...
    def create_runbook(self, create_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_runbook.py.html>`__ to see an example of how to use create_runbook API.
        """
    ...
    def create_task_record(self, create_task_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/create_task_record.py.html>`__ to see an example of how to use create_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_runbook(self, runbook_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_runbook.py.html>`__ to see an example of how to use delete_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_task_record(self, task_record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/delete_task_record.py.html>`__ to see an example of how to use delete_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_runbook(self, runbook_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_runbook.py.html>`__ to see an example of how to use get_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
        resource_path = "/runbooks/{runbookId}"
    ...
    def get_task_record(self, task_record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/get_task_record.py.html>`__ to see an example of how to use get_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['taskRecordId']
        resource_path = "/taskRecords/{taskRecordId}"
    ...
    def list_runbooks(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_runbooks.py.html>`__ to see an example of how to use list_runbooks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/runbooks"
    ...
    def list_task_records(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/list_task_records.py.html>`__ to see an example of how to use list_task_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/taskRecords"
    ...
    def publish_runbook(self, publish_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/publish_runbook.py.html>`__ to see an example of how to use publish_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def set_default_runbook(self, set_default_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/set_default_runbook.py.html>`__ to see an example of how to use set_default_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_runbook(self, runbook_id, update_runbook_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_runbook.py.html>`__ to see an example of how to use update_runbook API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['runbookId']
        resource_path = "/runbooks/{runbookId}"
    ...
    def update_task_record(self, task_record_id, update_task_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.142.0/fleetappsmanagement/update_task_record.py.html>`__ to see an example of how to use update_task_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['taskRecordId']
        resource_path = "/taskRecords/{taskRecordId}"
