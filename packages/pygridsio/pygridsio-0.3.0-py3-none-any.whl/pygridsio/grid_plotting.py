...
from pygridsio.grid_to_xarray import grids_to_xarray
...
def plot_grid(grid: Grid | xr.DataArray | xr.Dataset, axes=None, outfile=None, show=False, cmap="viridis", vmin=None, vmax=None, zoom=True, zoom_buffer=10000, custom_shapefile = None, add_netherlands_shapefile=False, shapefile_alpha=0.5):
    """
...
def plot_grid_comparison(grid1, grid2, outfile, custom_shapefile=None, add_netherlands_shapefile=False, title1=None, title2=None, suptitle=None):
