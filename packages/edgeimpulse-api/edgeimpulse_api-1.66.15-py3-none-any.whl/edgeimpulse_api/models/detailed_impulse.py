...
class DetailedImpulse(BaseModel):
    ...
    __properties = ["impulse", "metrics", "dspBlockConfigs", "learnBlockKerasConfigs", "learnBlockAnomalyConfigs", "pretrainedModelInfo", "isStale", "configured", "complete", "tags", "createdFromTunerTrialId"]
