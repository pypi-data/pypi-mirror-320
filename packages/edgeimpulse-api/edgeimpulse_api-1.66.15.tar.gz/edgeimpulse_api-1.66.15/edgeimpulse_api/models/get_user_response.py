...
class GetUserResponse(BaseModel):
    ...
    __properties = ["success", "error", "id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "lastTosAcceptanceDate", "jobTitle", "permissions", "companyName", "activated", "mfaConfigured", "stripeCustomerId", "hasPendingPayments", "tier", "organizations", "projects", "experiments", "evaluation", "ambassador", "whitelabels", "suspended", "notifications", "subscriptionDowngradeDate", "subscriptionTerminationDate", "passwordConfigured", "projectsSortOrder", "activeEnterpriseTrial", "hasEnterpriseFeaturesAccess", "timezone", "lastAccessedProjects", "privatePersonalProjectsUsed"]
