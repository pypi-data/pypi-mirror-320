...
def main():
    ...
    # Debug: Log the first 500 characters of the raw content
    logger.info(f"Raw Wiktionary content fetched: {page_text[:500]}")

    # Step 4: Count tokens and split into chunks if necessary
    ...
    # Step 5: Extract morphology from each chunk
    final_data = {}
    got_any_data = False
    ...
    # Step 6: Use fallback if no data was found from Wiktionary
    if not got_any_data:
    ...
    # Step 7: Fill in missing keys if necessary
    expected_keys = [
        "part_of_speech",
        "plural_form",
        "declension",
    ...
    # Step 8: Print the final JSON output
