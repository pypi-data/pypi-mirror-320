...
class TriangesCustomConverter(ValueCollector):
    """A custom converter for a field representing a list of Triangle objects.
    This will represent the list of triangles as a numpy array and allow to serialize it
    back to a list of Triangle objects."""
...
class Build:
    ...
    items: List[Item] = xfield(doc="List of Item entries per objectid")


@xdatatree
class Model:
    """
    The model class is the root of the models part of a 3mf file.
    """
    ...
    copyright: str = xfield(aname="Copyright", doc="The copyright string - may be spelled wrong")
    copyRight: str = xfield(aname="CopyRight", doc="The copyRight string - may be spelled wrong")
    license_terms: str = xfield(doc="The license terms")
    ...
    rating: str = xfield(doc="The rating string")
    ...
    build: Build = DEFAULT_CONFIGX(ftype=Element, doc="Build info per objectid")
