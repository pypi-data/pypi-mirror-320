...
@typechecked
def appregistry_upload(app_dir: str, build_args: Dict[str, str] = {}, archs: List[str] = []) -> OperationResponse:
    """
    ...
    return _appregistry_upload(app_dir_path=app_dir, build_args=build_args, archs=archs)
