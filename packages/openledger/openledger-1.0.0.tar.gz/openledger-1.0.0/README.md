...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Faccelbooks%2Fopenledger-python-sdk)
...
```python
client.company.create_company(..., request_options={
    "max_retries": 1
})
```
