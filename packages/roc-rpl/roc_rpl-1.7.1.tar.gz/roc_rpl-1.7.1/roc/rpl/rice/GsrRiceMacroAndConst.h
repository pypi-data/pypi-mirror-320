...
/**
 * \brief Nombre de bits utilis�s pour coder FS
 */
#define ID_BITS					4
/**
 * \brief Nombre max de 'Zero_bloc' cons�cutifs, doit �tre une puissance de 2
 */
...
/**
 * \brief Masque permettant de r�cup�rer les i derniers bits
 */
...
/**
 * \brief tableau permettant l'encodage du format �tendu (#ID_LOW)\n
...
/**
 * \brief Tableau permettant le d�codage du format �tendu (#ID_LOW) en conjonction avec #ext2_array2
 */
static unsigned char ext2_array1[MAX_EXT2_SUM+1];
/**
 * \brief Tableau permettant le d�codage du format �tendu (#ID_LOW) en conjonction avec #ext2_array1
 */
