...
class GeneProcessor:
    ...
    def process_files(self, output_gff, input_seq, output_seq):
        gene_dict = self.create_gene_dict(output_gff)
        self.process_protein_file(gene_dict, input_seq, output_seq)
        print(f"Processing completed {output_seq}")
