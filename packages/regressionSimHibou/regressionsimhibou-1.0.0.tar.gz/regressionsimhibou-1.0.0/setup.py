...
setup(
   name='regressionSimHibou',  # Nom unique du package
   ...
   packages=['regressionSimHibou'],  # Assurez-vous que ce dossier existe
   url='https://github.com/votre-repo/regressionSimHibou',  # Remplacez par l'URL de votre projet (si disponible)
