...
_import_structure = {
    ...
    "online_dpo_trainer": ["OnlineFPOTrainer"],
...
try:
    ...
    _import_structure["ddpo_trainer"] = ["DFPOTrainer"]
...
if TYPE_CHECKING:
    ...
    from .fpo_dpo_trainer import FPOTrainer
    ...
    from .online_dpo_trainer import OnlineFPOTrainer
    ...
    try:
        ...
        from .ddpo_trainer import DFPOTrainer
else:
    import sys
