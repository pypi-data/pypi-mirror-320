...
export interface InitOutput {
  ...
  readonly closure283_externref_shim: (a: number, b: number, c: number, d: number) => any;
  readonly closure287_externref_shim: (a: number, b: number, c: number, d: number, e: number) => any;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he3db040121be2717: (a: number, b: number) => void;
  readonly closure293_externref_shim: (a: number, b: number, c: number) => any;
  readonly closure296_externref_shim: (a: number, b: number) => any;
