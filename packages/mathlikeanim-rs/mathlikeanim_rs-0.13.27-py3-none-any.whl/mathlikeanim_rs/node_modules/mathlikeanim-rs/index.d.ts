...
export class SVGScene {
  ...
  set3DIndex(index: number): void;
  projectAndShade(): WasmVectorObject;
  setCameraPosition(x: number, y: number, z: number): void;
  setCameraRotation(x: number, y: number, z: number): void;
  setCameraFocalDistance(focal_distance: number): void;
  get3DIndex(): number;
  getCameraPosition(): Array<any>;
  getCameraRotation(): Array<any>;
  getCameraFocalDistance(): number;
  getCameraZoom(): number;
  getLightSourcePosition(): Array<any>;
  setCameraZoom(zoom: number): void;
  setLightSourcePosition(x: number, y: number, z: number): void;
  add3D(object: WasmThreeDObject): void;
  insert3D(index: number, object: WasmThreeDObject): void;
  remove3D(index: number): void;
  get3DObjects(): Array<any>;
  set3DObjects(objects: (WasmThreeDObject)[]): void;
  set3DObject(object: WasmThreeDObject): void;
  get3DObject(): WasmThreeDObject;
}
export class Scene {
  free(): void;
  constructor(width: number, height: number, fps: number);
...
export interface InitOutput {
  ...
  readonly scene_set3DIndex: (a: number, b: number) => void;
  readonly scene_projectAndShade: (a: number) => number;
  readonly scene_setCameraPosition: (a: number, b: number, c: number, d: number) => void;
  readonly scene_setCameraRotation: (a: number, b: number, c: number, d: number) => void;
  readonly scene_setCameraFocalDistance: (a: number, b: number) => void;
  readonly scene_setCameraZoom: (a: number, b: number) => void;
  readonly scene_setLightSourcePosition: (a: number, b: number, c: number, d: number) => void;
  readonly scene_get3DIndex: (a: number) => number;
  readonly scene_getCameraPosition: (a: number) => any;
  readonly scene_getCameraRotation: (a: number) => any;
  readonly scene_getCameraFocalDistance: (a: number) => number;
  readonly scene_getCameraZoom: (a: number) => number;
  readonly scene_getLightSourcePosition: (a: number) => any;
  readonly scene_add3D: (a: number, b: number) => void;
  readonly scene_insert3D: (a: number, b: number, c: number) => void;
  readonly scene_remove3D: (a: number, b: number) => void;
  readonly scene_get3DObjects: (a: number) => any;
  readonly scene_set3DObjects: (a: number, b: number, c: number) => void;
  readonly scene_set3DObject: (a: number, b: number) => void;
  readonly scene_get3DObject: (a: number) => number;
  ...
  readonly svgscene_set3DIndex: (a: number, b: number) => void;
  readonly svgscene_projectAndShade: (a: number) => number;
  readonly svgscene_setCameraPosition: (a: number, b: number, c: number, d: number) => void;
  readonly svgscene_setCameraRotation: (a: number, b: number, c: number, d: number) => void;
  readonly svgscene_setCameraFocalDistance: (a: number, b: number) => void;
  readonly svgscene_get3DIndex: (a: number) => number;
  readonly svgscene_getCameraPosition: (a: number) => any;
  readonly svgscene_getCameraRotation: (a: number) => any;
  readonly svgscene_getCameraFocalDistance: (a: number) => number;
  readonly svgscene_getCameraZoom: (a: number) => number;
  readonly svgscene_getLightSourcePosition: (a: number) => any;
  readonly svgscene_setCameraZoom: (a: number, b: number) => void;
  readonly svgscene_setLightSourcePosition: (a: number, b: number, c: number, d: number) => void;
  readonly svgscene_add3D: (a: number, b: number) => void;
  readonly svgscene_insert3D: (a: number, b: number, c: number) => void;
  readonly svgscene_remove3D: (a: number, b: number) => void;
  readonly svgscene_get3DObjects: (a: number) => any;
  readonly svgscene_set3DObjects: (a: number, b: number, c: number) => void;
  readonly svgscene_set3DObject: (a: number, b: number) => void;
  readonly svgscene_get3DObject: (a: number) => number;
  ...
  readonly closure266_externref_shim: (a: number, b: number, c: number, d: number) => any;
  readonly closure270_externref_shim: (a: number, b: number) => any;
  readonly closure273_externref_shim: (a: number, b: number, c: number) => any;
  readonly closure276_externref_shim: (a: number, b: number, c: number, d: number, e: number) => any;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6f1f36850d647a84: (a: number, b: number) => void;
  readonly closure311_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure358_externref_shim: (a: number, b: number, c: any, d: any) => void;
