...
class Service(_message.Message):
    __slots__ = ("name", "port", "host", "callbacks")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    port: str
    host: str
    callbacks: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, name: _Optional[str] = ..., port: _Optional[str] = ..., host: _Optional[str] = ..., callbacks: _Optional[_Iterable[str]] = ...) -> None: ...
