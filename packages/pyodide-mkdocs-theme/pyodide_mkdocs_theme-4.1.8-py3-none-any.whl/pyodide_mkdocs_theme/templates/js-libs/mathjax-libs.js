...
function mathJaxUpdate(){
  LOGGER_CONFIG.ACTIVATE && jsLogger('[MathJax] - Page formatting')
...
window.MathJax = {
  startup: {
    ready: () => {
      LOGGER_CONFIG.ACTIVATE && jsLogger("[MathJax] - Setting up");
      MathJax.startup.defaultReady();
      LOGGER_CONFIG.ACTIVATE && jsLogger("[MathJax] - Ready");
      mathJaxIsReady()
      mathJaxUpdate()
    },
  },
