...
""")
    ...
    async def patch_accept_encoding_bug(request: Request, handler) -> Response:
        if request.get_first_header(b"accept-encoding") is None:
            request.headers[b"accept-encoding"] = b""
