...
from dnet.Api.graphql_queries import (CHECK_API_KEY_USAGE_QUERY,
                                      CREATE_API_KEY_MUTATION,
                                      CREATE_COMPANY_MUTATION,
                                      CREATE_USER_MUTATION, GET_API_KEYS_QUERY,
...
class ApiManager:
    ...
    def _initialize_client(self):
        """
        Initialize the GQL client with authentication headers if an API key is provided.
        """
    ...
    def _execute_graphql(self, query: str, variables: dict = None):
        ...
        try:
            ...
            print("GraphQL operation successful. Response:")
            ...
            print("Error executing GraphQL operation:")
