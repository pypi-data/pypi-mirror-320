...
class CrewAIClient:
    """
    A reusable HTTP client class for interacting with the CrewAIRouter API endpoints.
    """
    ...
    def __init__(
        ...
        """
        Initialize the CrewAIClient with a base URL, optional headers, timeout, and authentication.
