...
class CrewAIApiClient:
    """
    A reusable HTTP client class for interacting with the CrewAIApiRouter API endpoints.
    """
    ...
    def __init__(
        ...
        """
        Initialize the CrewAIApiClient with a base URL, optional headers, timeout, and authentication.

        Args:
            base_url (str): The base URL for the CrewAI API.
