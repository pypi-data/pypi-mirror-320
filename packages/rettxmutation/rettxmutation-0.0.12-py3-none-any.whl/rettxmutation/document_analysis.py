...
class RettXDocumentAnalysis:
    ...
    def extract_text(self, file_stream: BinaryIO) -> Document:
        ...
        for keyword in document.keywords:
            ...
            if confidence_value is not None:
                logger.info(f"Found {keyword} with confidence {confidence_value}")
                keyword.confidence = confidence_value
            else:
                logger.info(f"{keyword} was not found")
                keyword.confidence = 0.0
        logger.info(f"Mecp2 keyword confidence {document.keywords}")
    ...
    def summarize_and_correct(self,
        ...
        logger.info(f"OpenAI summary: {document.summary}")
        ...
        logger.info(f"TA4H: {document.text_analytics_result}")
        ...
        logger.info(f"Corrected summary: {corrected_summary}")
    ...
    def analyze_document(self,
                         file_stream: BinaryIO,
                         min_confidence: float = 0.0) -> List[GeneMutationCollection]:
            """
            ...
            try:
                ...
                return list_mutations_with_all_transcripts
