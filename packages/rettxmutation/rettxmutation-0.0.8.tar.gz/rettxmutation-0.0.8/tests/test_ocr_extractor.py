...
from src.rettxmutation.analysis.models import Document, WordData
from src.rettxmutation.analysis.ocr_extractor import OcrExtractor
...
@patch("src.rettxmutation.analysis.ocr_extractor.DocumentAnalysisClient")
