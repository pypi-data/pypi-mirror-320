...
class MutationFilter:
    ...
    def calculate_confidence_score(
        ...
        """
        logger.info("Running consolidate_confidence with separate scoring methods...")
        ...
        for mutation in mutations:
            ...
            # (C) Combine
            final_conf = (base_conf_weight / 100 * mutation.confidence) + (keyword_weight / 100 * k_conf) + (proximity_weight / 100 * p_conf)
        ...
        logger.info(f"Done. Processed {len(updated_mutations)} mutations.")
    ...
    def filter_mutations(
        ...
        """
        logger.info("Filtering mutations. Keeping duplicates with highest confidence, dropping below min_confidence.")
        ...
        logger.info(f"Filtered mutations: started with {len(mutations)}, "
