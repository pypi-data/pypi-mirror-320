...
from src.rettxmutation.analysis.models import GeneMutation
from src.rettxmutation.analysis.openai_rettx_agents import OpenAIRettXAgents, InvalidResponse


@patch("src.rettxmutation.analysis.openai_rettx_agents.AzureOpenAI")
