...
class DataLoader:
    def __init__(self, data_folder=None):
        ...
        :param data_folder: Path to the folder containing the CSV files. Defaults to the `data` folder in the package.
        """
        if data_folder is None:
            data_folder = pkg_resources.resource_filename("operationunitaire", "data")
