...
class BaseWebsite:
    ...
    def process_request(self, script: str, request_name, task_id, *args, timeout=None):
        ...
        self.browser.tab.latest_tab.run_js(request_name, script, task_id, *args, timeout=timeout)
        ...
        if http_code == 403 and "Just a moment..." in http_data:
            ...
            self.browser.tab.get(self.base_url)
            timeout_while_loop(lambda ctx:self.browser.tab.cookies().as_dict().get('cf_clearance') == old_cf_clearance, None, {}, 1*30, 2)
