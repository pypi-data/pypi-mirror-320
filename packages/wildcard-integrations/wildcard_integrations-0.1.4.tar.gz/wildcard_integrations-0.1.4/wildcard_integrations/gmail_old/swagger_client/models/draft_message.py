...
class DraftMessage(object):
    ...
    def __init__(self, history_id=None, id=None, internal_date=None, label_ids=None, payload=None, raw=None, size_estimate=None, snippet=None, thread_id=None):  # noqa: E501
        """DraftMessage - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def history_id(self):
        """Gets the history_id of this DraftMessage.  # noqa: E501

        The ID of the last history record that modified this message.  # noqa: E501

        :return: The history_id of this DraftMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def history_id(self, history_id):
        """Sets the history_id of this DraftMessage.

        The ID of the last history record that modified this message.  # noqa: E501

        :param history_id: The history_id of this DraftMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this DraftMessage.  # noqa: E501

        The immutable ID of the message.  # noqa: E501

        :return: The id of this DraftMessage.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DraftMessage.

        The immutable ID of the message.  # noqa: E501

        :param id: The id of this DraftMessage.  # noqa: E501
        :type: str
        """
    ...
    def internal_date(self):
        """Gets the internal_date of this DraftMessage.  # noqa: E501

        The internal message creation timestamp (epoch ms), which determines ordering in the inbox. For normal SMTP-received email, this represents the time the message was originally accepted by Google, which is more reliable than the `Date` header. However, for API-migrated mail, it can be configured by client to be based on the `Date` header.  # noqa: E501

        :return: The internal_date of this DraftMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_date(self, internal_date):
        """Sets the internal_date of this DraftMessage.

        The internal message creation timestamp (epoch ms), which determines ordering in the inbox. For normal SMTP-received email, this represents the time the message was originally accepted by Google, which is more reliable than the `Date` header. However, for API-migrated mail, it can be configured by client to be based on the `Date` header.  # noqa: E501

        :param internal_date: The internal_date of this DraftMessage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this DraftMessage.  # noqa: E501

        List of IDs of labels applied to this message.  # noqa: E501

        :return: The label_ids of this DraftMessage.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this DraftMessage.

        List of IDs of labels applied to this message.  # noqa: E501

        :param label_ids: The label_ids of this DraftMessage.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def payload(self):
        """Gets the payload of this DraftMessage.  # noqa: E501


        :return: The payload of this DraftMessage.  # noqa: E501
        :rtype: MessagePart
        """
    ...
    def payload(self, payload):
        """Sets the payload of this DraftMessage.


        :param payload: The payload of this DraftMessage.  # noqa: E501
        :type: MessagePart
        """
    ...
    @property
    def raw(self):
        """Gets the raw of this DraftMessage.  # noqa: E501
        ...
        :return: The raw of this DraftMessage.  # noqa: E501
        :rtype: str
        """
        return self._raw
    ...
    @raw.setter
    def raw(self, raw):
        """Sets the raw of this DraftMessage.

        REQUIRED. Always populate this field. Make this entire email message in an RFC 2822 formatted string and base64url encoded string. Returned in `messages.get` and `drafts.get` responses when the `format=byte` parameter is supplied. When creating a draft, the complete message needs to be passed in the raw parameter, see the example: From: John Doe <jdoe@machine.example> To: Mary Smith <mary@example.net> Subject: Saying Hello  Date [optional]: Fri, 21 Nov 1997 09:55:06 -0600 Message-ID [optional]: <1234@local.machine.example> ...<other RFC 2822 headers> ...  Hi Mary,  This is the body of the message.  Regards, John Doe  If you are replying to an existing message, make sure to include the `References` and `In-Reply-To` headers. See the example below: From: John Doe <jdoe@machine.example> To: Mary Smith <mary@example.net> Subject: Re: Saying Hello  References: <CADsZLRxZDUGn4Frx80qe2_bE5H5bQhgcqGk=GwFN9gs7Z_8oZw@mail.gmail.com> <CADsZLRyzVPLRQuTthGSHKMCXL7Ora1jNW7h0jvoNgR+hU59BYg@mail.gmail.com> <CADsZLRwQWzLB-uq4_4G2E64NX9G6grn0cEeO0L=avY7ajzuAFg@mail.gmail.com> In-Reply-To: <CADsZLRwQWzLB-uq4_4G2E64NX9G6grn0cEeO0L=avY7ajzuAFg@mail.gmail.com> ...<other RFC 2822 headers> ...  Hi Mary,  This is the body of the message.  Regards, John Doe   # noqa: E501

        :param raw: The raw of this DraftMessage.  # noqa: E501
        :type: str
        """
        if raw is None:
    ...
    def size_estimate(self):
        """Gets the size_estimate of this DraftMessage.  # noqa: E501

        Estimated size in bytes of the message.  # noqa: E501

        :return: The size_estimate of this DraftMessage.  # noqa: E501
        :rtype: int
        """
    ...
    def size_estimate(self, size_estimate):
        """Sets the size_estimate of this DraftMessage.

        Estimated size in bytes of the message.  # noqa: E501

        :param size_estimate: The size_estimate of this DraftMessage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def snippet(self):
        """Gets the snippet of this DraftMessage.  # noqa: E501

        A short part of the message text.  # noqa: E501

        :return: The snippet of this DraftMessage.  # noqa: E501
        :rtype: str
        """
    ...
    def snippet(self, snippet):
        """Sets the snippet of this DraftMessage.

        A short part of the message text.  # noqa: E501

        :param snippet: The snippet of this DraftMessage.  # noqa: E501
        :type: str
        """
    ...
    def thread_id(self, thread_id):
        """Sets the thread_id of this DraftMessage.

        REQUIRED if replying to an existing message. The ID of the thread the message belongs to. To add a message or draft to a thread, the following criteria must be met: 1. The requested `threadId` must be specified on the `Message` or `Draft.Message` you supply with your request. 2. The `References` and `In-Reply-To` headers must be set in compliance with the [RFC 2822](https://tools.ietf.org/html/rfc2822) standard. 3. The `Subject` headers must match.   # noqa: E501

        :param thread_id: The thread_id of this DraftMessage.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DraftMessage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DraftMessage):
            return False
