...
class BaseIdTableIdOrNameBody(object):
    ...
    def __init__(self, perform_upsert=None, return_fields_by_field_id=False, typecast=False, records=None):  # noqa: E501
        """BaseIdTableIdOrNameBody - a model defined in Swagger"""  # noqa: E501
    ...
    def perform_upsert(self):
        """Gets the perform_upsert of this BaseIdTableIdOrNameBody.  # noqa: E501


        :return: The perform_upsert of this BaseIdTableIdOrNameBody.  # noqa: E501
    ...
    def perform_upsert(self, perform_upsert):
        """Sets the perform_upsert of this BaseIdTableIdOrNameBody.


        :param perform_upsert: The perform_upsert of this BaseIdTableIdOrNameBody.  # noqa: E501
    ...
    def return_fields_by_field_id(self):
        """Gets the return_fields_by_field_id of this BaseIdTableIdOrNameBody.  # noqa: E501
        ...
        :return: The return_fields_by_field_id of this BaseIdTableIdOrNameBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def return_fields_by_field_id(self, return_fields_by_field_id):
        """Sets the return_fields_by_field_id of this BaseIdTableIdOrNameBody.

        If set to true, records in the API response will key the fields object by field ID. Defaults to false when unset, which returns fields objects keyed by field name.  # noqa: E501

        :param return_fields_by_field_id: The return_fields_by_field_id of this BaseIdTableIdOrNameBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def typecast(self):
        """Gets the typecast of this BaseIdTableIdOrNameBody.  # noqa: E501
        ...
        :return: The typecast of this BaseIdTableIdOrNameBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def typecast(self, typecast):
        """Sets the typecast of this BaseIdTableIdOrNameBody.

        If set to true, Airtable will try to convert string values into the appropriate cell value. This conversion is only performed on a best-effort basis. To ensure your data's integrity, this should only be used when necessary. Defaults to false when unset.  # noqa: E501

        :param typecast: The typecast of this BaseIdTableIdOrNameBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def records(self):
        """Gets the records of this BaseIdTableIdOrNameBody.  # noqa: E501

        Array of records to update  # noqa: E501

        :return: The records of this BaseIdTableIdOrNameBody.  # noqa: E501
    ...
    def records(self, records):
        """Sets the records of this BaseIdTableIdOrNameBody.

        Array of records to update  # noqa: E501

        :param records: The records of this BaseIdTableIdOrNameBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseIdTableIdOrNameBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseIdTableIdOrNameBody):
            return False
