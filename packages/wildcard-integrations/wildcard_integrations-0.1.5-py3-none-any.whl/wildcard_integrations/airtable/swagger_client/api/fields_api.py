...
class FieldsApi(object):
    ...
    def airtable_fields_create(self, body, base_id, table_id, **kwargs):  # noqa: E501
        ...
        :param FieldModel body: Field model with name. This identical to Field type and options, with an additional name and description property on all types (required)
