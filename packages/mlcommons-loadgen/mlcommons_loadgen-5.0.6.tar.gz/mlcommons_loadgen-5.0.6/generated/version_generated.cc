...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.6";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-14T17:00:31.641048";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-14T17:00:31.641064";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "c40d6e1ef6";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-14T17:00:01Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(c40d6e1ef63693ce286b6c9833d950b40d1742e4 Increment version to 5.0.6)LGVG_RSLD";
  return str;
}
...
8e56a9b648a997e25d00a921b3369bf78ea6bccd /VERSION.txt
