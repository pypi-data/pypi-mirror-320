...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.7";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-14T19:20:22.465051";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-14T19:20:22.465066";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "1618142d40";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-14T19:19:49Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(1618142d400bc7cf00bc9ea3f6501e339ba4ff5b Increment version to 5.0.7)LGVG_RSLD";
  return str;
}
...
8efdc12f621201d91d03e71d7c8364f9c7bc231d /VERSION.txt
...
7c7de6f3af37e71d91c403f593ce508232f72484 /loadgen.cc
...
1ed37df8ffd4c8e798e30ee5bf511f5c2f4a44b4 /test_settings_internal.cc
