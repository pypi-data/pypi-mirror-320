...
def get_ext_modules():
    ...
    extensions = [
        Extension('toad_fix.c_utils', sources = ['toad_fix/c_utils.pyx'], include_dirs = [np.get_include()]),
        Extension('toad_fix.merge', sources = ['toad_fix/merge.pyx'], include_dirs = [np.get_include()]),
    ]
