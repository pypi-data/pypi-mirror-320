...
```bash
pip install toad_fix # to install
pip install -U toad_fix # to upgrade
```

Conda

```bash
conda install toad_fix --channel conda-forge # to install
conda install -U toad_fix --channel conda-forge # to upgrade
```
