...
class PyeeException(Exception):
    """An exception internal to pyeecui. Deprecated in favor of PyeeError."""


class PyeeError(PyeeException):
    """An error internal to pyeecui."""
...
class EventEmitter:
    ...
    methods, and fired with the `emit` method. However, pyeecui event emitters
