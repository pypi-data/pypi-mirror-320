...
class SingleStoreConnectionConfig(SQLAlchemyConnectionConfig):
    # defaults
    host_port: str = Field(
        default="localhost:3306", description="Singlestore host URL."
    )
    scheme: str = "singlestoredb"


class SingleStoreConfig(SingleStoreConnectionConfig, TwoTierSQLAlchemyConfig):
