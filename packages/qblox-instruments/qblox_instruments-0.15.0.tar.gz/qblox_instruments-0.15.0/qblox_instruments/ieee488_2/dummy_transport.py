...
class DummyTransport(abc.ABC, Transport):
    ...
    def _get_idn(self, cmd_params: list, cmd_args: list, bin_in: bytes) -> None:
        ...
        self._data_out = f"Qblox,{self.instrument_class} {self.instrument_type},whatever,fwVersion=0.0.0 fwBuild=28/11/1967-00:00:00 fwHash=0xDEADBEAF fwDirty=0 kmodVersion=0.0.0 kmodBuild=15/07/1943-00:00:00 kmodHash=0x0D15EA5E kmodDirty=0 swVersion=0.0.0 swBuild=11/05/1924-00:00:00 swHash=0xBEEFBABE swDirty=0"
