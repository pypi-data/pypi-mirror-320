...
class Ieee488_2:
    ...
    _STAT_OPER_CORRECTING = (
        0x0080  # The instrument is currently performing a correction
    )
    _STAT_OPER_INST_SUMMARY = (
        0x2000  # One of n multiple logical instruments is reporting OPERational status
    )
    _STAT_OPER_PROG_RUNNING = (
        0x4000  # A user-defined program is currently in the run state
    )
