...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.10.0 fwBuild=13/12/2024-15:09:35 fwHash=0x849D08F5 fwDirty=0 kmodVersion=0.10.0 kmodBuild=19/12/2024-15:09:20 kmodHash=0x5948D50B kmodDirty=0 swVersion=0.10.0 swBuild=19/12/2024-15:09:20 swHash=0x5948D50B swDirty=0 cfgManVersion=0.4.0 cfgManBuild=19/12/2024-15:09:20 cfgManHash=0x5948D50B cfgManDirty=0"
            if build != build_ref:
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def reset_duc_phase(self, slot: int, tile_id: int, block_id: int) -> Any:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def set_mixer_settings_coarse_delay(
        ...
        block_id : int
            Block ID of the target DAC
        delay : int
            Coarse delay in the number of samples. Range: 0 to 7 for Gen 1/Gen 2 devices and 0 to 40 for Gen 3 devices
