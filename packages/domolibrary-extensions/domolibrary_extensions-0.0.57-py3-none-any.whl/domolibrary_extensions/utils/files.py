...
__all__ = ['rename_filepath_to_match_datatype', 'change_file_suffix', 'detect_encoding', 'read_html_file_as_soup',
           ...
           'download_pptx', 'generate_filename_from_url']
...
def upsert_file(
    ...
    upsert_folder(folder_path=file_path, debug_prn=debug_prn)
...
def download_zip(content, output_folder, is_convert_to_markdown: bool = True, **kwargs):
...
def download_pptx(
    ...
    if is_convert_to_markdown:
        ...
        # upsert_file(
        #     file_path = os.path.join(output_folder, "index.md"),
