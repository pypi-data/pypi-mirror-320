...
# %% auto 0
__all__ = ['get_file_by_id', 'get_folder_by_id', 'walk_folder_and_flatten', 'walk_folder', 'GDrive_MimeType_Enum',
...
async def get_file_by_id(
    service: ga.Resource, file_id: str, fields: List[str] = None, parent_ls=None
):
...
async def walk_folder_and_flatten(
    ...
    new_files = await get_folder_by_id(
...
class GDrive_File:
    ...
    async def _super_get_by_id(
        ...
        file = await get_file_by_id(file_id=id, service=service)
    ...
    async def get_by_id(
        ...
        return await cls._super_get_by_id(
            id=id, auth=auth, service=service, return_raw=return_raw
        )
