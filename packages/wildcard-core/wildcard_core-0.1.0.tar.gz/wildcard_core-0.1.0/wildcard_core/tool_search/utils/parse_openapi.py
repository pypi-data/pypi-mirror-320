...
from wildcard_core.tool_search.utils.helpers import debug_print
import hashlib
import json
from enum import Enum
from pydantic import BaseModel
from wildcard_core.tool_search.utils.handle_merge_openapi import merge_allof_schemas
...
def openapi_to_api_schema(result: Dict[str, Any], function_id: str, api_id: APIService, parse_all: bool = False) -> APISchema:
