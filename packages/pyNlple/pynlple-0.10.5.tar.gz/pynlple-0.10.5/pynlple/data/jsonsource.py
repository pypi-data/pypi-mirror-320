...
class ElasticJsonDataSource(TakingSource, SkippingSource):
    ...
    def __init__(
        ...
        fill_na_map=None,
        authentication=None,
        cluster_timeout: int = 10,
        max_retries: int = 5,
        max_urls_pool_size: int = 3,
        additional_es_kwargs: Optional[Dict[str, Any]] = None
    ):
        ...
        if additional_es_kwargs is None:
            additional_es_kwargs = {}
        self.additional_es_kwargs = additional_es_kwargs
        self.hosts = hosts
        self.index = index
        self.__query = query
        self.keys = keys
    ...
    def __create_es(self, max_retries=5):
        ...
        es = Elasticsearch(
            self.__get_connection_props(),
            timeout=self.cluster_timeout,
            max_retries=max_retries,
            retry_on_timeout=True,
            **self.additional_es_kwargs
        )
