...
def show_status(user=None, job_id=None, detail=False, queue=None, node=None):
    """
    ...
    if queue or node:
        ...
        if not matched_job_ids:
            ...
            # 可视化
            formatted_output = format_qstat_output(output, jobid_queue_dict, detail)
    ...
    # 可视化
    formatted_output = format_qstat_output(output, user_job_info, detail)
    print(formatted_output)
