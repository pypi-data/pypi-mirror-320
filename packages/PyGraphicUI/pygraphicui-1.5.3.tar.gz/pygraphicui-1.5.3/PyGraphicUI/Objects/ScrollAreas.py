...
class PyVerticalScrollArea(QScrollArea, PyWidget):
    ...
    def __init__(
        self, scroll_area_init: ScrollAreaInit = ScrollAreaInit(), instances: typing.Union[typing.Iterable[LinearLayoutItem], None] = None
    ):
        """
...
class PyGridScrollArea(QScrollArea, PyWidget):
    ...
    def __init__(
        self, scroll_area_init: ScrollAreaInit = ScrollAreaInit(), instances: typing.Union[typing.Iterable[GridLayoutItem], None] = None
    ):
        """
