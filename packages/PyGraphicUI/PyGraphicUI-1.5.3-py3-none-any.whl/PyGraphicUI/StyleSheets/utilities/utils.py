...
) -> tuple[typing.Union[ObjectOfStyle, list[ObjectOfStyle], tuple[ObjectOfStyle], array.array[ObjectOfStyle], collections.deque[ObjectOfStyle], None], dict[str, typing.Any]]:
    """
