...
class WidgetSelector:
    ...
    def __init__(self, selector: Selector, widget_name: typing.Union[str, None] = None, object_name: typing.Union[str, None] = None):
        """
    ...
    def set_widget_selector(self, selector: Selector, widget_name: typing.Union[str, None] = None, object_name: typing.Union[str, None] = None):
        """
