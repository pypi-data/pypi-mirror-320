...
class SpinBoxStyleSheet(BaseStyleSheet):
    ...
    def __init__(self, widget_style: typing.Union[SpinBoxStyle, typing.Iterable[SpinBoxStyle], None] = None):
        """
        Initializes a SpinBoxStyleSheet object.

        Args:
            widget_style (typing.Union[SpinBoxStyle, typing.Iterable[SpinBoxStyle], None]): A SpinBoxStyle object or typing.Iterable of SpinBoxStyle objects representing the styles to be applied to the QSpinBox objects.
        """
        super().__init__()
