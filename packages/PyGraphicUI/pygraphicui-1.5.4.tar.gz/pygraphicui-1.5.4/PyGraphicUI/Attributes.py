...
class LinearLayoutItem:
    ...
    def __init__(self, instance: typing.Union[QWidget, QLayout], stretch: int = 0, alignment: typing.Union[Qt.AlignmentFlag, None] = None):
        """
...
class PyBrush(QBrush):
    ...
    def __init__(
        ...
        color: typing.Union[QColor, None] = None,
        texture: typing.Union[QPixmap, None] = None,
        transform: typing.Union[QTransform, None] = None,
        texture_image: typing.Union[QImage, None] = None,
    ):
        """
