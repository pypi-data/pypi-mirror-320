...
class CssObject:
	...
	def __init__(
			self,
			widget: typing.Union[str, typing.Iterable[str], None] = None,
        ...
        Args:
            widget (typing.Union[str, typing.Iterable[str], None]): The widget name or a typing.Iterable of widget names.
            selector (typing.Union[Selector, typing.Iterable[Selector]]): The selector or a typing.Iterable of selectors.
        """
		self.widgets = widget if isinstance(widget, typing.Iterable) else [widget]
		self.selectors = selector if isinstance(selector, typing.Iterable) else [selector]
		self.css_object = ""
...
class ObjectOfStyle:
	...
	def __init__(self, css_objects: CssObject = None, subcontrol: str = "", pseudo_state: PseudoState = None):
		"""
...
class StyleSheetObject:
	...
	def __init__(self, objects_of_style: typing.Union[ObjectOfStyle, typing.Iterable[ObjectOfStyle]]):
		"""
	...
	def update_style_sheet_object(self):
        ...
        """
		self.style_sheet_object = ", ".join("".join([objects_of_style.css_object.css_object, objects_of_style.subcontrol, objects_of_style.pseudo_state, ])
