 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_ELEWISE_IMPL_H_
#define MS_KERNELS_INTERNAL_KERNEL_ELEWISE_IMPL_H_
...
namespace mindspore {
namespace internal {
class ElewiseUnaryImpl : public InternelKernelImpl {
 public:
  ElewiseUnaryImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~ElewiseUnaryImpl() {}
...
#endif  // MS_KERNELS_INTERNAL_KERNEL_ELEWISE_IMPL_H_