 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_NZ_IMPL_H_
#define MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_NZ_IMPL_H_
...
namespace mindspore {
namespace internal {
class ReshapeAndCacheNzImpl : public InternelKernelImpl {
 public:
  ReshapeAndCacheNzImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~ReshapeAndCacheNzImpl() {}
