...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_0058516187c0_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_0058516187c0_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_0058516187c0_error")
        self._setDefault(outputCol="AddDocuments_0058516187c0_output")
