...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="FindSimilarFace_bedc78054b34_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_bedc78054b34_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_bedc78054b34_error")
        self._setDefault(outputCol="FindSimilarFace_bedc78054b34_output")
