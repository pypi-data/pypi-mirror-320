...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_fc6fb4220563_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_fc6fb4220563_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_fc6fb4220563_error")
        self._setDefault(outputCol="IdentifyFaces_fc6fb4220563_output")
