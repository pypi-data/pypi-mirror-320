...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_ceba9ce65e0f_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_ceba9ce65e0f_output",
        ...
        self._setDefault(errorCol="GroupFaces_ceba9ce65e0f_error")
        self._setDefault(outputCol="GroupFaces_ceba9ce65e0f_output")
