...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_3c76fbb003c4_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_3c76fbb003c4_output",
        ...
        self._setDefault(errorCol="DetectFace_3c76fbb003c4_error")
        self._setDefault(outputCol="DetectFace_3c76fbb003c4_output")
