...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_187fb5e1e2bd_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_187fb5e1e2bd_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_187fb5e1e2bd_error")
        self._setDefault(outputCol="AnalyzeImage_187fb5e1e2bd_output")
