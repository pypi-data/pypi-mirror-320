...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_caab51d9474b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_caab51d9474b_output",
        ...
        self._setDefault(errorCol="OCR_caab51d9474b_error")
        self._setDefault(outputCol="OCR_caab51d9474b_output")
