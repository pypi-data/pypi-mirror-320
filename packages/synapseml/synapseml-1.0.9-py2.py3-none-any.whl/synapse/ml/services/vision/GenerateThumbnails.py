...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_5fe50dd5b5ed_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_5fe50dd5b5ed_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_5fe50dd5b5ed_error")
        self._setDefault(outputCol="GenerateThumbnails_5fe50dd5b5ed_output")
