...
class RecognizeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="RecognizeText_4c2d3fb6d775_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="RecognizeText_4c2d3fb6d775_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="RecognizeText_4c2d3fb6d775_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="RecognizeText_4c2d3fb6d775_output")
