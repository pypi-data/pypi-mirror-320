...
class ReadImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ReadImage_40f1e8ad7287_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="ReadImage_40f1e8ad7287_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReadImage_40f1e8ad7287_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReadImage_40f1e8ad7287_output")
