...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_8ba51830938b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_8ba51830938b_output",
        ...
        self._setDefault(errorCol="DescribeImage_8ba51830938b_error")
        self._setDefault(outputCol="DescribeImage_8ba51830938b_output")
