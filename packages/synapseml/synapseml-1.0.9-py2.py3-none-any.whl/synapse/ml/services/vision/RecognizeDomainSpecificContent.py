...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="RecognizeDomainSpecificContent_35ea2fe991a3_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_35ea2fe991a3_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_35ea2fe991a3_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_35ea2fe991a3_output")
