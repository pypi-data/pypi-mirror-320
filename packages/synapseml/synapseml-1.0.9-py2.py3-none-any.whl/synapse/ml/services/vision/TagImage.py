...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_fe912c906a1b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_fe912c906a1b_output",
        ...
        self._setDefault(errorCol="TagImage_fe912c906a1b_error")
        self._setDefault(outputCol="TagImage_fe912c906a1b_output")
