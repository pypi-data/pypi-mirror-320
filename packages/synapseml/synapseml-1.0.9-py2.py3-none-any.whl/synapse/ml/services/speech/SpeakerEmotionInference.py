...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_634ca2786e79_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_634ca2786e79_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_634ca2786e79_error")
        self._setDefault(outputCol="SpeakerEmotionInference_634ca2786e79_output")
