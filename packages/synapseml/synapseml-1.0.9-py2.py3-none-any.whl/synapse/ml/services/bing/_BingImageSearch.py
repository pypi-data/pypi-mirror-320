...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="BingImageSearch_601a95c9069b_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_601a95c9069b_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        self._setDefault(errorCol="BingImageSearch_601a95c9069b_error")
        self._setDefault(outputCol="BingImageSearch_601a95c9069b_output")
