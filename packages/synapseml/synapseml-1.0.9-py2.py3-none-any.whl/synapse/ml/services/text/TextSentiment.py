...
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentiment_5bcec2eca78a_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_5bcec2eca78a_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="TextSentiment_5bcec2eca78a_error")
        self._setDefault(outputCol="TextSentiment_5bcec2eca78a_output")
