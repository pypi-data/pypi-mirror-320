...
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetector_0a9179a465b2_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_0a9179a465b2_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="EntityDetector_0a9179a465b2_error")
        self._setDefault(outputCol="EntityDetector_0a9179a465b2_output")
