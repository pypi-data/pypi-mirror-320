...
class KeyPhraseExtractor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractor_3916b2247f72_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="KeyPhraseExtractor_3916b2247f72_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="KeyPhraseExtractor_3916b2247f72_error")
        self._setDefault(outputCol="KeyPhraseExtractor_3916b2247f72_output")
