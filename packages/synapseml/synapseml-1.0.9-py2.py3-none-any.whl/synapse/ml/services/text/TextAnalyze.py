...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_150a162b3621_error",
        ...
        outputCol="TextAnalyze_150a162b3621_output",
        ...
        self._setDefault(errorCol="TextAnalyze_150a162b3621_error")
        ...
        self._setDefault(outputCol="TextAnalyze_150a162b3621_output")
