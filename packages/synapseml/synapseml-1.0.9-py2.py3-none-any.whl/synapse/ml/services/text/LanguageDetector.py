...
class LanguageDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetector_0c954abeb308_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="LanguageDetector_0c954abeb308_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="LanguageDetector_0c954abeb308_error")
        self._setDefault(outputCol="LanguageDetector_0c954abeb308_output")
