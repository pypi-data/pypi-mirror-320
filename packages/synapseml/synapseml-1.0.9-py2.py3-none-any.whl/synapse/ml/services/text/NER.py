...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_eab41429e74f_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_eab41429e74f_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_eab41429e74f_error")
        self._setDefault(outputCol="NER_eab41429e74f_output")
