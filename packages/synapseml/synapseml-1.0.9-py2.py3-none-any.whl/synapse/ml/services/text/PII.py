...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_2ba4ede1f714_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_2ba4ede1f714_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_2ba4ede1f714_error")
        self._setDefault(outputCol="PII_2ba4ede1f714_output")
