...
class AnalyzeHealthText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeHealthText_8d8d2f41190b_error",
        ...
        outputCol="AnalyzeHealthText_8d8d2f41190b_output",
        pollingDelay=300,
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="AnalyzeHealthText_8d8d2f41190b_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeHealthText_8d8d2f41190b_output")
