...
class AddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddressGeocoder_c5a7b464a0e9_error",
        initialPollingDelay=300,
        maxPollingRetries=1000,
        outputCol="AddressGeocoder_c5a7b464a0e9_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AddressGeocoder_c5a7b464a0e9_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AddressGeocoder_c5a7b464a0e9_output")
