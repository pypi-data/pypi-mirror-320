...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_341b7d1c6a26_error",
        ...
        outputCol="ReverseAddressGeocoder_341b7d1c6a26_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReverseAddressGeocoder_341b7d1c6a26_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_341b7d1c6a26_output")
