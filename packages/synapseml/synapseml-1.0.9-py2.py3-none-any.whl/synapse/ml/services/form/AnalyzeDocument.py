...
class AnalyzeDocument(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeDocument_fd2d3651fafb_error",
        features=None,
        featuresCol=None,
        imageBytes=None,
        imageBytesCol=None,
        ...
        outputCol="AnalyzeDocument_fd2d3651fafb_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeDocument_fd2d3651fafb_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeDocument_fd2d3651fafb_output")
