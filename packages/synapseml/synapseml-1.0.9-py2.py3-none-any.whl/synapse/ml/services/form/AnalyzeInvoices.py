...
class AnalyzeInvoices(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeInvoices_9f33102dc234_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeInvoices_9f33102dc234_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeInvoices_9f33102dc234_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeInvoices_9f33102dc234_output")
