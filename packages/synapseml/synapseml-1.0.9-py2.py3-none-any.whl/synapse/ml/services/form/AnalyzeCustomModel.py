...
class AnalyzeCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeCustomModel_236116cb38d3_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        modelId=None,
        modelIdCol=None,
        outputCol="AnalyzeCustomModel_236116cb38d3_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeCustomModel_236116cb38d3_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeCustomModel_236116cb38d3_output")
