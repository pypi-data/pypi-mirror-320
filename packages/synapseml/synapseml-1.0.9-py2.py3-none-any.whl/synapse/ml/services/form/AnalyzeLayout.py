...
class AnalyzeLayout(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeLayout_4b342f1d5d28_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeLayout_4b342f1d5d28_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        readingOrder=None,
        ...
        self._setDefault(errorCol="AnalyzeLayout_4b342f1d5d28_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeLayout_4b342f1d5d28_output")
