...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_eb60bc397f82_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_eb60bc397f82_output",
        ...
        self._setDefault(errorCol="GetCustomModel_eb60bc397f82_error")
        self._setDefault(outputCol="GetCustomModel_eb60bc397f82_output")
