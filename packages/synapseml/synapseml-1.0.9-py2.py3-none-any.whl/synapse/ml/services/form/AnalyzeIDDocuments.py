...
class AnalyzeIDDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeIDDocuments_9093c90bc839_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeIDDocuments_9093c90bc839_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeIDDocuments_9093c90bc839_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeIDDocuments_9093c90bc839_output")
