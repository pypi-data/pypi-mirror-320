...
class AnalyzeBusinessCards(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeBusinessCards_44d2c654de15_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeBusinessCards_44d2c654de15_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeBusinessCards_44d2c654de15_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeBusinessCards_44d2c654de15_output")
