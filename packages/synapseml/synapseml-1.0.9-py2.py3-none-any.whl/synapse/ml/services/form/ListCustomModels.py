...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_c6a084a71183_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_c6a084a71183_output",
        ...
        self._setDefault(errorCol="ListCustomModels_c6a084a71183_error")
        self._setDefault(outputCol="ListCustomModels_c6a084a71183_output")
