...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_cb428c400cce_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_cb428c400cce_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_cb428c400cce_error")
        self._setDefault(outputCol="AnalyzeText_cb428c400cce_output")
