...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_69e8e3787e0b_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_69e8e3787e0b_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_69e8e3787e0b_error")
        self._setDefault(outputCol="OpenAIChatCompletion_69e8e3787e0b_output")
