...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_ffb8d2d6cfcd_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_ffb8d2d6cfcd_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_ffb8d2d6cfcd_error")
        self._setDefault(outputCol="OpenAICompletion_ffb8d2d6cfcd_output")
