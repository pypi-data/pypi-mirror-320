...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_e85da20d024d_error",
        handler=None,
        outputCol="OpenAIEmbedding_e85da20d024d_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_e85da20d024d_error")
        self._setDefault(outputCol="OpenAIEmbedding_e85da20d024d_output")
