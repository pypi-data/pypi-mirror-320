...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_eb2abcb6e0d9_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_eb2abcb6e0d9_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_eb2abcb6e0d9_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_eb2abcb6e0d9_error")
        self._setDefault(messagesCol="OpenAIPrompt_eb2abcb6e0d9_messages")
        self._setDefault(outputCol="OpenAIPrompt_eb2abcb6e0d9_output")
