...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_578fc1abd42f_error",
        handler=None,
        outputCol="Detect_578fc1abd42f_output",
        ...
        self._setDefault(errorCol="Detect_578fc1abd42f_error")
        self._setDefault(outputCol="Detect_578fc1abd42f_output")
