...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_92d8d9a91d74_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_92d8d9a91d74_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_92d8d9a91d74_error")
        self._setDefault(outputCol="DictionaryExamples_92d8d9a91d74_output")
