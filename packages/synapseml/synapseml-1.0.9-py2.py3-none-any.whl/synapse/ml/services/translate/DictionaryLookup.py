...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_df237a5ac01d_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_df237a5ac01d_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_df237a5ac01d_error")
        self._setDefault(outputCol="DictionaryLookup_df237a5ac01d_output")
