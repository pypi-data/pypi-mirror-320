...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_841ae68b5c24_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_841ae68b5c24_output",
        ...
        self._setDefault(errorCol="Transliterate_841ae68b5c24_error")
        self._setDefault(outputCol="Transliterate_841ae68b5c24_output")
