...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_2a23a3c87545_error",
        fromLanguage=None,
        ...
        outputCol="Translate_2a23a3c87545_output",
        ...
        self._setDefault(errorCol="Translate_2a23a3c87545_error")
        self._setDefault(outputCol="Translate_2a23a3c87545_output")
