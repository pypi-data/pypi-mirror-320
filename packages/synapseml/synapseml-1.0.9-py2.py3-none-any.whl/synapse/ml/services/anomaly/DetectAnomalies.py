...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectAnomalies_cef29acf1045_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectAnomalies_cef29acf1045_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectAnomalies_cef29acf1045_error")
        self._setDefault(outputCol="DetectAnomalies_cef29acf1045_output")
