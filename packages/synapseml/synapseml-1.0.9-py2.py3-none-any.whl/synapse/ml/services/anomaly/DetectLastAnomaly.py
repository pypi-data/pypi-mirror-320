...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectLastAnomaly_ddf01198aa4a_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectLastAnomaly_ddf01198aa4a_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_ddf01198aa4a_error")
        self._setDefault(outputCol="DetectLastAnomaly_ddf01198aa4a_output")
