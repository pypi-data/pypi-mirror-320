...
class DetectLastMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastMultivariateAnomaly_c914305d1eac_error",
        handler=None,
        inputVariablesCols=None,
        modelId=None,
        outputCol="DetectLastMultivariateAnomaly_c914305d1eac_output",
        ...
        self._setDefault(errorCol="DetectLastMultivariateAnomaly_c914305d1eac_error")
        self._setDefault(outputCol="DetectLastMultivariateAnomaly_c914305d1eac_output")
