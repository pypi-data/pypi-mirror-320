...
class SimpleDetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SimpleDetectAnomalies_5abefb918b0b_error",
        granularity=None,
        granularityCol=None,
        groupbyCol=None,
        handler=None,
        ...
        outputCol="SimpleDetectAnomalies_5abefb918b0b_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="SimpleDetectAnomalies_5abefb918b0b_error")
        self._setDefault(outputCol="SimpleDetectAnomalies_5abefb918b0b_output")
