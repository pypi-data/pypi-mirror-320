...
class PvImage(KivyImage):
    def __init__(self, container=None, x=0, y=0, image_path="", scale=1.0, is_visible=True, opacity=1, tag=None):
        ...
        # If auto_add is True and container is provided, add immediately
        if container:
...
if __name__ == "__main__":
    ...
    img1 = PvImage(container=window, x=50, y=50, image_path="../../assets/buttons/blue_round/idle.png", scale=1.5, )
    img2 = PvImage(container=window, x=300, y=50, image_path="../../assets/buttons/blue_round/idle.png", scale=1.0,
                 is_visible=False)
    window.show()
