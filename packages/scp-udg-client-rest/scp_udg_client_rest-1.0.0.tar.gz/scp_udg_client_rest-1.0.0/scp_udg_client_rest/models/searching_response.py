...
class SearchingResponse(BaseModel):
    ...
    code: StrictStr
    message: StrictStr
    dataset: Optional[List[ScpsUrbandatasetSchema20]] = None
    detail: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["code", "message", "dataset", "detail"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchingResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchingResponse from a dict"""
        if obj is None:
            return None
