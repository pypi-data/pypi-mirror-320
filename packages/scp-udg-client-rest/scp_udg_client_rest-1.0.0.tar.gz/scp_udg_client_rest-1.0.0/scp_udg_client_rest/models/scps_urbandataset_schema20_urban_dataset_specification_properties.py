...
class ScpsUrbandatasetSchema20UrbanDatasetSpecificationProperties(BaseModel):
    ...
    """ # noqa: E501
    property_definition: List[ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner] = Field(alias="propertyDefinition")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.property_definition:
            for _item_property_definition in self.property_definition:
                if _item_property_definition:
                    _items.append(_item_property_definition.to_dict())
