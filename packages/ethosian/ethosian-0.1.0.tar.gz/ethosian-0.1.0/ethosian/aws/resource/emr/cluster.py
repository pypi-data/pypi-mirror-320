...
class EmrCluster(AwsResource):
    ...
    scale_down_behavior: Optional[Literal["TERMINATE_AT_INSTANCE_HOUR",
                                          "TERMINATE_AT_TASK_COMPLETION"]] = None
            ...
            try:
                ...
                if self.job_flow_id is not None:
                    waiter = self.get_service_client(
                        aws_client).get_waiter("cluster_running")
                    waiter.wait(
    ...
    def _delete(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            if self.job_flow_id:
                service_client.terminate_job_flows(
