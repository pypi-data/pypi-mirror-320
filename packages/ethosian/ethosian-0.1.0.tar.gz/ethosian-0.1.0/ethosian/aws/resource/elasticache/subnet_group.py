...
class CacheSubnetGroup(AwsResource):
    ...
    def get_subnet_ids(self, aws_client: AwsApiClient) -> List[str]:
        ...
        if self.subnet_ids is not None:
            if isinstance(self.subnet_ids, list):
                ...
                subnet_ids = self.subnet_ids.get_reference(
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            create_response = service_client.create_cache_subnet_group(
                ...
                CacheSubnetGroupDescription=self.description or f"Created for {
                    self.name}",
            ...
            self.active_resource = create_response.get(
                "CacheSubnetGroup", None)
    ...
    def _read(self, aws_client: AwsApiClient) -> Optional[Any]:
        ...
        try:
            ...
            cache_subnet_group_list = describe_response.get(
    ...
    def _update(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            self.active_resource = update_response.get(
                "CacheSubnetGroup", None)
            if self.active_resource is not None:
                print_info(f"{self.get_resource_type()}: {
