...
from ethosian.aws.resource.s3.object import S3Object
...
class S3Bucket(AwsResource):
    ...
    acl: Optional[Literal["private", "public-read",
                          "public-read-write", "authenticated-read"]] = None
    ...
    object_ownership: Optional[Literal["BucketOwnerPreferred",
                                       "ObjectWriter", "BucketOwnerEnforced"]] = None
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        if aws_client.aws_region is not None and aws_client.aws_region != "us-east-1":
            bucket_configuration = {
                "LocationConstraint": aws_client.aws_region}
        ...
        if self.wait_for_create:
            try:
                ...
                waiter = self.get_service_client(
                    aws_client).get_waiter("bucket_exists")
                waiter.wait(
                    Bucket=self.name,
                    WaiterConfig={
