...
class DbCluster(AwsResource):
    ...
    engine: Union[str, Literal["aurora", "aurora-mysql",
    ...
    def _create(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            if resource_dict is not None:
                logger.debug(f"DBCluster created: {
        ...
        if self.wait_for_create:
            try:
                ...
                waiter = self.get_service_client(
                    aws_client).get_waiter("db_cluster_available")
                waiter.wait(
                    DBClusterIdentifier=self.get_db_cluster_identifier(),
                    WaiterConfig={
    ...
    def _delete(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            if resource_dict is not None:
                logger.debug(f"DBCluster deleted: {
                             self.get_db_cluster_identifier()}")
                self.active_resource = resource_dict
                return True
        except Exception as e:
    ...
    def post_delete(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.wait_for_delete:
            try:
                ...
                waiter = self.get_service_client(
                    aws_client).get_waiter("db_cluster_deleted")
                waiter.wait(
                    DBClusterIdentifier=self.get_db_cluster_identifier(),
                    WaiterConfig={
                        "Delay": self.waiter_delay,
