...
from ethosian.workflow import WorkflowSession
from ethosian.storage.workflow.base import WorkflowStorage
...
class SqlWorkflowStorage(WorkflowStorage):
    def __init__(
        ...
        if _engine is None:
            raise ValueError(
                "Must provide either db_url, db_file or db_engine")
    ...
    def get_table_v1(self) -> Table:
        ...
        return Table(
            ...
            Column("created_at", sqlite.INTEGER,
                   default=lambda: int(time.time())),
            # The Unix timestamp of when this session was last updated.
            Column("updated_at", sqlite.INTEGER,
