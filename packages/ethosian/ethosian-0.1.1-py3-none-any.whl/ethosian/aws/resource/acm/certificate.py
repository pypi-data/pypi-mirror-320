...
from ethosian.cli.console import print_info, print_subheading
    ...
    def post_create(self, aws_client: AwsApiClient) -> bool:
        ...
        if self.wait_for_create:
            try:
                ...
                waiter = self.get_service_client(
                    aws_client).get_waiter("certificate_validated")
        ...
        if self.store_cert_summary:
            ...
            try:
                ...
                self.certificate_summary_file.write_text(
                    cert_summary.json(indent=2))
                print_info(f"Certificate Summary stored at: {
                           str(self.certificate_summary_file)}")
            except Exception as e:
