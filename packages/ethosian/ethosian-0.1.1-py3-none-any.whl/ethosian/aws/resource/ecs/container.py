...
from ethosian.aws.resource.secret.reader import read_secrets
...
class EcsContainer(AwsResource):
    ...
    env_from_secrets: Optional[Union[SecretsManager,
                                     List[SecretsManager]]] = None
