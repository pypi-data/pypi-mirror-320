...
class LanceDb(VectorDb):
    def __init__(
        ...
        if self.table is None:
            ...
            if table:
                ...
                if not table_name:
                    raise ValueError(
                        "Either table or table_name should be provided.")
    ...
    def _init_table(self) -> lancedb.db.LanceTable:
        schema = pa.schema(
            [
                pa.field(
                    ...
                    pa.list_(
                        pa.float32(),
                        len(self.embedder.get_embedding(
                            "test")),  # type: ignore
                    ),
                ),
        ...
        tbl = self.connection.create_table(
    ...
    def insert(self, documents: List[Document], filters: Optional[Dict[str, Any]] = None) -> None:
        ...
        if self.table:
            ...
            logger.error(
                "Table not initialized. Please create the table first")
