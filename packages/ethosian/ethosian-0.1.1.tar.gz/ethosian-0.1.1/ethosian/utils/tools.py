...
from ethosian.tools.function import Function, FunctionCall
from ethosian.utils.functions import get_function_call
...
def get_function_call_for_tool_call(
    ...
    if tool_call.get("type") == "function":
        ...
        if _tool_call_function is not None:
            ...
            _tool_call_function_arguments_str = _tool_call_function.get(
                "arguments")
...
def extract_tool_from_xml(xml_str):
    ...
    while parameters_block:
        ...
        # Move past this tag
        parameters_block = parameters_block[value_end +
                                            len(f"</{tag_name}>"):].strip()
