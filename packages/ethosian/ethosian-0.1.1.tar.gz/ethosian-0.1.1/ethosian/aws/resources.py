...
from ethosian.aws.app.base import AwsApp
from ethosian.aws.app.context import AwsBuildContext
from ethosian.aws.api_client import AwsApiClient
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from ethosian.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from ethosian.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from ethosian.aws.resource.types import AwsResourceInstallOrder
    ...
    def delete_resources(
        ...
        # Sort the AwsResources in install order
        resources_to_delete.sort(key=lambda x: AwsResourceInstallOrder.get(
