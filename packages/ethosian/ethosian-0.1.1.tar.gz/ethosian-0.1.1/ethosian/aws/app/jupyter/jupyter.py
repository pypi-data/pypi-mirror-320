...
from ethosian.aws.app.base import AwsApp, ContainerContext, AwsBuildContext  # noqa: F401
...
class Jupyter(AwsApp):
    ...
    # -*- Image Configuration
    image_name: str = "ethosian/jupyter"
    image_tag: str = "4.0.5"
    ...
    # Defaults to /resources/jupyter_lab_config.py which is added in the "ethosian/jupyter" image
