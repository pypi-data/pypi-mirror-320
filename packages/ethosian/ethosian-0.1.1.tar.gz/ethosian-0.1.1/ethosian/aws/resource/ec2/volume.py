...
class EbsVolume(AwsResource):
    ...
    #
    # Default: gp2
    volume_type: Optional[Literal["standard", "io_1",
                                  "io_2", "gp_2", "sc_1", "st_1", "gp_3"]] = None
            ...
            try:
                if self.volume_id is not None:
                    ...
                    waiter = self.get_service_client(
                        aws_client).get_waiter("volume_available")
                    waiter.wait(
    ...
    def _delete(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            for attachment in volume.get("Attachments", []):
                ...
                print_info(f"Detaching volume from device: {
    ...
    def _update(self, aws_client: AwsApiClient) -> bool:
        ...
        try:
            ...
            volume_modification = update_response.get(
                "VolumeModification", None)
            if volume_modification is not None:
                volume_id_after_modification = volume_modification.get(
                    "VolumeId", None)
