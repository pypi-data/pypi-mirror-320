...
class WorkspaceSettings(BaseSettings):
    ...
    # default env for ethosian ws commands
    default_env: Optional[str] = "dev"
    # default infra for ethosian ws commands
    default_infra: Optional[str] = None
    #
    # -*- Image Settings
    #
    # Repository for images
    image_repo: str = "ethosian"
    ...
    # -*- Cli settings
    # Set to True if `ethosian` should continue creating
    # resources after a resource creation has failed
    continue_on_create_failure: bool = False
    # Set to True if `ethosian` should continue deleting
    ...
    # Set to True if `ethosian` should continue patching
