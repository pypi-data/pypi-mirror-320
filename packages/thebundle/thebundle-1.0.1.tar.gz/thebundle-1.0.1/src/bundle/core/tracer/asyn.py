...
async def call_raise(func: Callable[P, Awaitable[R]], *args: P.args, stacklevel: int = 4, **kwargs: P.kwargs) -> R:
...
def decorator_call(func: Callable[P, Awaitable[R]]) -> Callable[P, Awaitable[tuple[R | None, Exception | None]]]:
    @wraps(func)
...
def decorator_call_raise(func: Callable[P, Awaitable[R]]) -> Callable[P, Awaitable[R]]:
    @wraps(func)
