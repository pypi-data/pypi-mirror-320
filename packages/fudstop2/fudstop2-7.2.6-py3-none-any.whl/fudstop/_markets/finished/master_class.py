...
db = Polygon(host='localhost', user='chuck', database='market_data', password='fud', port=5432)
...
opts = PolygonOptions(user='chuck', database='market_data', host='localhost', password='fud', port=5432)
