...
class CountsOp(_ods_ir.OpView):
  ...
  def __init__(self, eigvals, counts, obs, *, in_eigvals=None, in_counts=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def counts(eigvals, counts, obs, *, in_eigvals=None, in_counts=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(CountsOp(eigvals=eigvals, counts=counts, obs=obs, in_eigvals=in_eigvals, in_counts=in_counts, loc=loc, ip=ip))
...
class SampleOp(_ods_ir.OpView):
  ...
  def __init__(self, samples, obs, *, in_data=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def sample(samples, obs, *, in_data=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SampleOp(samples=samples, obs=obs, in_data=in_data, loc=loc, ip=ip))
...
@_ods_cext.register_operation(_Dialect)
class StaticCustomOp(_ods_ir.OpView):
  OPERATION_NAME = "quantum.static_custom"
  ...
  def __init__(self, out_qubits, out_ctrl_qubits, static_params, in_qubits, gate_name, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(_get_op_results_or_values(in_ctrl_values))
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["static_params"] = (static_params if (
    isinstance(static_params, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('DenseF64ArrayAttr')) else
      _ods_ir.AttrBuilder.get('DenseF64ArrayAttr')(static_params, context=_ods_context))
    attributes["gate_name"] = (gate_name if (
    isinstance(gate_name, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
      _ods_ir.AttrBuilder.get('StrAttr')(gate_name, context=_ods_context))
  ...
  def static_params(self):
    return self.operation.attributes["static_params"]

  @static_params.setter
  def static_params(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["static_params"] = value
...
def static_custom(out_qubits, out_ctrl_qubits, static_params, in_qubits, gate_name, in_ctrl_qubits, in_ctrl_values, *, adjoint=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(StaticCustomOp(out_qubits=out_qubits, out_ctrl_qubits=out_ctrl_qubits, static_params=static_params, in_qubits=in_qubits, gate_name=gate_name, in_ctrl_qubits=in_ctrl_qubits, in_ctrl_values=in_ctrl_values, adjoint=adjoint, loc=loc, ip=ip))
