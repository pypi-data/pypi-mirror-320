    ...
    use crate::{
        ...
        types::{
            ...
            request::{
                ...
                ClientRequest, Cmd, IndexPrice, InsuranceFundWithdrawIntent, MintPriceCheckpoint,
                OrderIntent, OrderType as RustOrderType, ProfileUpdate, Request,
    ...
    mod tests {
        ...
        fn merkle_proof_single_key_roundtrip() {
            ...
            Python::with_gil(|py| {
                ...
                smt.store_strategy(strategy_key, Some(Strategy::new_py(StrategyId::default())))
                    .unwrap();
