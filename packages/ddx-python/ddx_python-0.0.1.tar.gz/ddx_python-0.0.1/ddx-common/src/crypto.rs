...
use libsecp256k1::{
    Message, PublicKey, RecoveryId, SecretKey, SharedSecret, Signature,
    util::{COMPRESSED_PUBLIC_KEY_SIZE, FULL_PUBLIC_KEY_SIZE},
};
...
pub use encryption::trusted::{do_decrypt, do_encrypt_with_nonce};
#[cfg(not(target_vendor = "teaclave"))]
pub use encryption::untrusted::{do_decrypt, do_encrypt_with_nonce};
#[cfg(target_vendor = "teaclave")]
...
pub fn encrypt_with_nonce(
    ...
    do_encrypt_with_nonce(&mut ciphertext, derived_key, nonce)?;
    tracing::debug!(
...
mod tests {
    ...
    fn test_encryption_workflow() {
        ...
        // `EncrytedContent` is deserialized from input bytes. The network secret key is sealed
        // in protected memory.
