...
class ConverseRequest(BaseModel):
    ...
    mode: Optional[StrictStr] = Field(default=None, description="The model to use to answer the question. Supports the standard (`default`) and advanced (`advanced`) models. See [Choosing a model](/overview/models/) for details about each model. <Note>The multistep model and research mode are not supported.</Note> ")
