...
class Client:
    ...
    def build_base_response(self):
        ...
        logger.debug(f"(%s) - Base payload length: {len(data)}", format(__name__))
    ...
    def build_following_response(self):
        ...
        logger.debug(f"(%s) - follower payload length: {len(data)}", format(__name__))
        logger.debug(f"(%s) - packed data: {data}", format(__name__))
