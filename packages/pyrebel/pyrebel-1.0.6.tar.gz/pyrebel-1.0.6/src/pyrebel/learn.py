    ...
    if ci<len(nz_ba_size_d):
        ...
        for i in range(nz_ba_size_d[ci]-1):
            ...
            while 1:
                ...
                ba_sign_array_d[ci][k1+(nz_ba_size_d[ci]-1)+i][s-1]=ii1_inv
                ba_sign_array_d[ci][k1+(nz_ba_size_d[ci]-1)*2+i][nz_ba_size_d[ci]-s-1]=ii1
                ba_sign_array_d[ci][k1+(nz_ba_size_d[ci]-1)*3+i][nz_ba_size_d[ci]-s-1]=ii1_inv
...
class Learn:
    ...
    def find_signatures2(self,ba_sign_h,nz_ba_size_h):
        ...
        find_signatures_cuda2[len(nz_ba_size_h),1](ba_sign_d,nz_ba_size_d,nz_ba_size_cum_d,ba_sign_array2_d)
        cuda.synchronize()
