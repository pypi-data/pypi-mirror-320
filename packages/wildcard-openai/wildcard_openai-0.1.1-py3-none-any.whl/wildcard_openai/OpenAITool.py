...
from wildcard_core.tool_search.utils.helpers import generate_readable_args_schema, generate_readable_request_body_schema, _process_schema, _process_arg
...
class OpenAITool(BaseModel):
    ...
    @classmethod
    def from_api_schema(cls, tool_enum: str, tool_details: APISchema, strict: bool = False, openai_mode: bool = False):
