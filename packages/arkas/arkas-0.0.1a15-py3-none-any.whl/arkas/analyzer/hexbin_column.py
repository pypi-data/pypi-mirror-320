...
class HexbinColumnAnalyzer(BaseLazyAnalyzer):
    r"""Implement an analyzer that plots the content of each column.
    ...
    def _analyze(self, frame: pl.DataFrame) -> HexbinColumnOutput:
