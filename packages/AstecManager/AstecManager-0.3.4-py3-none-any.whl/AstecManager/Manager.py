...
class Manager:
    ...
    def copy_raw_data(self, parameters):
        ...
        copy_on_cold_storage = ("copy_on_cold_storage" in parameters and parameters["copy_on_cold_storage"])
        ...
        try:
            ...
            if copy_on_cold_storage:
                cold_storage_container = parameters["cold_storage_folder"]
                ...
                try:
                    subprocess.run(['rsync', '-avzr', str(folder_to_copy), cold_storage_container], check=True)
                except subprocess.CalledProcessError:
                    print(
                        'Error during the copy of the data on the cold storage , please verify the access to the storage')
        except subprocess.CalledProcessError:
