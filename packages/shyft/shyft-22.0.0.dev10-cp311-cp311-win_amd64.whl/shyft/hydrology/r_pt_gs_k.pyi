...
class RPTGSKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> RPTGSKParameter:
        ...
...
def create_opt_model_clone(src_model: RPTGSKModel, with_catchment_params: bool = False) -> RPTGSKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: RPTGSKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> RPTGSKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: RPTGSKStateWithIdVector) -> RPTGSKStateVector:
    ...
    """
def serialize(states: RPTGSKStateWithIdVector) -> list[str]:
    """
