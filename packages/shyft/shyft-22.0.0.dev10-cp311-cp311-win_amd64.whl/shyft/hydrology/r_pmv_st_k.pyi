...
class RPMVSTKAllCollector:
    ...
    def destination_area(self) -> float:
        ...
        """
    @property
    def end_reponse(self) -> RPMVSTKResponse:
        """
...
class RPMVSTKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> RPMVSTKParameter:
        ...
...
class RPMVSTKStateWithIdVector:
    ...
    def pop(self, i: int) -> RPMVSTKStateWithId:
        ...
        Remove and return the item at index ``i``
        """
    def serialize_to_bytes(self) -> list[str]:
        ...
...
def create_opt_model_clone(src_model: RPMVSTKModel, with_catchment_params: bool = False) -> RPMVSTKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: RPMVSTKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> RPMVSTKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: RPMVSTKStateWithIdVector) -> RPMVSTKStateVector:
    ...
    """
def serialize(states: RPMVSTKStateWithIdVector) -> list[str]:
    """
