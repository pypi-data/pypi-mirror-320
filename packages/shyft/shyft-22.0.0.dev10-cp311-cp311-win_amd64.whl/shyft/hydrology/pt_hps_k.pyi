...
class PTHPSKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> PTHPSKParameter:
        ...
...
def create_opt_model_clone(src_model: PTHPSKModel, with_catchment_params: bool = False) -> PTHPSKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: PTHPSKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> PTHPSKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: PTHPSKStateWithIdVector) -> PTHPSKStateVector:
    ...
    """
def serialize(states: PTHPSKStateWithIdVector) -> list[str]:
    """
