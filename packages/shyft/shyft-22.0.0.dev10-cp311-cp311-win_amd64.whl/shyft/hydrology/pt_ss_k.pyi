...
class PTSSKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> PTSSKParameter:
        ...
...
def create_opt_model_clone(src_model: PTSSKModel, with_catchment_params: bool = False) -> PTSSKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: PTSSKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> PTSSKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: PTSSKStateWithIdVector) -> PTSSKStateVector:
    ...
    """
def serialize(states: PTSSKStateWithIdVector) -> list[str]:
    """
