...
class PTHSKParameter:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @staticmethod
    def deserialize(blob: list[str]) -> PTHSKParameter:
        ...
...
def create_opt_model_clone(src_model: PTHSKModel, with_catchment_params: bool = False) -> PTHSKOptModel:
    ...
    Returns:
        XXXX?Model: new_model. new_model ready to run_cells, or to put into the calibrator/optimizer
    """
def deserialize(bytes: list[str], states: PTHSKStateWithIdVector) -> None:
    """
    from a blob, fill in states
    """
def deserialize_from_bytes(bytes: list[str]) -> PTHSKStateWithIdVector:
    ...
def extract_state_vector(cell_state_id_vector: PTHSKStateWithIdVector) -> PTHSKStateVector:
    ...
    """
def serialize(states: PTHSKStateWithIdVector) -> list[str]:
    """
