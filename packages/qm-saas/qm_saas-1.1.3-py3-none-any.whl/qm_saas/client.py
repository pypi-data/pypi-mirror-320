...
class QmSaasInstance:
    ...
    def __init__(self, client: Client, version: QoPVersion, cluster_config: ClusterConfig=None, auto_cleanup: bool = True, log: logging.Logger = None):
        """
        Create a simulator instance on the cloud platform.

        Args:
            client (Client): The client to use for the simulator instance
            version (QoPVersion): The QoP version to use for the simulator instance
...
class QmSaas:
    ...
    def simulator(self, version: QoPVersion = QoPVersion.latest, cluster_config: ClusterConfig=None) -> QmSaasInstance:
        """
        Create a simulator instance on the cloud platform.
