...
class AttributeValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["val_bool", b"val_bool", "val_double", b"val_double", "val_float", b"val_float", "val_float_array", b"val_float_array", "val_int", b"val_int", "val_int_array", b"val_int_array", "val_null", b"val_null", "val_str", b"val_str", "val_str_array", b"val_str_array", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["val_bool", b"val_bool", "val_double", b"val_double", "val_float", b"val_float", "val_float_array", b"val_float_array", "val_int", b"val_int", "val_int_array", b"val_int_array", "val_null", b"val_null", "val_str", b"val_str", "val_str_array", b"val_str_array", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["val_bool", "val_str", "val_float", "val_int", "val_null", "val_str_array", "val_int_array", "val_float_array", "val_double"] | None: ...
