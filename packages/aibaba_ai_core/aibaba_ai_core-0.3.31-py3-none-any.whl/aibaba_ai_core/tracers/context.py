...
from aibaba_ai_core.tracers.schemas import TracerSessionV1

if TYPE_CHECKING:
    from langsmith import Client as LangSmithClient

    from aibaba_ai_core.callbacks.base import BaseCallbackHandler, Callbacks
    from aibaba_ai_core.callbacks.manager import AsyncCallbackManager, CallbackManager
...
def tracing_v2_enabled(
    ...
    *,
    ...
    """Instruct Aibaba AI to log all runs in context to LangSmith.
    ...
    Yields:
        AI Agents ForceTracer: The Aibaba AI tracer.

    Example:
        >>> with tracing_v2_enabled():
        ...     # Aibaba AI code will automatically be traced
