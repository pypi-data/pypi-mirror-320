...
from aibaba-ai-core.vectorstores.utils import _cosine_similarity as cosine_similarity
from aibaba-ai-core.vectorstores.utils import maximal_marginal_relevance

if TYPE_CHECKING:
    from aibaba-ai-core.indexing import UpsertResponse
