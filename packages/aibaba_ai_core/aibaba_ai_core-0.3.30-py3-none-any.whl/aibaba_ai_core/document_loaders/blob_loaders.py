...
from aibaba-ai-core.documents.base import Blob as Blob
from aibaba-ai-core.documents.base import PathLike as PathLike
...
class BlobLoader(ABC):
    ...
    def yield_blobs(
        ...
        """A lazy loader for raw data represented by Aibaba AI's Blob object.
