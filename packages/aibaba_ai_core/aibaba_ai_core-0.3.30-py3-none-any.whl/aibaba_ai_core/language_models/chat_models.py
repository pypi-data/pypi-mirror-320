...
from aibaba-ai-core.globals import get_llm_cache
...
from aibaba-ai-core.prompt_values import ChatPromptValue, PromptValue, StringPromptValue
from aibaba-ai-core.rate_limiters import BaseRateLimiter
from aibaba-ai-core.runnables import RunnableMap, RunnablePassthrough
from aibaba-ai-core.runnables.config import ensure_config, run_in_executor
...
class BaseChatModel(BaseLanguageModel[BaseMessage], ABC):
    ...
    Creating custom chat model:
        ...
        [Guide](https://docs.aibaba.world/docs/how_to/custom_chat_model/).
