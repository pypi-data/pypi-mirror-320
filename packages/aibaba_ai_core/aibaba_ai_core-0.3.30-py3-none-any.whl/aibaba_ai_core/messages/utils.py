...
from aibaba-ai-core.exceptions import ErrorCode, create_message
from aibaba-ai-core.messages.ai import AIMessage, AIMessageChunk
from aibaba-ai-core.messages.base import BaseMessage, BaseMessageChunk
from aibaba-ai-core.messages.chat import ChatMessage, ChatMessageChunk
from aibaba-ai-core.messages.function import FunctionMessage, FunctionMessageChunk
from aibaba-ai-core.messages.human import HumanMessage, HumanMessageChunk
from aibaba-ai-core.messages.modifier import RemoveMessage
from aibaba-ai-core.messages.system import SystemMessage, SystemMessageChunk
from aibaba-ai-core.messages.tool import ToolCall, ToolMessage, ToolMessageChunk
...
if TYPE_CHECKING:
    ...
    from aibaba-ai-core.runnables.base import Runnable
...
def get_buffer_string(
    ...
    Example:
        .. code-block:: python
            ...
            from aibaba-ai-core import AIMessage, HumanMessage
    ...
    **additional_kwargs: Any,
    ...
    if tool_calls is not None:
        ...
        for tool_call in tool_calls:
            # Convert OpenAI-format tool call to Aibaba AI format.
    ...
    *,
    ...
    Example:
        .. code-block:: python
            ...
            from aibaba-ai-core.messages import filter_messages, AIMessage, HumanMessage, SystemMessage
...
def trim_messages(
    ...
    *,
    ...
    1. The resulting chat history should be valid. Most chat models expect that chat
       ...
       https://docs.aibaba.world/docs/concepts/#messages
...
def convert_to_openai_messages(
    ...
    *,
    ...
    """Convert Aibaba AI messages into OpenAI message dicts.
