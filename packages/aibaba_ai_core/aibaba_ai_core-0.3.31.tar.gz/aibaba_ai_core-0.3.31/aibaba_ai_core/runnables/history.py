...
from aibaba_ai_core.runnables.base import Runnable, RunnableBindingBase, RunnableLambda
...
if TYPE_CHECKING:
    from aibaba_ai_core.language_models.base import LanguageModelLike
...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    .. code-block:: python
        ...
        from aibaba_ai_core.messages import BaseMessage, AIMessage
