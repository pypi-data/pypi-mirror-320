...
from aibaba_ai_core._api import beta_decorator
from aibaba_ai_core.load.serializable import (
    Serializable,
...
from aibaba_ai_core.runnables.graph import Graph
...
from aibaba_ai_core.utils.aiter import aclosing, atee, py_anext
from aibaba_ai_core.utils.iter import safetee
from aibaba_ai_core.utils.pydantic import create_model_v2
...
if TYPE_CHECKING:
    ...
    from aibaba_ai_core.runnables.fallbacks import (
    ...
    **RunnableParallel** invokes runnables concurrently, providing the same input
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, list[str]]) -> RunnableSerializable[Any, Any]:
        ...
        Pick single key:
            .. code-block:: python
                ...
                from aibaba_ai_core.runnables import RunnableLambda, RunnableMap
        ...
        """
        from aibaba_ai_core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        """
        from aibaba_ai_core.runnables.passthrough import RunnableAssign
    ...
    async def astream_events(
        ...
        **ATTENTION** This reference table is for the V2 version of the schema.
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.runnables import RunnableLambda, RunnableConfig
            import asyncio
        ...
        """  # noqa: E501
        from aibaba_ai_core.tracers.event_stream import (
    ...
    def with_retry(
        ...
        *,
        ...
        Returns:
            A new Runnable that retries the original Runnable on exceptions.
        """
        from aibaba_ai_core.runnables.retry import RunnableRetry
        ...
        *,
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from aibaba_ai_core.runnables import RunnableGenerator
    ...
    def _transform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba_ai_core.tracers._streaming import _StreamingCallbackHandler
    ...
    def as_tool(
        ...
        *,
        ...
        from aibaba_ai_core.tools import convert_runnable_to_tool
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.runnables import ConfigurableField
        ...
        """
        from aibaba_ai_core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.runnables.utils import ConfigurableField
            from langchain_openai import ChatOpenAI
        ...
        """
        from aibaba_ai_core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from aibaba_ai_core.runnables.passthrough import RunnableAssign, RunnablePick
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    **RunnableSequence** is the most important composition operator in Aibaba AI
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        ...
        """
        from aibaba_ai_core.beta.runnables.context import (
    ...
    def invoke(
        ...
        from aibaba_ai_core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba_ai_core.beta.runnables.context import aconfig_with_context
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba_ai_core.beta.runnables.context import aconfig_with_context
        from aibaba_ai_core.callbacks.manager import AsyncCallbackManager
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    context. Below we show an example:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.prompts import ChatPromptTemplate
            from aibaba_ai_core.runnables import RunnableGenerator, RunnableLambda
            from langchain_openai import ChatOpenAI
            from aibaba_ai_core.output_parsers import StrOutputParser
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    with a Runnable:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.runnables.base import RunnableEach
            from langchain_openai import ChatOpenAI
            from aibaba_ai_core.prompts import ChatPromptTemplate
            from aibaba_ai_core.output_parsers import StrOutputParser
...
def chain(
    ...
    .. code-block:: python
        ...
        from aibaba_ai_core.runnables import chain
