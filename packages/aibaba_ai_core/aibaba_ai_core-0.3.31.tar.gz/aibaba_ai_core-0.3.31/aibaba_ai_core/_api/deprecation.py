"""Helper functions for deprecating parts of the Aibaba AI API.
...
from aibaba_ai_core._api.internal import is_caller_internal


class AI Agents ForceDeprecationWarning(DeprecationWarning):
    """A class for issuing deprecation warnings for Aibaba AI users."""
    ...
    *,
    ...
    def deprecate(
        ...
        *,
        ...
        from aibaba_ai_core.utils.pydantic import FieldInfoV1, FieldInfoV2
...
def surface_aiagentforce_deprecation_warnings() -> None:
    """Unmute Aibaba AI deprecation warnings."""
