...
from aibaba_ai_core.callbacks.base import (
    BaseCallbackHandler,
    BaseCallbackManager,
    Callbacks,
    ChainManagerMixin,
...
if TYPE_CHECKING:
    ...
    from aibaba_ai_core.outputs import ChatGenerationChunk, GenerationChunk, LLMResult
...
def _get_debug() -> bool:
    from aibaba_ai_core.globals import get_debug
...
def trace_as_chain_group(
    ...
    *,
    ...
    """  # noqa: E501
    from aibaba_ai_core.tracers.context import _get_trace_callbacks
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # <class 'aibaba_ai_core.callbacks.manager.CallbackManagerForChainGroup'>

                    print(merged_manager.handlers)
                    # [
                    #    <aibaba_ai_core.callbacks.stdout.AI Agents ForceTracer object at ...>,
                    #    <aibaba_ai_core.callbacks.streaming_stdout.StdOutCallbackHandler object at ...>,
                    # ]
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from aibaba_ai_core.callbacks.manager import CallbackManager, atrace_as_chain_group
                from aibaba_ai_core.callbacks.stdout import StdOutCallbackHandler
                ...
                async with atrace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    merged_manager = group_manager.merge(manager)
                    print(type(merged_manager))
                    # <class 'aibaba_ai_core.callbacks.manager.AsyncCallbackManagerForChainGroup'>
...
async def adispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.runnable import RunnableLambda
...
def dispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.callbacks import dispatch_custom_event
            from aibaba_ai_core.runnable import RunnableLambda
