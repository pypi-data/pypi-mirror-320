...
class ThrottlingValve(jneqsim.neqsim.process.equipment.TwoPortEquipment, ValveInterface):
    ...
    def calcPercentValveOpeningLiquid(self, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> float: ...
    ...
    def liquidValveCv(self, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> float: ...
    def liquidValveMassFlow(self, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> float: ...
