                ...
                with sync_playwright() as p:
                    ...
                    for i,browser_budle in enumerate(browser_Bundle_List):
                        if path.exists(browser_budle.executable_path):
                            ...
                            return i
            print(f"error: can't get the preparser browser bundle for dynamic html !!!")
        except Exception as err:
            print(f"error: when check the preparser browser bundle, error:{err} !!!")
        print(f'please try again, if failed again, please reinstall preparser with cmd : `pip install preparser` !!!')
        self.stop_parse()
        return -1          
