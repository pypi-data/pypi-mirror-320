...
from InstallHelper import BrowserCoreInstaller
...
setup(
    ...
    classifiers=[  # package class label, which helps user learn about current package
        "Development Status :: 4 - Beta",   # developed status, reference: https://packaging.python.org/specifications/core-metadata # https://pypi.org/classifiers/
    ...
    cmdclass={
        'download_browser_core':BrowserCoreInstaller,   # excute the installer 
    },
