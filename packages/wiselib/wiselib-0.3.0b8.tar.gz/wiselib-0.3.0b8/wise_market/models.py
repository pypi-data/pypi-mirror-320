...
from wise.utils.numbers import is_zero, safe_mult, to_decimal
...
class ExchangeMarketPairBinding(BaseModel):
    ...
    price_decimals = models.IntegerField(default=9)
    quantity_decimals = models.IntegerField(default=9)
    price_step_size = models.DecimalField(
        decimal_places=20, max_digits=20, default=to_decimal(1e-9)
    )
...
class NetworkSymbolBinding(BaseModel):
    ...
    decimals = models.IntegerField(default=9)
