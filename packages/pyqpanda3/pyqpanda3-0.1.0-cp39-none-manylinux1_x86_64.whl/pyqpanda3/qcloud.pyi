...
class QCloudBackend:
    ...
    def run(self, prog, shots: int, model: QCloudNoiseModel = ...) -> QCloudJob:
        ...
        1. run(self: qcloud.QCloudBackend, prog: QPanda::QProg, shots: int, model: qcloud.QCloudNoiseModel = <qcloud.QCloudNoiseModel object at 0x7ff55e01b130>) -> qcloud.QCloudJob
