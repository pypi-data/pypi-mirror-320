...
class VQCResult:
    ...
    def expval_hamiltonian(self, hamiltonian, exp_type: ExpectationType = ...) -> list[float]:
        ...
        1. expval_hamiltonian(self: vqcircuit.VQCResult, hamiltonian: QPanda::Hamiltonian, exp_type: vqcircuit.ExpectationType = <ExpectationType.THEORETICAL: 0>) -> list[float]
        ...
        2. expval_hamiltonian(self: vqcircuit.VQCResult, hamiltonian: QPanda::Hamiltonian, idx_s: list[int], exp_type: vqcircuit.ExpectationType = <ExpectationType.THEORETICAL: 0>) -> float
        ...
        """
    @overload
    def expval_hamiltonian(self, hamiltonian, idx_s: list[int], exp_type: ExpectationType = ...) -> float:
        """expval_hamiltonian(*args, **kwargs)
        Overloaded function.
    ...
    def expval_pauli_operator(self, pauli_operator, exp_type: ExpectationType = ...) -> list[float]:
        ...
        1. expval_pauli_operator(self: vqcircuit.VQCResult, pauli_operator: QPanda::PauliOperator, exp_type: vqcircuit.ExpectationType = <ExpectationType.THEORETICAL: 0>) -> list[float]
        ...
        2. expval_pauli_operator(self: vqcircuit.VQCResult, pauli_operator: QPanda::PauliOperator, idx_s: list[int], exp_type: vqcircuit.ExpectationType = <ExpectationType.THEORETICAL: 0>) -> float
        ...
        """
    @overload
    def expval_pauli_operator(self, pauli_operator, idx_s: list[int], exp_type: ExpectationType = ...) -> float:
        """expval_pauli_operator(*args, **kwargs)
        Overloaded function.
...
class VQCircuit:
    ...
    def __call__(self, *args, **kwargs):
        """__call__(self: vqcircuit.VQCircuit, params: numpy.ndarray[numpy.float64]) -> QPanda::VQCircuitResult
    ...
    def __lshift__(self, qgate) -> VQCircuit:
        ...
        1. __lshift__(self: vqcircuit.VQCircuit, qgate: QPanda::QGate) -> vqcircuit.VQCircuit
        ...
        2. __lshift__(self: vqcircuit.VQCircuit, qcircuit: QPanda::QCircuit) -> vqcircuit.VQCircuit
        ...
        3. __lshift__(self: vqcircuit.VQCircuit, vqgate: tuple[QPanda::VariationalQuantumGate, list[Union[float, list[int]]]]) -> vqcircuit.VQCircuit
