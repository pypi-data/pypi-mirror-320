...
class QCloudBackend:
    ...
    def run(self, prog, shots: int, model: QCloudNoiseModel = ...) -> QCloudJob:
        ...
        1. run(self: qcloud.QCloudBackend, prog: QPanda::QProg, shots: int, model: qcloud.QCloudNoiseModel = <qcloud.QCloudNoiseModel object at 0x7fc25876de70>) -> qcloud.QCloudJob
        ...
        3. run(self: qcloud.QCloudBackend, prog: QPanda::QProg, qubits: std::initializer_list<unsigned long>) -> qcloud.QCloudJob
