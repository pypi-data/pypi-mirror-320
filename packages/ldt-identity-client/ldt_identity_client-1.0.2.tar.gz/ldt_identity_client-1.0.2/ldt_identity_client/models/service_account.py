...
class ServiceAccount(BaseModel):
    ...
    client_secret: Optional[StrictStr] = Field(default=None, description="Only returned when the account is created, never again.", alias="clientSecret")
    __properties: ClassVar[List[str]] = ["clientId", "name", "createdAt", "type", "clientSecret"]
