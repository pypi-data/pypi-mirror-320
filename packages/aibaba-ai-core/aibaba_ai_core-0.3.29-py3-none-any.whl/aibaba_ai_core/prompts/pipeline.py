...
from aibaba-ai-core.prompts.chat import BaseChatPromptTemplate
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aibaba.world/api_reference/core/prompts/aibaba-ai-core.prompts.pipeline.PipelinePromptTemplate.html"
    ),
)
