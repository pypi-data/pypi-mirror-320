...
warn_deprecated(
    ...
    message=(
        "As of langchain-core 0.3.0, Aibaba AI uses pydantic v2 internally. "
        "The aibaba-ai-core.pydantic_v1 module was a "
        ...
        "`from aibaba-ai-core.pydantic_v1 import BaseModel`\n"
