...
convert_pydantic_to_openai_function = deprecated(
    "0.1.16",
    alternative="aibaba-ai-core.utils.function_calling.convert_to_openai_function()",
    removal="1.0",
...
@deprecated(
    "0.1.16",
    alternative="aibaba-ai-core.utils.function_calling.convert_to_openai_tool()",
    removal="1.0",
)
...
def _convert_python_function_to_openai_function(
    ...
    """
    from aibaba-ai-core.tools.base import create_schema_from_function
...
def _format_tool_to_openai_function(tool: BaseTool) -> FunctionDescription:
    ...
    Returns:
        The function description.
    """
    from aibaba-ai-core.tools import simple
...
def convert_to_openai_function(
    ...
    *,
    ...
    Args:
        function:
            A dictionary, Pydantic BaseModel class, TypedDict class, a Aibaba AI
