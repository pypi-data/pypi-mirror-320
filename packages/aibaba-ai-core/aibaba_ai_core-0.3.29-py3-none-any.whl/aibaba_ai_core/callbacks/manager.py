...
from aibaba-ai-core.callbacks.base import (
    BaseCallbackHandler,
    BaseCallbackManager,
    Callbacks,
    ChainManagerMixin,
...
from aibaba-ai-core.messages import BaseMessage, get_buffer_string
...
if TYPE_CHECKING:
    ...
    from aibaba-ai-core.outputs import ChatGenerationChunk, GenerationChunk, LLMResult
...
def _get_debug() -> bool:
    from aibaba-ai-core.globals import get_debug
...
def trace_as_chain_group(
    ...
    *,
    ...
    """  # noqa: E501
    from aibaba-ai-core.tracers.context import _get_trace_callbacks
...
class CallbackManager(BaseCallbackManager):
    """Callback manager for Aibaba AI."""
    ...
    def on_custom_event(
        ...
        **kwargs: Any,
        ...
        This event should NOT be used in any internal Aibaba AI code. The event
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # <class 'aibaba-ai-core.callbacks.manager.CallbackManagerForChainGroup'>

                    print(merged_manager.handlers)
                    # [
                    #    <aibaba-ai-core.callbacks.stdout.AI Agents ForceTracer object at ...>,
                    #    <aibaba-ai-core.callbacks.streaming_stdout.StdOutCallbackHandler object at ...>,
                    # ]
...
class AsyncCallbackManager(BaseCallbackManager):
    """Async callback manager that handles callbacks from Aibaba AI."""
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from aibaba-ai-core.callbacks.manager import CallbackManager, atrace_as_chain_group
                from aibaba-ai-core.callbacks.stdout import StdOutCallbackHandler
                ...
                async with atrace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    merged_manager = group_manager.merge(manager)
                    print(type(merged_manager))
                    # <class 'aibaba-ai-core.callbacks.manager.AsyncCallbackManagerForChainGroup'>
...
async def adispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.runnable import RunnableLambda
    ...
    .. warning::
        ...
        Aibaba AI from automatically propagating the config object on the user's
        behalf.
...
def dispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.callbacks import dispatch_custom_event
            from aibaba-ai-core.runnable import RunnableLambda
