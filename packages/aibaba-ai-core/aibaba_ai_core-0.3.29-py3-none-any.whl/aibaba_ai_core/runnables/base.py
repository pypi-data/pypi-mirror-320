...
from aibaba-ai-core._api import beta_decorator
from aibaba-ai-core.load.serializable import (
    Serializable,
...
from aibaba-ai-core.runnables.graph import Graph
...
from aibaba-ai-core.utils.aiter import aclosing, atee, py_anext
from aibaba-ai-core.utils.iter import safetee
from aibaba-ai-core.utils.pydantic import create_model_v2
...
if TYPE_CHECKING:
    ...
    from aibaba-ai-core.runnables.fallbacks import (
...
class Runnable(Generic[Input, Output], ABC):
    ...
    The Aibaba AI Expression Language (LCEL) is a declarative way to compose Runnables
    ...
    **RunnableParallel** invokes runnables concurrently, providing the same input
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, list[str]]) -> RunnableSerializable[Any, Any]:
        ...
        Pick single key:
            .. code-block:: python
                ...
                from aibaba-ai-core.runnables import RunnableLambda, RunnableMap
        ...
        """
        from aibaba-ai-core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.prompts import SystemMessagePromptTemplate
        ...
        """
        from aibaba-ai-core.runnables.passthrough import RunnableAssign
    ...
    async def astream_events(
        ...
        **ATTENTION** This reference table is for the V2 version of the schema.
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.runnables import RunnableLambda, RunnableConfig
            import asyncio
        ...
        """  # noqa: E501
        from aibaba-ai-core.tracers.event_stream import (
    ...
    def with_retry(
        ...
        *,
        ...
        Returns:
            A new Runnable that retries the original Runnable on exceptions.
        """
        from aibaba-ai-core.runnables.retry import RunnableRetry
        ...
        *,
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from aibaba-ai-core.runnables import RunnableGenerator
    ...
    def _transform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba-ai-core.tracers._streaming import _StreamingCallbackHandler
    ...
    def as_tool(
        ...
        *,
        ...
        from aibaba-ai-core.tools import convert_runnable_to_tool
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.runnables import ConfigurableField
        ...
        """
        from aibaba-ai-core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.runnables.utils import ConfigurableField
            from langchain_openai import ChatOpenAI
        ...
        """
        from aibaba-ai-core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from aibaba-ai-core.runnables.passthrough import RunnableAssign, RunnablePick
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    **RunnableSequence** is the most important composition operator in Aibaba AI
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.output_parsers.json import SimpleJsonOutputParser
            from langchain_openai import ChatOpenAI
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        ...
        """
        from aibaba-ai-core.beta.runnables.context import (
    ...
    def invoke(
        ...
        from aibaba-ai-core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba-ai-core.beta.runnables.context import aconfig_with_context
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from aibaba-ai-core.beta.runnables.context import aconfig_with_context
        from aibaba-ai-core.callbacks.manager import AsyncCallbackManager
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    context. Below we show an example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.prompts import ChatPromptTemplate
            from aibaba-ai-core.runnables import RunnableGenerator, RunnableLambda
            from langchain_openai import ChatOpenAI
            from aibaba-ai-core.output_parsers import StrOutputParser
...
class RunnableLambda(Runnable[Input, Output]):
    ...
    seamless integration with Aibaba AI tracing.
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    with a Runnable:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.runnables.base import RunnableEach
            from langchain_openai import ChatOpenAI
            from aibaba-ai-core.prompts import ChatPromptTemplate
            from aibaba-ai-core.output_parsers import StrOutputParser
...
def chain(
    ...
    .. code-block:: python
        ...
        from aibaba-ai-core.runnables import chain
