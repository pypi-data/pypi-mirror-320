...
from aibaba-ai-core.runnables.base import Input, Output, RunnableBindingBase
from aibaba-ai-core.runnables.config import RunnableConfig, patch_config
...
class RunnableRetry(RunnableBindingBase[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.chat_models import ChatOpenAI
