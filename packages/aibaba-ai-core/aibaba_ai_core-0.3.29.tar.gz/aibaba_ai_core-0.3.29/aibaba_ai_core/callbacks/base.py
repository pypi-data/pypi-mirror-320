"""Base callback handler for Aibaba AI."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler for Aibaba AI."""
...
class BaseCallbackManager(CallbackManagerMixin):
    """Base callback manager for Aibaba AI."""
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # [
                    #    <aibaba-ai-core.callbacks.stdout.StdOutCallbackHandler object at ...>,
                    #    <aibaba-ai-core.callbacks.streaming_stdout.StreamingStdOutCallbackHandler object at ...>,
                    # ]
