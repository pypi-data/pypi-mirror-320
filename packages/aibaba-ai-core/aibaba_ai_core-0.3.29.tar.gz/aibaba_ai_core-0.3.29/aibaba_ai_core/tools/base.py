...
from aibaba-ai-core.messages.tool import ToolCall, ToolMessage, ToolOutputMixin
...
from aibaba-ai-core.runnables.config import _set_config_context
from aibaba-ai-core.runnables.utils import asyncio_accepts_context
...
class BaseTool(RunnableSerializable[Union[str, dict, ToolCall], Any]):
    """Interface Aibaba AI tools must implement."""
...
class InjectedToolCallId(InjectedToolArg):
    ...
    Example:
        ..code-block:: python
            ...
            from aibaba-ai-core.tools import tool, InjectedToolCallID
