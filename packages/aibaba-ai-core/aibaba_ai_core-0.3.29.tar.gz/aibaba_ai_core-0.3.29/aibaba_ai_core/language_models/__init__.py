...
Aibaba AI has two main classes to work with language models: **Chat Models**
...
should inherit from this class. Please see Aibaba AI how-to guides with more
...
https://docs.aibaba.world/docs/how_to/custom_chat_model/
...
Although the underlying models are string in, string out, the Aibaba AI wrappers
...
https://docs.aibaba.world/docs/how_to/custom_llm/


"""  # noqa: E501

from aibaba-ai-core.language_models.base import (
    BaseLanguageModel,
    LangSmithParams,
    LanguageModelInput,
    LanguageModelLike,
...
from aibaba-ai-core.language_models.fake import FakeListLLM, FakeStreamingListLLM
...
from aibaba-ai-core.language_models.llms import LLM, BaseLLM
