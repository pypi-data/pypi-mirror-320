...
from aibaba-ai-core.utils.aiter import py_anext

if TYPE_CHECKING:
    from aibaba-ai-core.callbacks.manager import AsyncCallbackManagerForChainRun
...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.chat_models.openai import ChatOpenAI
            from aibaba-ai-core.chat_models.anthropic import ChatAnthropic
            ...
            from aibaba-ai-core.output_parser import StrOutputParser
