    ...
    match orm_obj:
        ...
        case orm.Space():
            return models_pb2.Space(
                ...
                description=orm_obj.description,
                room_id=str(orm_obj.room_id),
                space_parameters=orm_obj.parameters,
                feature_view_id=str(orm_obj.feature_view_id),
                auto_sync=orm_obj.auto_sync if orm_obj.auto_sync is not None else False,
                org_id=str(orm_obj.org_id),
                created_at=created_at,
            )
...
def proto_to_orm(
    ...
    match proto_obj:
        ...
        case models_pb2.Space():
            return _space_proto_to_orm(proto_obj, session)
        case models_pb2.FeatureViewSource():
