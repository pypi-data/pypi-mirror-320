...
class NaturezaOperacao(Enum):
    ...
    BONIFICACAO_SAIDA = ("bonificacao_saida", "venda", "saida", "Bonificação")
    AMOSTRA_GRATIS_SAIDA = ("amostra_gratis_saida", "venda", "saida", "Amostra gratis")
    ...
    INDUSTRIALIZACAO_SAIDA = ("industrializacao_saida", "industrializacao", "saída", "Mão de obra")
    ...
    REMESSA_CONSERTO_SAIDA = ("remessa_conserto", "remessa", "saida", "Remessa para conserto")        
    ...
    DEVOLUCAO_VASILHAME_SAIDAS = ("devolucao_vasilhame_saidas", "devolucao", "saida", "Devolução de vasilhame")
    REMESSA_VASILHAME_SAIDAS = ("remessa_vasilhame_saidas", "remessa", "saida", "Remessa de vasilhame")
    ...
    BONIFICACAO_ENTRADA = ("bonificacao_entrada", "venda", "entrada", "Bonificação")    
    DEVOLUCAO_COMPRA = ("devolucao_compra", "devolucao", "saida", "Devolução de compra")    
    TRANSFERENCIA_PRODUCAO_ENTRADA = ("transferencia_producao_entrada", "transferencia", "entrada", "Transferência de produção")
    TRANSFERENCIA_MERCADORIA_ENTRADA = ("transferencia_mercadoria_entrada", "transferencia", "entrada", "Transferência de mercadoria")    
    INDUSTRIALIZACAO_ENTRADA = ("industrializacao_entrada", "industrializacao", "entrada", "Mão de obra/servicos")
    RETORNO_CONSERTO_ENTRADA = ("retorno_conserto", "retorno", "entrada", "Retorno de conserto")    
    REMESSA_CONSERTO_ENTRADA = ("remessa_conserto", "remessa", "entrada", "Remessa para conserto")
    OUTRAS_ENTRADAS = ("outras_entradas", "outras", "entradas", "Outras entradas")
    DEVOLUCAO_VASILHAME_ENTRADAS = ("devolucao_vasilhame_entradas", "devolucao", "entrada", "Devolução de vasilhame")
    REMESSA_VASILHAME_ENTRADAS = ("remessa_vasilhame_entradas", "remessa", "entrada", "Remessa de vasilhame") 
