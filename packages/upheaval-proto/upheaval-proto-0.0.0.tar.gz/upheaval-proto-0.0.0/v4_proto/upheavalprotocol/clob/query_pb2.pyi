...
from v4_proto.upheavalprotocol.clob import block_rate_limit_config_pb2 as _block_rate_limit_config_pb2
from v4_proto.upheavalprotocol.clob import clob_pair_pb2 as _clob_pair_pb2
from v4_proto.upheavalprotocol.clob import equity_tier_limit_config_pb2 as _equity_tier_limit_config_pb2
from v4_proto.upheavalprotocol.clob import order_pb2 as _order_pb2
from v4_proto.upheavalprotocol.clob import matches_pb2 as _matches_pb2
from v4_proto.upheavalprotocol.clob import liquidations_config_pb2 as _liquidations_config_pb2
from v4_proto.upheavalprotocol.clob import mev_pb2 as _mev_pb2
from v4_proto.upheavalprotocol.indexer.off_chain_updates import off_chain_updates_pb2 as _off_chain_updates_pb2
from v4_proto.upheavalprotocol.subaccounts import streaming_pb2 as _streaming_pb2
from v4_proto.upheavalprotocol.subaccounts import subaccount_pb2 as _subaccount_pb2
from v4_proto.upheavalprotocol.prices import streaming_pb2 as _streaming_pb2_1
...
class StreamOrderbookUpdatesRequest(_message.Message):
    __slots__ = ("clob_pair_id", "subaccount_ids", "market_ids")
    CLOB_PAIR_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, clob_pair_id: _Optional[_Iterable[int]] = ..., subaccount_ids: _Optional[_Iterable[_Union[_subaccount_pb2.SubaccountId, _Mapping]]] = ..., market_ids: _Optional[_Iterable[int]] = ...) -> None: ...
