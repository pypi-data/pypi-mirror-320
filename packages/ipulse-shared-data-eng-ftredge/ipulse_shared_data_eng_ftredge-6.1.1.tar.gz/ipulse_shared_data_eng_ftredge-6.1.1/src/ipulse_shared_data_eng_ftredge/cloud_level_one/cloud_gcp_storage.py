...
def read_file_from_gcs_extended(storage_client:GCSClient, bucket_name:str, file_path:str,
    ...
    try:
        ...
        log_by_lvl(
            info_msg=f"{function_name}: Fetched {len(data)} records",
...
def write_file_to_gcs_extended(storage_client: GCSClient,
    ...
    try:
        ...
        cloud_storage_ref = resource=DataResource.GCS
        ...
        result.final(status=ProgressStatus.DONE if success else ProgressStatus.FAILED)
