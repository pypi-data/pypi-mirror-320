...
def create_app(pyproject_toml, category, llm_config):
    ...
    app.add_event_handler("startup", get_startup_event(app, category=category, pyproject_toml=pyproject_toml, llm_config=llm_config))
