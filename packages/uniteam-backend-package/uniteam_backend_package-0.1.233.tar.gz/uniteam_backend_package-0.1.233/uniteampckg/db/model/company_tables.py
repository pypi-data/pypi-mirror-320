...
class CompanyModuleMap(BaseTableModel):
    ...
    module_feed: Optional[str] = Column()
    module_connect: Optional[str] = Column()
    module_survey: Optional[str] = Column()
    module_contest: Optional[str] = Column()
    module_recognition: Optional[str] = Column()
    module_events: Optional[str] = Column()
    module_analytics: Optional[str] = Column()
    module_shop: Optional[str] = Column()
    module_notification: Optional[str] = Column()
    hris_intergration: Optional[str] = Column()
    custom_branding: Optional[str] = Column()
    custom_color_theme: Optional[str] = Column()
    authentication_mode: Optional[str] = Column()
    feed_story: Optional[str] = Column()
    feed_community: Optional[str] = Column()
    feed_recognition: Optional[str] = Column()
    feed_polls: Optional[str] = Column()
    feed_profanity_check: Optional[str] = Column()
    connect_dms: Optional[str] = Column()
    connect_space: Optional[str] = Column()
    connect_huddle: Optional[str] = Column()
    connect_huddle_global_limit: Optional[str] = Column()
    connect_meet: Optional[str] = Column()
    connect_meet_global_limit: Optional[str] = Column()
    connect_threads: Optional[str] = Column()
    connect_campaigns: Optional[str] = Column()
    survey_recurring: Optional[str] = Column()
    notification_emails: Optional[str] = Column()
    notification_sms: Optional[str] = Column()
    notification_push: Optional[str] = Column()
