...
WorkerPingType = Callable[[], bool]
ExecuteContextReturnType = Generator[Tuple[ExecuteType, WorkerPingType], None, None]
...
class RemoteExecutor(futures.Executor):
    ...
    def _worker_main(self):
        ...
        try:
            with self.execute_context() as (execute, ping):
