...
class NetworkConfig:
    ...
    __annotations__ = ...
    def __init__(self, arbitrum_rpc_url, ethereum_rpc_url, gnosis_rpc_url, deployments, runtime_bytecodes, abis, bytecodes, creation_codes, allow_bad_archive_node=...) -> None: ...
