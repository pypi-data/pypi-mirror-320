...
## Data Usage Terms
Data generated by this library is for personal or internal use only.

Please note that while the Rasteret library code is open-source, the data files generated by the library are subject to separate usage terms.

The generated data is restricted and **not allowed for commercial use** without prior written permission from the Rasteret project maintainers.