...
class Authenticator(dns_common.DNSAuthenticator):
    ...
    def _perform(self, domain, validation_name, validation):
        ...
        decoded_validation_name = idna.decode(validation_name)
        try:
            logger.debug("perform %s, %s", validation_name, validation)
            self._api_client().add_txt_record(decoded_domain, decoded_validation_name, validation)
    ...
    def _cleanup(self, domain, validation_name, validation):
        ...
        try:
            ...
            self._api_client().del_txt_record(decoded_domain, decoded_validation_name, validation)
        except ValueError as err:
