...
class NoteApp(QMainWindow):
    def __init__(self):
        ...
        self.notes_list_file = os.path.join(self.program_dir, "notes_list.xml")  # 常用文件列表路径
    ...
    def initUI(self):
        self.setWindowTitle('笔记软件 v 0.0.5')  # 添加版本号
        ...
        main_layout.addLayout(favorites_layout, 1)
