...
class IOrmImpl(ABC):
    ...
    @abstractmethod
    def _kbatch_create(self, *args: Any, **kwargs: Any) -> Callable[..., Any]:
        raise NotImplementedError
    ...
    @abstractmethod
    def _kupload_file(self, *args: Any, **kwargs: Any) -> Callable[..., Any]:
        raise NotImplementedError
    
    @abstractmethod
    def _kupdate_file(self, *args: Any, **kwargs: Any) -> Callable[..., Any]:
        raise NotImplementedError
...
class CRUDGenerator(Generic[T], APIRouter, IOrmImpl):
    ...
    def __init__(
        ...
        kupload_file_route: Union[bool, DEPENDENCIES] = True,
        kupdate_file_route: Union[bool, DEPENDENCIES] = True,
        ...
        **kwargs: Any,
        ...
        if kbatch_create_route:
            self._add_api_route(
                ...
                dependencies=kbatch_create_route,
            )
