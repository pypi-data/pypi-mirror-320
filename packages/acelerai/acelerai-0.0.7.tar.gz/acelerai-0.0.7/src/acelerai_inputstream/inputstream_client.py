...
if __mode == "LOCAL":
    ...
    # Environment production
    DATA_URL        = os.environ.get("DATA_URL", "https://inputstreamdata-service:1008")
    QUERY_MANAGER   = os.environ.get("QUERY_MANAGER", "https://querymanager-service:1012")
    INPUTSTREAM_URL = os.environ.get("INPUTSTREAM_URL", "https://apigateway-service:1006")
    verify_https = False
