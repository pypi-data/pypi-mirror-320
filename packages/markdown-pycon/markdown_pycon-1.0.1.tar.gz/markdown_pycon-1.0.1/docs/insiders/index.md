...
*Markdown PyCon* follows the **sponsorware** release strategy, which means
...
*Markdown PyCon Insiders* is a private fork of *Markdown PyCon*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *Markdown PyCon*.
...
*Markdown PyCon* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *Markdown PyCon*,
...
<small>
  ...
  your profile and avatar to show your support for *Markdown PyCon*.
...
to use *Markdown PyCon* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *Markdown PyCon*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *Markdown PyCon
Insiders* precisely under the same terms as *Markdown PyCon*, which are given
