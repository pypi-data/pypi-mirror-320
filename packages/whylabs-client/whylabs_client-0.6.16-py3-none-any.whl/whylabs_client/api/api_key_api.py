...
class ApiKeyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_api_key_metadata_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/api-key',
                'operation_id': 'list_api_key_metadata',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.validate_api_key_endpoint = _Endpoint(
            settings={
                'response_type': (Response,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v1/api-key/validate',
    ...
    def list_api_key_metadata(
        self,
        **kwargs
    ):
        """List API key metadata for a given organization  # noqa: E501

        Returns the API key metadata for a given organization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_api_key_metadata(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_api_key_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def validate_api_key(
        ...
        **kwargs
        ...
        """Validate API key access  # noqa: E501

        Returns the status code 200 if the API key is valid, 403 if the API key is invalid  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.validate_api_key_endpoint.call_with_http_info(**kwargs)
