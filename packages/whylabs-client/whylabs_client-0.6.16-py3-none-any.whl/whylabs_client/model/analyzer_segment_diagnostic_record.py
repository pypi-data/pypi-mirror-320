...
class AnalyzerSegmentDiagnosticRecord(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, segment, total_anomalies, batch_count, *args, **kwargs):  # noqa: E501
        """AnalyzerSegmentDiagnosticRecord - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, segment, total_anomalies, batch_count, *args, **kwargs):  # noqa: E501
        """AnalyzerSegmentDiagnosticRecord - a model defined in OpenAPI
