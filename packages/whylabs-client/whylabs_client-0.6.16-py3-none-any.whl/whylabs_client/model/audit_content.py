...
class AuditContent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message_id, content, *args, **kwargs):  # noqa: E501
        """AuditContent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message_id, content, *args, **kwargs):  # noqa: E501
        """AuditContent - a model defined in OpenAPI
