...
class WebhookNotificationAction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, method, headers, *args, **kwargs):  # noqa: E501
        """WebhookNotificationAction - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, method, headers, *args, **kwargs):  # noqa: E501
        """WebhookNotificationAction - a model defined in OpenAPI
