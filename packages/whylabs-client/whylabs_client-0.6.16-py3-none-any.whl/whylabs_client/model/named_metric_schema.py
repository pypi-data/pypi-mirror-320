...
class NamedMetricSchema(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, label, column, builtin_metric, *args, **kwargs):  # noqa: E501
        """NamedMetricSchema - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, column, builtin_metric, *args, **kwargs):  # noqa: E501
        """NamedMetricSchema - a model defined in OpenAPI
