...
class MetricSchemaFields(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, column, builtin_metric, *args, **kwargs):  # noqa: E501
        """MetricSchemaFields - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, column, builtin_metric, *args, **kwargs):  # noqa: E501
        """MetricSchemaFields - a model defined in OpenAPI
