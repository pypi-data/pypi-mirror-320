...
class AssetTagEntry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, asset_id, tag, *args, **kwargs):  # noqa: E501
        """AssetTagEntry - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_id, tag, *args, **kwargs):  # noqa: E501
        """AssetTagEntry - a model defined in OpenAPI
