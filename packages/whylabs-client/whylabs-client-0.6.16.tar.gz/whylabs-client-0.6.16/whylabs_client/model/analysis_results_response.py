...
def lazy_import():
    ...
    globals()['AnalysisResultsRecord'] = AnalysisResultsRecord


class AnalysisResultsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([AnalysisResultsRecord],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """AnalysisResultsResponse - a model defined in OpenAPI

        Args:
            results ([AnalysisResultsRecord]):
