...
class LogSessionReferenceResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, model_id, alias, observatory_url, upload_url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            upload_timestamp (int): The time when the upload was completed. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, model_id, alias, observatory_url, upload_url, *args, **kwargs):  # noqa: E501
        """LogSessionReferenceResponse - a model defined in OpenAPI
