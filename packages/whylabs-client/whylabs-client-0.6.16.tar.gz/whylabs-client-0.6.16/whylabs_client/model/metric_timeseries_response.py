...
def lazy_import():
    ...
    globals()['MetricTimeseriesRecord'] = MetricTimeseriesRecord


class MetricTimeseriesResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([MetricTimeseriesRecord],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """MetricTimeseriesResponse - a model defined in OpenAPI

        Args:
            data ([MetricTimeseriesRecord]):
