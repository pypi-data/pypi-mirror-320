...
def lazy_import():
    ...
    globals()['KeyValueTag'] = KeyValueTag
...
class ModelMetadataResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, org_id, name, creation_time, time_period, model_category, tags, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, org_id, name, creation_time, time_period, model_category, tags, *args, **kwargs):  # noqa: E501
        """ModelMetadataResponse - a model defined in OpenAPI
