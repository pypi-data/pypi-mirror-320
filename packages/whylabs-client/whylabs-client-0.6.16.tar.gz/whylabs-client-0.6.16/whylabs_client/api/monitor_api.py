...
class MonitorApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_constraints_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/organizations/{org_id}/models/{dataset_id}/constraints',
                'operation_id': 'list_constraints',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_constraints(
        ...
        **kwargs
        ...
        """List the constraints for a given dataset.  # noqa: E501

        List the constraints for a given dataset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_constraints(org_id, dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['dataset_id'] = \
            dataset_id
        return self.list_constraints_endpoint.call_with_http_info(**kwargs)
