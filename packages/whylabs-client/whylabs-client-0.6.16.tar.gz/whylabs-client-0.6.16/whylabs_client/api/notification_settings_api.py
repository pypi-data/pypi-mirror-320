...
class NotificationSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_webhook_notification_action_payload_endpoint = _Endpoint(
            settings={
                'response_type': (WebhookNotificationAction,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/notification-settings/actions/webhook/payload',
                'operation_id': 'get_webhook_notification_action_payload',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_webhook_notification_action_payload(
        self,
        **kwargs
    ):
        """Get dummy notification action payload for webhooks  # noqa: E501

        Get dummy notification action payload for webhooks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_webhook_notification_action_payload(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_webhook_notification_action_payload_endpoint.call_with_http_info(**kwargs)
