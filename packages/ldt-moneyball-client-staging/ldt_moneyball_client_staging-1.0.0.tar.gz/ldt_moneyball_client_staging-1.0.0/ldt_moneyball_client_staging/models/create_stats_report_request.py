...
class CreateStatsReportRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["companies", "include_grouped_companies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateStatsReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateStatsReportRequest from a dict"""
        if obj is None:
            return None
