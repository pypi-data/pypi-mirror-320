...
class CreateAccessPolicyRequest(BaseModel):
    ...
    resource: Optional[List[Resource]] = Field(default=None, description="Used to assign accessible locations to the access policy.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAccessPolicyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAccessPolicyRequest from a dict"""
        if obj is None:
            return None
