...
class SystemLogs(BaseModel):
    ...
    SystemLogs
    """ # noqa: E501
    hits: Optional[List[SystemLog]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SystemLogs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SystemLogs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hits": [SystemLog.from_dict(_item) for _item in obj["hits"]] if obj.get("hits") is not None else None
        })
        return _obj
