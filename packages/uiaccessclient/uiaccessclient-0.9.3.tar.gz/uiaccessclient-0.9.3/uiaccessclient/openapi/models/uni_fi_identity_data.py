...
class UniFiIdentityData(BaseModel):
    """
    UniFiIdentityData
    """ # noqa: E501
    resources: Optional[Dict[str, UniFiIdentityResourceList]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UniFiIdentityData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UniFiIdentityData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resources": dict(
                (_k, UniFiIdentityResourceList.from_dict(_v))
