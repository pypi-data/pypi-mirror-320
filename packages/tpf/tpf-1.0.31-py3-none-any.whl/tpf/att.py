...
class MultiHead(nn.Module):
    ...
    def __init__(self, features=32):
        ...
        self.norm = nn.LayerNorm(normalized_shape=features, elementwise_affine=True)

        # Q 矩阵
        self.fc_Q = nn.Linear(features, features)
        # K 矩阵
        self.fc_K = nn.Linear(features, features)
        # V 矩阵
        self.fc_V = nn.Linear(features, features)


        self.out_fc = nn.Linear(features, features)
