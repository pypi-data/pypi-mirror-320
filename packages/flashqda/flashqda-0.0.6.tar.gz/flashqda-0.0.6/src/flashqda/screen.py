...
def initialize_files(file_name):
    ...
    # Ensure a results file exists or create an empty one
    results_file = os.path.join(results_path, file_name + "_screening.csv")
    ...
    log_file = os.path.join(results_path, file_name + "_screening_log.csv")
    ...
    temp_file = os.path.join(results_path, file_name + "_screening_temp.csv")
