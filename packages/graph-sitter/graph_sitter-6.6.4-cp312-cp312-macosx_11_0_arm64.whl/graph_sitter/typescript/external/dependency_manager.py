            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        # Set up yarn
                        logger.info(f"Running yarn install with cwd {self.full_path}")
                        ...
                        logger.error(f"yarn install failed with exit code {e.returncode}\nstdout: {e.stdout}\nstderr: {e.stderr}")
                        raise
                finally:
    ...
    def _install_dependencies_pnpm(self):
        ...
        with shadow_files(files_to_shadow):
            ...
            try:
                ...
                logger.error(f"pnpm install failed with exit code {e.returncode}\nstdout: {e.stdout}\nstderr: {e.stderr}")
                raise
