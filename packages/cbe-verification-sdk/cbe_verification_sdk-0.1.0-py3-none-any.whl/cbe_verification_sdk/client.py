...
class CBEVerificationClient:
    ...
    def _get_transaction_pdf(self, transaction_id: str) -> str:
        """
        ...
        try:
            # Construct CBE URL
            cbe_url = f"https://apps.cbe.com.et:100/?id={transaction_id}"
    ...
    def verify_transaction(self, reference_number: str, account_number: str) -> Dict:
        ...
        try:
            # Get PDF content
            pdf_data = self._get_transaction_pdf(reference_number)
