# --------------------------------------------------
# Name        : undouble_gui.py
# Author      : E.Taskesen
# Contact     : erdogant@gmail.com
# github      : https://github.com/erdogant/undouble_gui
...
def open_window(select_pathnames, savedir=None, action='move', overwrite=False, logger=None):
    ...
    for pathnames in select_pathnames:
        # print(pathnames)
...
class Gui:
    ...
    def create_widgets(self):
        ...
        self.mark_unselected_button = tkinter.Button(
            self.nav_frame,
