    ...
    def make_instance(self, include_optional) -> DbuiV1alpha1ObservableEventsList:
        ...
        if include_optional:
            return DbuiV1alpha1ObservableEventsList(
                cursor = '',
                items = [
                    asl_api.models.dbui_v1alpha1_observable_events_list_items_inner.dbui_v1alpha1_ObservableEventsList_items_inner(
                        from = 'notable', 
                        adjust_by = 1.337, 
                        notable = asl_api.models.dbui_v1alpha1_observable_events_list_items_inner_notable.dbui_v1alpha1_ObservableEventsList_items_inner_notable(
                            id = '', 
                            rule_name = '', 
                            summary = '', ), )
                    ]
