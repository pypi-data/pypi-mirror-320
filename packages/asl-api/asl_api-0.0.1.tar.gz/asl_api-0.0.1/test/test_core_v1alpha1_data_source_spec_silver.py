        ...
        if include_optional:
            return CoreV1alpha1DataSourceSpecSilver(
                ...
                transform = asl_api.models.core_v1alpha1_data_source_spec_silver_transform.core_v1alpha1_DataSourceSpec_silver_transform(
                    ...
                    filter = '', 
                    post_filter = '', 
                    preset_overrides = asl_api.models.core_v1alpha1_data_source_spec_silver_transform_preset_overrides.core_v1alpha1_DataSourceSpec_silver_transform_presetOverrides(
                        omit_fields = [
                            ''
                            ], 
