    ...
    def make_instance(self, include_optional) -> ContentV1alpha1MitreAttack:
        ...
        if include_optional:
            return ContentV1alpha1MitreAttack(
                tactics = [
                    asl_api.models.content/v1alpha1/mitre_tactic.content.v1alpha1.MitreTactic(
                        name = '', 
                        techniques = [
                            asl_api.models.content/v1alpha1/mitre_technique.content.v1alpha1.MitreTechnique(
                                identifier = '', 
                                name = '', 
                                subtechniques = [
                                    asl_api.models.content/v1alpha1/mitre_sub_technique.content.v1alpha1.MitreSubTechnique(
                                        identifier = '', 
                                        name = '', )
                                    ], )
                            ], )
