...
DB_ENCODER_POOL = "default_text"

# 日志分发规则
# 规则1：debug日志
DB_DEBUG_FILE_SUFFIX = ".debug"
DB_DEBUG_LEVELS = [logging.DEBUG]

# 规则2：trace、notice日志
DB_INFO_FILE_SUFFIX = ".info"
DB_INFO_LEVELS = [logging.INFO]

# 规则3：warning、error、fatal日志
# python中的fatal日志与go不同，不会退出程序，如果需要退出程序，需要raise
DB_WF_FILE_SUFFIX = ".wf"
DB_WF_LEVELS = [logging.WARNING, logging.ERROR, logging.FATAL]
