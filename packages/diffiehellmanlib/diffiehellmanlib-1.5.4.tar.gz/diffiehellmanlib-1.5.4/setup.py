...
setup(
    ...
    long_description_content_type="text/markdown",  # Указывает формат Markdown
    author='Konstantin Gorshkov',
    author_email='kostya_gorshkov_06@vk.com',
    url='https://github.com/kostya2023/diffie_hellman_lib',
    license='MIT',
    packages=find_packages(),
    package_data={"diffiehellmanlib" : ["diffiehellmanlib/libs/dif_helm_arm64.so", "diffiehellmanlib/libs/dif_helm_armv7.so", "diffiehellmanlib/libs/dif_helm_x64.dll", "diffiehellmanlib/libs/dif_helm_x64.so", "diffiehellmanlib/libs/dif_helm_x86.dll", "diffiehellmanlib/libs/dif_helm_x86.so", "diffiehellmanlib/libs/libcrypto-3-x64.dll", "diffiehellmanlib/libs/libcrypto-3.dll"]},
