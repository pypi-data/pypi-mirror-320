    ...
    def run(self):
        ...
        if system == "Windows":
            if arch in ["AMD64", "x86_64"]:
                libs = [
                    "diffiehellmanlib/libs/dif_helm_x64.dll",
                    "diffiehellmanlib/libs/libcrypto-3-x64.dll"
                ]
            elif arch in ["i386", "i686"]:
                libs = [
                    "diffiehellmanlib/libs/dif_helm_x86.dll",
                    "diffiehellmanlib/libs/libcrypto-3.dll"
                ]
            else:
        ...
        target_dir = os.path.join(self.install_lib, "libs")
