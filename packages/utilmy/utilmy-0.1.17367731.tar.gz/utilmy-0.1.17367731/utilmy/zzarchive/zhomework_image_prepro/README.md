...
### CI Github Action pylint, pytest, CLI testing
     ...
     Run :    https://github.com/arita37/zyrwerifsdhfsk/runs/2865296342?check_suite_focus=true
 
     Code :    https://github.com/arita37/zyrwerifsdhfsk/blob/k/.github/workflows/CI_build_release.yml


### CI Run on large scale >10k :

     Run :   https://github.com/arita37/zyrwerifsdhfsk/runs/2865251398?check_suite_focus=true

     Code :  https://github.com/arita37/zyrwerifsdhfsk/blob/k/.github/workflows/CI_test_deep.yml
...
tests/test_dataset.py::test_image_dataset_get_sampe PASSED               [ 17%]
tests/test_dataset.py::test_image_dataset_get_image_only PASSED          [ 23%]
tests/test_dataset.py::test_nlp_dataset_len PASSED                       [ 29%]
tests/test_import.py::test_import PASSED                                 [ 35%]
tests/test_pipeline.py::test_generate_phone_numbers PASSED               [ 41%]
tests/test_transform.py::test_chars_to_images_transform PASSED           [ 47%]
tests/test_transform.py::test_combine_images_horizontally_transform PASSED [ 52%]
tests/test_transform.py::test_scale_image_transform PASSED               [ 58%]
tests/test_transform.py::test_text_to_image_transform PASSED             [ 64%]
tests/test_util_image.py::test_image_merge PASSED                        [ 70%]
tests/test_util_image.py::test_image_remove_extra_padding PASSED         [ 76%]
tests/test_util_image.py::test_image_resize PASSED                       [ 82%]
tests/test_util_image.py::test_image_read PASSED                         [ 88%]
...
### Restrictions on params (to prevent overflow, mis-usage)
    ...
    (n_digits-1)*max_spacing   <= image_width  < n_digits* 200
