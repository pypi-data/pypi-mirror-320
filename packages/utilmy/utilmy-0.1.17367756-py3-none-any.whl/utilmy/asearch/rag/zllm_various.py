...
"""
### https://github.com/phunterlau/paper_without_code/blob/main/examples/rufus/rufus.py
### AMazon
https://arxiv.org/pdf/2407.18553



"""
if "amazon REAPER model":
    ...
    def get_reaper_prompt(tools):
        ...
        prompt = """You are an AI assistant for a retail store. Generate a single, 
        coherent step-by-step plan to retrieve information from the knowledge graph to answer customer questions. Use these tools:
