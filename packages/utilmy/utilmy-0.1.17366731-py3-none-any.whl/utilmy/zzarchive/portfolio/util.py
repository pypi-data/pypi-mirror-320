...
base_dir is path where we start archiving from; ie. base_dir will be the common prefix of all files and directories in the archive.
...
def os_folder_copy(src, dst, symlinks=False, pattern1="*.py", fun_file_toignore=None):
   '''
       ...
       'src' parameter, which is path being visited by copytree(), and
