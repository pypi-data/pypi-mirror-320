...
class XarrayTimelines(PlotSettingsMixin):
    ...
    def __init__(self, array, t='t', dims=None, *,
        ...
        self.skipna = skipna
        super().__init__(robust=robust, ymargin=ymargin, ybounds=ybounds, **kw_super)
        if plot:
            self.plot()
    ...
    def get_effective_data_interval(self, *, robust=UNSET):
        ...
        for dimsel, style in self.iter_dimpoints():
            ...
            vmin, vmax = calculate_vlims(to_plot, robust=robust)
    ...
    def plot(self, *, legend=UNSET, add_labels=True, robust=UNSET, ymargin=None, ybounds=UNSET, **kw_plot):
        ...
        for dimsel, style in self.iter_dimpoints():
            ...
            kw_plot_here = self.plot_settings.get_mpl_kwargs('plt.plot', **style, **kw_plot)
            # >> actually plot this line <<
            plt.plot(t_values, to_plot, label=label, **kw_plot_here)
        # formatting
