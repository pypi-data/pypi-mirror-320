...
class Map:
    ...
    def get_xy_from_normalized_global_d(self, d: float):
        ...
        """
        # To avoid rounding decimal errors I use the 'd'
        # even in the pair of coordinates to calculate the
        # X and Y I want.
    ...
    # Helpers below
    # TODO: Many helpers but they are not being used
    ...
    def _get_normalized_local_d_from_normalized_global_d(self, d: float):
        ...
        return d % (pair_of_coordinates_index * pair_of_coordinates_d) / pair_of_coordinates_d if pair_of_coordinates_index > 0 else d / pair_of_coordinates_d
    # Helpers above
    
    # TODO: This function below is no longer being used
    # def _get_x_from_normalized_global_d(self, d: float):
    #     """
    ...
    def plot(self):
        ...
        # Plotin is from bottom-left to top right, while moviepy
