...
class ValueNormalizer:
    ...
    def __init__(self, lower_limit: float, upper_limit: float):
        if lower_limit == upper_limit or lower_limit > upper_limit:
    ...
    def normalize(self, value: float, do_accept_outliers: bool = True):
        ...
        return (value - self.lower_limit) / (self.upper_limit - self.lower_limit)
    ...
    def denormalize(self, value: float, do_accept_outliers: bool = True):
        ...
        return self.lower_limit + value * (self.upper_limit - self.lower_limit)
    ...
    def to_range_value(self, value: float, new_range_lower_limit: float, new_range_upper_limit: float, do_accept_outliers: bool = True):
        ...
        return new_range_lower_limit + self.normalize(value) * (new_range_upper_limit - new_range_lower_limit)