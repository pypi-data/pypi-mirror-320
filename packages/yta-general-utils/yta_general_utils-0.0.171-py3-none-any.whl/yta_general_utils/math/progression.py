...
class Progression:
    ...
    """
    _rate_function: mRateFunction = None
    """
    ...
    def rate_function(self, value: mRateFunction):
        # TODO: Validate rate function

        self._values = None
        self._rate_function = value

    def __init__(self, start: float, end: float, n: int, rate_function: mRateFunction = mRateFunction.LINEAR):
    ...
    @staticmethod
    def get_n_normalized_values(n: int, rate_function: mRateFunction = mRateFunction.LINEAR):
        """
        ...
        return [
            rate_function.apply(normalized_value)
