...
def begin_benchmark(
    ...
    print("line 30, UTILS, Starting benchmark execution steps =", execution_steps)
    ...
    if "ollama_to_openrouter_evaluate" in execution_steps:
        print("line 107, UTILS, ollama_to_openrouter_evaluate == execution_steps", execution_steps)
...
class EQUATOR_Client(object):
        ...
        while True:
            ...
            for row in results:
                ...
                for student_model in student_models:
                    ...
                    print("line 247, UTILS Model Path  = ", model_path)
                    ...
                    print("line 257, UTILS, unpacking student answer = ", student_answer)
                    print("line 258, UTILS, unpacking evaluator  = ", evaluator_response)
    ...
    def student(self, model_path, full_prompt_student):
        ...
        print("line 292 ,UTILS, in Execution steps =", self.execution_steps)
        if "ollama_to_openrouter_evaluate" in self.execution_steps:
            ...
            print("line 302, UTILS , in Execution steps =", self.execution_steps)
            ...
            print("line 310, UTILS , in Execution steps =", self.execution_steps)

            response = call_groq_student_api(
                full_prompt_student, warning_prompt, self.student_model
            )
            print("line 315, UTILS, def student() = response ", response)
            return response

        elif "groq_to_openrouter_evaluate" in self.execution_steps:
            print("line 319, UTILS , in Execution steps =", self.execution_steps)

            response = call_openrouter_student_api(
                full_prompt_student, warning_prompt, model_path
            )
            print("line 324, UTILS,  = response ", response)
            return response
    ...
    def call_evaluator(self, model_path, prompt):
        ...
        print("line 343, UTILS, student_answer =", student_answer)
        ...
        if "ollama_to_groq_evaluate" in self.execution_steps:
            print("line 374, UTILS ollama_to_groq_evaluate = ", self.execution_steps )
        ...
        elif "groq_to_ollama_evaluate" in self.execution_steps or "groq_to_openrouter_evaluate" in self.execution_steps:
            print("line 382, UTILS ollama_to_groq_evaluate  or groq_to_openrouter_evaluate= ", self.execution_steps )
            ...
            print("line 390, UTILS ollama_to_openrouter_evaluate = ", self.execution_steps )
            student_answer, eval_response = call_ollama_evaluator_api(
                self.evaluator_model, student_answer, evaluator_system_prompt
            )
            return student_answer, eval_response
        elif "groq_to_openrouter_evaluate" in self.execution_steps:
            print("line 396, UTILS = groq_to_openrouter_evaluate ", self.execution_steps )
