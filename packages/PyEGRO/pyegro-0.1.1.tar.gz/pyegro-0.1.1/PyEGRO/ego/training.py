...
#             # Create final plots if dimension is suitable
#             if len(self.variable_names) <= 2:
#                 try:
...
#                     # Create the animation from saved frames
#                     create_optimization_animation(self.config.save_dir, frame_duration=1000)
#                     console.print("[green]✓ Animation created successfully[/green]")
