...
class BaseOSManager(ABC):
    ...
    def _check_python_version(self, pythonMajor, pythonMinor):
        # Specify the required version
        required_major = pythonMajor
        required_minor = pythonMinor
    ...
    # Public Method
    def initialize_dependencies(self, pythonMajor, pythonMinor):
        # Step 1: Check Python version
        self._check_python_version(pythonMajor, pythonMinor)
