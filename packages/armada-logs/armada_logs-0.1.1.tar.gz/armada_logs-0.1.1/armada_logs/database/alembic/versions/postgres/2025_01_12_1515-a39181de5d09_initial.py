...
Revision ID: a39181de5d09
Revises:
Create Date: 2025-01-12 15:15:09.670236
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_asset_users_email"), "asset_users", ["email"], unique=False)
    op.create_index("ix_asset_users_identity_search", "asset_users", ["email", "upn", "samaccountname"], unique=False)
    op.create_index(op.f("ix_asset_users_samaccountname"), "asset_users", ["samaccountname"], unique=False)
    op.create_index(op.f("ix_asset_users_upn"), "asset_users", ["upn"], unique=False)
    op.create_table(
        "credential_profiles",
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("description", sa.String(), nullable=True),
    ...
    op.create_index(op.f("ix_metrics_task_time"), "metrics_task", ["time"], unique=False)
    ...
    op.create_index(op.f("ix_metrics_activity_time"), "metrics_activity", ["time"], unique=False)
    op.create_index(op.f("ix_metrics_activity_user_id"), "metrics_activity", ["user_id"], unique=False)
...
def downgrade() -> None:
    op.drop_index(op.f("ix_metrics_activity_user_id"), table_name="metrics_activity")
    op.drop_index(op.f("ix_metrics_activity_time"), table_name="metrics_activity")
    ...
    op.drop_index(op.f("ix_metrics_task_time"), table_name="metrics_task")
    op.drop_table("metrics_task")
    op.drop_table("credential_profiles")
    op.drop_index(op.f("ix_asset_users_upn"), table_name="asset_users")
    op.drop_index(op.f("ix_asset_users_samaccountname"), table_name="asset_users")
    op.drop_index("ix_asset_users_identity_search", table_name="asset_users")
    op.drop_index(op.f("ix_asset_users_email"), table_name="asset_users")
