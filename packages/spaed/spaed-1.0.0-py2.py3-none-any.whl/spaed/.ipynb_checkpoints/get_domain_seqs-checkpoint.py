...
def parse_args():
    ...
    parser.add_argument('--fasta_path', type=float, help='Path to fasta file or folder containing fasta files. Make sure headers and/or file names correspond to entries in prediction file.', default=10)
    parser.add_argument('--output_path', type=float, help="Path to output file.", default="predicted_domain_seqs.faa")
    parser.add_argument('--mode', type=int, help='Whether to get sequences for predicted domains, linkers, or disordered regions. options: domains, linkers, disordered.', default="domains")
