...
def help() -> None:
    """Print help message."""
    CONSOLE_MANGAER.safe_print("Welcome to Snowflake Demos Library", color="cyan")
    CONSOLE_MANGAER.safe_print("Run the following in your interactive Python shell:\n", color="cyan")
    CONSOLE_MANGAER.safe_print("", color="cyan")
