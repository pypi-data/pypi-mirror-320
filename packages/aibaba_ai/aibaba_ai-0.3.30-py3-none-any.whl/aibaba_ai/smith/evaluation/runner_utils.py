...
from aibaba-ai-core.outputs import ChatResult, LLMResult
from aibaba-ai-core.runnables import Runnable, RunnableConfig, RunnableLambda
from aibaba-ai-core.runnables import config as runnable_config
from aibaba-ai-core.runnables import utils as runnable_utils
...
def _construct_run_evaluator(
    ...
    if isinstance(evaluator_, StringEvaluator):
        ...
        raise NotImplementedError(
            ...
            "\nSee: https://docs.aibaba.world/docs/guides/evaluation/string/"
        )
