...
from aibaba-ai-core.output_parsers import BaseLLMOutputParser
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aibaba.world/docs/how_to/qa_sources/#structure-sources-in-model-response"  # noqa: E501
    ),
)
