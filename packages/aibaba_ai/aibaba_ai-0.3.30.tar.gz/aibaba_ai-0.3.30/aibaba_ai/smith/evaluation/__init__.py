...
applications using Aibaba AI evaluators and LangSmith.
...
- ``arun_on_dataset``: Asynchronous function to evaluate a chain or other Aibaba AI component over a dataset.
- ``run_on_dataset``: Function to evaluate a chain or other Aibaba AI component over a dataset.
