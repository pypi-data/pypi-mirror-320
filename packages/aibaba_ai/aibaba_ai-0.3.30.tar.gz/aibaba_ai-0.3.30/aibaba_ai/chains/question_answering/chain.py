...
@deprecated(
    ...
    message=(
        ...
        "based on `chain_type`:\n"
        "stuff: https://docs.aibaba.world/docs/versions/migrating_chains/stuff_docs_chain\n"  # noqa: E501
        "map_reduce: https://docs.aibaba.world/docs/versions/migrating_chains/map_reduce_chain\n"  # noqa: E501
        "refine: https://docs.aibaba.world/docs/versions/migrating_chains/refine_chain\n"  # noqa: E501
        "map_rerank: https://docs.aibaba.world/docs/versions/migrating_chains/map_rerank_docs_chain\n"  # noqa: E501
        "\nSee also guides on retrieval and question-answering here: "
        "https://docs.aibaba.world/docs/how_to/#qa-with-rag"
    ),
)
def load_qa_chain(
    llm: BaseLanguageModel,
