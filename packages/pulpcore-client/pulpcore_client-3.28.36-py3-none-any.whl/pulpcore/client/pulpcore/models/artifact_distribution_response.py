...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, content_guard=None, base_path=None, name=None, pulp_created=None, hidden=False, base_url=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
