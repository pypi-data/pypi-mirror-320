...
class GHRSSTLevel4Granules(CMRGranuleSearcher):
    ...
    _Metadata = {
                 'AVHRR_OI-NCEI-L4-GLOB-v2.0':                {'CollectionConceptID': 'C2499940505-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'AVHRR_OI-NCEI-L4-GLOB-v2.1':                {'CollectionConceptID': 'C2036881712-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'CMC0.1deg-CMC-L4-GLOB-v3.0':                {'CollectionConceptID': 'C2036881720-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': True, 'IsGlobal': True, 'Shape': (1, 1801, 3600), 'CornerCoords': (None, -90., -180.), 'CoordIncrements': (1., 0.1, 0.1)},
                 'CMC0.2deg-CMC-L4-GLOB-v2.0':                {'CollectionConceptID': 'C2499940521-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': True, 'IsGlobal': True, 'Shape': (1, 901, 1800), 'CornerCoords': (None, -90., -180.), 'CoordIncrements': (1., 0.2, 0.2)},
                 'DMI_OI-DMI-L4-GLOB-v1.0':                   {'CollectionConceptID': 'C2036881727-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 3561, 7200), 'CornerCoords': (None, -89., -179.975), 'CoordIncrements': (1., 0.05, 0.05)},
                 'GAMSSA_28km-ABOM-L4-GLOB-v01':              {'CollectionConceptID': 'C2036881735-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'Geo_Polar_Blended-OSPO-L4-GLOB-v1.0':       {'CollectionConceptID': 'C2036877754-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 3600, 7200), 'CornerCoords': (None, -89.975, -179.975), 'CoordIncrements': (1., 0.05, 0.05)},
                 'Geo_Polar_Blended_Night-OSPO-L4-GLOB-v1.0': {'CollectionConceptID': 'C2036877745-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 3600, 7200), 'CornerCoords': (None, -89.975, -179.975), 'CoordIncrements': (1., 0.05, 0.05)},
                 'K10_SST-NAVO-L4-GLOB-v01':                  {'CollectionConceptID': 'C2036881956-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': True, 'IsGlobal': True, 'Shape': (1, 1801, 3600), 'CornerCoords': (None, -90., -180.), 'CoordIncrements': (1., 0.1, 0.1)},
                 'MUR-JPL-L4-GLOB-v4.1':                      {'CollectionConceptID': 'C1996881146-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 17999, 36000), 'CornerCoords': (None, -89.99, -179.99), 'CoordIncrements': (1., 0.01, 0.01)},
                 'MUR25-JPL-L4-GLOB-v04.2':                   {'CollectionConceptID': 'C2036880657-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'MW_IR_OI-REMSS-L4-GLOB-v5.0':               {'CollectionConceptID': 'C2036878045-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 2048, 4096), 'CornerCoords': (None, -90. + 360./4096/2, -180. + 360./4096/2), 'CoordIncrements': (1., 360./4096, 360./4096)},
                 'MW_IR_OI-REMSS-L4-GLOB-v5.1':               {'CollectionConceptID': 'C2205102254-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 2048, 4096), 'CornerCoords': (None, -90. + 360./4096/2, -180. + 360./4096/2), 'CoordIncrements': (1., 360./4096, 360./4096)},
                 'MW_OI-REMSS-L4-GLOB-v5.0':                  {'CollectionConceptID': 'C2036878052-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'MW_OI-REMSS-L4-GLOB-v5.1':                  {'CollectionConceptID': 'C2205105895-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 720, 1440), 'CornerCoords': (None, -89.875, -179.875), 'CoordIncrements': (1., 0.25, 0.25)},
                 'OISST_HR_NRT-GOS-L4-BLK-v2.0':              {'CollectionConceptID': 'C2036878059-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 162, 257), 'CornerCoords': (None, 38.75, 26.375), 'CoordIncrements': (1., 0.0625, 0.0625)},
                 'OISST_HR_NRT-GOS-L4-MED-v2.0':              {'CollectionConceptID': 'C2036878073-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 253, 871), 'CornerCoords': (None, 30.25, -18.125), 'CoordIncrements': (1., 0.0625, 0.0625)},
                 'OISST_UHR_NRT-GOS-L4-BLK-v2.0':             {'CollectionConceptID': 'C2036878081-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 1208, 1920), 'CornerCoords': (None, 38.75416666666667, 26.379166666666666), 'CoordIncrements': (1., 1/120., 1/120.)},
                 'OISST_UHR_NRT-GOS-L4-MED-v2.0':             {'CollectionConceptID': 'C2036878088-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 1890, 6525), 'CornerCoords': (None, 30.254166666666666, -18.120833333333334), 'CoordIncrements': (1., 1/120., 1/120.)},
                 'OSTIA-UKMO-L4-GLOB-REP-v2.0':               {'CollectionConceptID': 'C2586786218-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 3600, 7200), 'CornerCoords': (None, -89.975, -179.975), 'CoordIncrements': (1., 0.05, 0.05)},
                 'OSTIA-UKMO-L4-GLOB-v2.0':                   {'CollectionConceptID': 'C2036877535-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': True, 'Shape': (1, 3600, 7200), 'CornerCoords': (None, -89.975, -179.975), 'CoordIncrements': (1., 0.05, 0.05)},
                 'RAMSSA_09km-ABOM-L4-AUS-v01':               {'CollectionConceptID': 'C2036878103-POCLOUD', 'GDSVersion': 2, 'Protocol': 'dap4', 'ApplyMask': False, 'IsGlobal': False, 'Shape': (1, 1081, 1561), 'CornerCoords': (None, -70.+1/12./2, 60.+1/12./2), 'CoordIncrements': (1., 1/12., 1/12.)}}  # Note that we added +1/12./2 to the corner coords. It appears the netCDF coord variables contain the cell edge coordinates, rather than the center coordinates. Our CornerCoords variable needs to contain the center coords of the lower-left corner cell.
    ...
    def _ConstructFoundObjectForUrl(self, url, title, queryableAttributeValues):
        ...
        lazyPropertyValues={'SpatialReference': Dataset.ConvertSpatialReference('proj4', '+proj=latlong +ellps=WGS84 +datum=WGS84 +no_defs', 'obj'),
                            ...
                            'VariableNames': ['analysed_sst', 'analysis_error', 'mask', 'sea_ice_fraction']}

        if self._DatasetType == 'opendap':
            raise NotImplementedError('GHRSSTLevel4Granules does not currently support opendap datasets, but adding support is not difficult. Please contact the MGET development team for assistance.')
            lazyPropertyValues['VariableTypes'] = ['Grid', 'Grid', 'Grid', 'Grid']
