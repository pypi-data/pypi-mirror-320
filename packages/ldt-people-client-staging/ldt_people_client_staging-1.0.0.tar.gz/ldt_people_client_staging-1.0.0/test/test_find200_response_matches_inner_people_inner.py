...
class TestFind200ResponseMatchesInnerPeopleInner(unittest.TestCase):
    """Find200ResponseMatchesInnerPeopleInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Find200ResponseMatchesInnerPeopleInner:
        """Test Find200ResponseMatchesInnerPeopleInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Find200ResponseMatchesInnerPeopleInner`
        """
        model = Find200ResponseMatchesInnerPeopleInner()
        if include_optional:
            return Find200ResponseMatchesInnerPeopleInner(
                id = '',
                created_at = '',
    ...
    def testFind200ResponseMatchesInnerPeopleInner(self):
        """Test Find200ResponseMatchesInnerPeopleInner"""
