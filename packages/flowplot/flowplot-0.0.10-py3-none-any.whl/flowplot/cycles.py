...
def load_csv_output(simulation_file, delimiter=delimiter):
    Sim_df = pd.read_csv(
...
def cycle(filename, cellsize_m2=1000*1000, num_cells_domain=153451, margins=True, onlyCircle = False, onlyTypeFlows = False, delimiter=';'):
