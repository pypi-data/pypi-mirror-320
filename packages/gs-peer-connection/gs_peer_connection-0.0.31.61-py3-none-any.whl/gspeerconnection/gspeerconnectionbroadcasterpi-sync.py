...
class GSPeerConnectionBroadcasterPiCaller:
    def __init__(self, gsdbs, camera, oncommand=None):
    ...
    def startSocket(self):
        GSPeerConnectionBroadcasterPiSocket.create(self.sio,
                                                   self.gsdbs,
                                                   self.camera,
                                                   self.oncommand)
...
class GSPeerConnectionBroadcasterPiSocket:
    ...
    @classmethod
    async def create(cls, sio, gsdbs, camera, oncommand):
        ...
        async def watcher(id, description):
            ...
            async def on_connectionstatechange():
                ...
                if pc.connectionState == "failed":
                    self._logger.info("closeConnection")
                    await pc.close()
