...
setup(
    name="veeml",  # Ensure the name is unique on PyPI
    ...
    url="https://github.com/vishnupriya230604/vee.git",  # GitHub repo URL
    ...
    entry_points={
        "console_scripts": [
            "veeml=main:main",  # Replace `main` with your actual script/module name
        ]
    },
