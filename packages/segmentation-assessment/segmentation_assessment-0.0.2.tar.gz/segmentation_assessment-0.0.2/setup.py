...
setup(
    ...
    entry_points={"console_scripts":["assessment_with_ground_truth=segmentation_assessment:asessment_with_ground_truth","assessment_without_ground_truth=segmentation_assessment:assessment_without_ground_truth"]},
