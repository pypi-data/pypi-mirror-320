...
class ParityOSAuthError(RequestException):
    """
...
class ParityOSRunError(ParityOSException):
    """
    Exception resulting from errors in the run on the ParityOS cloud server.
    """
