...
from ark.core.bot.middleware import ListenDisconnectionMiddleware, LogIdMiddleware
from ark.core.client import Client, get_client_pool
from ark.core.idl.common_protocol import ArkError, RequestType, ResponseType
...
def _default_endpoint_config() -> Dict[str, Type[MaasChatRequest]]:
    return {"/api/v3/bots/chat/completions": MaasChatRequest}
...
class BotServer(BaseModel, Generic[RequestType, ResponseType]):
    ...
    async def handler(self, http_request: fastapi.Request) -> fastapi.Response:
        try:
        ...
        except errorsv3.APIException as e:
            raise HTTPException(
            ...
            err = errorsv3.InternalServiceError(str(e))
            raise HTTPException(
