...
@patch("thunder.auth.requests.get")
def test_login_success(mock_requests_get, temp_credentials_file, temp_config_file):
...
@patch("thunder.auth.requests.get")
def test_login_failure(mock_requests_get, temp_credentials_file, temp_config_file):
    from thunder.thunder import login
