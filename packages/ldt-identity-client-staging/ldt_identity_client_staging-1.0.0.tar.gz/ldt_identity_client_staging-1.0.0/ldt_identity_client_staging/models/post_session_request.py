...
class PostSessionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["grantType", "email", "password", "refreshToken", "clientId", "clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostSessionRequest from a dict"""
        if obj is None:
            return None
