...
class CreateServiceAccount200Response(BaseModel):
    """
    CreateServiceAccount200Response
    """ # noqa: E501
    service_account: ServiceAccount = Field(alias="serviceAccount")
    org: Org
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateServiceAccount200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateServiceAccount200Response from a dict"""
        if obj is None:
            return None
