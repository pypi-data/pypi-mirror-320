    ...
    def make_instance(self, include_optional) -> UpdateServiceAccountRoles200Response:
        ...
        if include_optional:
            return UpdateServiceAccountRoles200Response(
                service_account = ldt_identity_client_staging.models.update_service_account_roles_200_response_service_account.update_service_account_roles_200_response_serviceAccount(
                    id = '', 
                    name = '', 
                    created_at = '', 
