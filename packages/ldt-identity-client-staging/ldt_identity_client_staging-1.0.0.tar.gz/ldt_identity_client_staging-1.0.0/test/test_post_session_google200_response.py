    ...
    def make_instance(self, include_optional) -> PostSessionGoogle200Response:
        ...
        if include_optional:
            return PostSessionGoogle200Response(
                ...
                refresh_token = '',
                expires_at = '',
                user = ldt_identity_client_staging.models.user.user(
                    id = '', 
                    name = '', 
                    email = '', 
                    ...
                    source = '', ),
                orgs = [
                    ldt_identity_client_staging.models.post_session_google_200_response_orgs_inner.post_session_google_200_response_orgs_inner(
                        id = '', 
                        name = '', 
                        role = '', 
                        settings = ldt_identity_client_staging.models.settings.settings(), 
                        customer_id = '', 
                        contacts_count = '', 
                        status = '', 
                        created_at = '', )
                ...
                services = [
                    ldt_identity_client_staging.models.post_session_google_200_response_services_inner.post_session_google_200_response_services_inner(
                        id = '', 
                        name = '', 
                        role = '', 
                        created_at = '', )
