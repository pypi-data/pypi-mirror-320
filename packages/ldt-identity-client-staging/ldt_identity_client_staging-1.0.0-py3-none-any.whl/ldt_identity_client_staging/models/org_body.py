...
class OrgBody(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    settings: Optional[Dict[str, Any]] = Field(default=None, description="If not provided will default to empty settings '{}'")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrgBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrgBody from a dict"""
        if obj is None:
            return None
