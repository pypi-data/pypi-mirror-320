...
def fix_content_data(input_file, output_file):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Fix GeoJSON output from DGGRID")
    ...
    fix_content_data(args.input, output_file)
