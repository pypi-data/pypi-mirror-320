...
class SDDS:
    ...
    Important:
    -   Each SDDS object must be initialized with a unique index ranging 
        from 0 to 19. This index is required to manage the internal SDDS 
        library resources and ensure no conflicts between multiple SDDS 
        objects in the same program.
    -   Ensure that the index is released (if necessary) before reusing it.

    Attributes:
        index (int): The index of the SDDS dataset (integer from 0 to 19).
    ...
    def __init__(self, index):
        ...
        Args:
            index (int): Integer index of the SDDS object. Must be between 0 and 19 inclusive.
