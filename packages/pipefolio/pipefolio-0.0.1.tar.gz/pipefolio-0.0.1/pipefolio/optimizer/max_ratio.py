...
class MaxRatioOptimizer(OptimizerPipeMixin, BaseEstimator):
    ...
    def __init__(
        ...
        """Initializes the MaxRatioOptimizer with a MeanRisk model.

        Args:
            risk_metric: The risk metric to use.
            min_weights: The minimum weights.
            max_weights: The maximum weights.
        """
        self.model = MeanRisk(
            objective_function=OptimizeObjective.MAXIMIZE_RATIO.value,
    ...
    def fit(self, X: DataPlaceHolder, y=None) -> MeanRisk:
        ...
        Returns:
            The fitted MaxRatioOptimizer model.
        """
