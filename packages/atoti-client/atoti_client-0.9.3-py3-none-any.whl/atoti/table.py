...
from typing import TYPE_CHECKING, Any, Final, Literal, TypeAlias, final
...
class Table(HasIdentifier[TableIdentifier], KeyCompletable, ReprJsonable):
    ...
    def __iadd__(self, row: _Row, /) -> Self:
        dataframe = pd.DataFrame([row], columns=list(self))
        self.load(dataframe)
        return self
    ...
    def load(
        ...
        match data:
            ...
            case DataLoad():
                return self._java_api.load_data_into_table(
                    data,
                    scenario_name=self.scenario,
    ...
    async def load_async(
        ...
        Example:
            ...
            ...     assert table.row_count == 3, "df_3 should have overrode key `1` of df_1"
