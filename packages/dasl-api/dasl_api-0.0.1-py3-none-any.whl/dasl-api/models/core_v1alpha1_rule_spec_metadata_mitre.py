...
class CoreV1alpha1RuleSpecMetadataMitre(BaseModel):
    """
    CoreV1alpha1RuleSpecMetadataMitre
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadataMitre from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadataMitre from a dict"""
        if obj is None:
            return None
