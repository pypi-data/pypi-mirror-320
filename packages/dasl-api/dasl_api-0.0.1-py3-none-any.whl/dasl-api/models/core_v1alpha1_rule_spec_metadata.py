...
class CoreV1alpha1RuleSpecMetadata(BaseModel):
    ...
    mitre: Optional[CoreV1alpha1RuleSpecMetadataMitre] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mitre": CoreV1alpha1RuleSpecMetadataMitre.from_dict(obj["mitre"]) if obj.get("mitre") is not None else None,
