    ...
    def make_instance(self, include_optional) -> WorkspaceV1alpha1ServiceAccount:
        ...
        if include_optional:
            return WorkspaceV1alpha1ServiceAccount(
                ...
                spec = dasl-api.models.workspace/v1alpha1/service_account_spec.workspace.v1alpha1.ServiceAccountSpec(
                    hash = '', 
                    roles = [
                        ''
                        ], ),
                status = dasl-api.models.workspace/v1alpha1/service_account_status.workspace.v1alpha1.ServiceAccountStatus(
                    credentials = null, )
            )
        else:
            return WorkspaceV1alpha1ServiceAccount(
