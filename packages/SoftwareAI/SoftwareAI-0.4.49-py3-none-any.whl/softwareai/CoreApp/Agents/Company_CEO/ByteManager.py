...
class ByteManager:
    ...
    def AI_1_ByteManager_Company_Owners(self, 
        ...
        if 'solicitadoalgumcodigo' in teste_dict:
            ...
            repo_namewithorg = f"A-I-O-R-G/{repo_name}"
            ##Agent Destilation##                   
            ...
            resposta_do_tigrao_com_doc_pre_projeto = self.Pre_Project_Document.AI_1_Pre_Project_Document_Writer(appfb, client, pergunta_ao_tigrao, repo_namewithorg)#invoke_tigrao(pergunta_ao_tigrao)

            print(resposta_do_tigrao_com_doc_pre_projeto)

            Uploadfile = resposta_do_tigrao_com_doc_pre_projeto

            path_planilha_Projeto, path_nome_do_cronograma, path_name_doc_Pre_Projeto = self.Gerente_de_projeto.Bob_Gerente_de_projeto(appfb, client, Uploadfile, repo_namewithorg)
            
            path_Roadmap, cronograma_do_projeto, planilha, doc_Pre_Projeto = self.Equipe_De_Solucoes.Dallas_Equipe_De_Solucoes_Roadmap(appfb, client, path_nome_do_cronograma, path_planilha_Projeto, path_name_doc_Pre_Projeto, repo_namewithorg)
            ...
            anaysis_in_txt_path = self.Softwareanaysis.AI_SynthOperator(appfb, client, path_Roadmap, cronograma_do_projeto, planilha, doc_Pre_Projeto, repo_namewithorg)

            script_version_1_path = self.SoftwareDevelopment.AI_QuantumCore(
                    appfb, client, repo_namewithorg,
