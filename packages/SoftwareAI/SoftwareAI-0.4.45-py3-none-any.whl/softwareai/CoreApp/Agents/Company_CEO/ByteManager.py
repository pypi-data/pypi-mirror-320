...
class ByteManager:
    ...
    def AI_1_ByteManager_Company_Owners(self, 
        ...
        if 'solicitadoalgumcodigo' in teste_dict:
            ...
            ##Agent Destilation##                   
            Agent_destilation.DestilationResponseAgent(mensagemz, AI_ByteManager_response, instructionsassistant, nameassistant)
            ...
            mensaxgemrepositorio = f"""
            Realiza A criacao do repositorio no github
            repo_name:
            {repo_name}
            description:
            {repo_description}
