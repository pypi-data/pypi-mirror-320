...
class Pre_Project_Document:
    ...
    def AI_1_Pre_Project_Document_Writer(self, appfb, client, mensagem, repo_name):
        ...
        try:
            ...
            path_doc_Pre_Projeto_env = os.path.dirname(path_name_doc_Pre_Projeto) 

            path_pre_projeto = f"AppMap/PreProject/{path_doc_Pre_Projeto_env}"
            mensaxgem = f"""realize o upload do documento Pre-Projeto usando autoupload\n 
            ...
            """
            mensage3 = mensaxgem 
            responseupload, total_tokens, prompt_tokens, completion_tokens = ResponseAgent.ResponseAgent_message_with_assistants(
                                                                    mensagem=mensage3,
                                                                    agent_id=AI_Tigrao, 
                                                                    key=key,
                                                                    app1=appfb,
            ...
            ##Agent Destilation##                   
            Agent_destilation.DestilationResponseAgent(mensage3, responseupload, instructionsassistant, nameassistant)
