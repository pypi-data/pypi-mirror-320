...
class PublicClient:
    ...
    def _get(self, endpoint, params=None):
        ...
        print(f"Request URL: {response.url}")  # 打印請求的完整 URL
        print(f"Response Status Code: {response.status_code}")  # 打印回應的狀態碼
        ...
        if 200 <= response.status_code < 300:
            ...
            try:
                ...
                print(f"Response Data: {response_data}")  # 打印回應的 JSON 資料
                return response_data
            except ValueError:
                print("Response is not a valid JSON")  # 打印錯誤信息
