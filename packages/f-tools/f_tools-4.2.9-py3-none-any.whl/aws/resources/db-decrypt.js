...
const transactionKmsKey = process.env.TRANSACTION_KMS_KEY;
if (transactionKmsKey) {
    keyIds.push(transactionKmsKey)
}

const mainRegionFieldLevelKmsKeyArn = process.env.MAIN_REGION_FIELD_LEVEL_KMS_DATA_ENCRYPTION_ARN
if (mainRegionFieldLevelKmsKeyArn) {
    keyIds.push(mainRegionFieldLevelKmsKeyArn)
}
