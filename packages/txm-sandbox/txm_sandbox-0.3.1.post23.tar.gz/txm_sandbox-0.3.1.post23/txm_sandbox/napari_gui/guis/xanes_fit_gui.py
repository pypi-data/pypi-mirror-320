...
class xanes_fit_gui:
    ...
    def __xanes_gui_widgets_logic(self):
        if self._reg_done:
            ...
            if self._elem is not None:
                ...
                if self.analysis_type.value == "raw spectra - wl":
    ...
    def __set_xanes_gui_widgets(self):
        if self._reg_done:
            ...
            if self._elem is not None:
                ...
                self.analysis_type.value = "normalized spectra - wl"
                self.analysis_type.value = "raw spectra - wl"
                self.enabled = True
                self.spec_in_roi.enabled = True
                self.roi_cen_x.enabled = True
                self.roi_cen_y.enabled = True
                ...
                self.downsample_factor.enabled = False
    ...
    def _xanes_fit_type_chgd(self):
        ...
        elif self.analysis_type.value == "normalized spectra - wl":
            self.edge_eng.enabled = True
            self.edge_s.enabled = True
            self.edge_e.enabled = True
            _XANES_FIT_SAVE_ITEMS_CHOICES = [
        ...
        elif self.analysis_type.value == "normalized spectra - lcf":
    ...
    def _save_items_chgd(self):
        if (self.analysis_type.value == "normalized spectra - lcf"):
    ...
    def _xanes_fit(self):
        ...
        if self.analysis_type.value == "normalized spectra - wl":
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
        ...
        elif self.analysis_type.value == "raw spectra - wl":
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
                "edge50_fit_s"] = "None"
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
                "edge50_fit_e"] = "None"
            ...
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
                "wl_fit method"]["params"][
                    "eng_offset"] = (float(self.wl_s.value) + float(self.wl_e.value)) / 2.0
        elif (self.analysis_type.value == "normalized spectra - lcf") and self._lcf_ref_spec_set:
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
            ...
            xanes_proc_cfg["processed_XANES"]["proc_parameters"][
                "wl_fit method"]["params"][
                    "eng_offset"] = (float(self.wl_s.value) + float(self.wl_e.value)) / 2.0
        elif (self.analysis_type.value == "normalized spectra - lcf") and not self._lcf_ref_spec_set:
