...
from app.utils.exceptions import ErrorCode, CustomException
from app.utils.base_model import Base, BaseColumn
...
class DatabaseService:
    ...
    # 5. 쿼리 실행      #
    #######################
    async def create_log(self, log_data: Dict[str, Any], request: Request = None) -> None:
        """로그를 생성합니다.
        ...
        Returns:
            생성된 로그 엔티티
        """
        from app.user.models import UserLog
        ...
        return await self.create_entity(UserLog, log_data)
