...
class Element:
    ...
    def wait_invisible(
        ...
        try:
            return self.wait(timeout).until(
                ecex.invisibility_of_element(self._present_element, present),
    ...
    def wait_unclickable(
        ...
        try:
            return self.wait(timeout).until(
                ecex.element_to_be_unclickable(self._present_element, present),
    ...
    def app_drag_and_drop(
        ...
        """
        try:
            self.driver.drag_and_drop(self._present_element, target._present_element, pause)
        except ElementReferenceException:
    ...
    def app_scroll(self, target: Element, duration: int | None = None) -> Self:
        ...
        """
        try:
            self.driver.scroll(self._present_element, target._present_element, duration)
        except ElementReferenceException:
