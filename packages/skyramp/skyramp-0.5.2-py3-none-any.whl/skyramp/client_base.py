...
class _ClientBase:
    ...
    def send_scenario(
        ...
        until: List[str],
        load_config: _LoadTestConfig,
        dependencies_filepath: str,
        debug: bool=True
    ) -> TestStatus:
        """
        ...
        Args:
            ...
            load_config: The load test configuration
            dependencies_filepath: The path to the dependencies file
            debug: Whether to print debug information
        Returns:
            The status of the test
        """
        result = self.tester_start_v1(
            scenario,
            loadtest_config=load_config,
            dependencies_filepath=dependencies_filepath,
    ...
    def send_request(self,
        ...
        return ResponseV2(response)

    def deploy_dashboard(self, network_name: str) -> None:
        """
        Deploy dashboard services

        Args:
            network_name: The name of the network to deploy the dashboard services
        """

        # Check for Docker or Kubernetes
