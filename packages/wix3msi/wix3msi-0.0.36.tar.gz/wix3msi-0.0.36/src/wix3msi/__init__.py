...
from .wix3.wxs import BooleanAttribute, Component, ComponentGroup, ComponentGroupRef, ComponentRef, Condition, Content, CreateFolder, Custom, CustomAction,\
...
from .wix3 import BaseBuildProcess, LanguageCode, SimpleWXS, WXSDocument
