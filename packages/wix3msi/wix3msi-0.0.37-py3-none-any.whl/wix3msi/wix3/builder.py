...
from .languagecodetype import LanguageCodeType
...
class Builder:
	...
	__productLanguague: LanguageCodeType
	...
	#--------------------------------------------------------------------------------
	@property
	def ProductLaunguage(self) -> LanguageCodeType:
	...
	def ProductLaunguage(self, value: LanguageCodeType) -> None:
	...
	def __init__(self) -> None:
		...
		self.__productLanguague: LanguageCodeType = LanguageCodeType.ENGLISH