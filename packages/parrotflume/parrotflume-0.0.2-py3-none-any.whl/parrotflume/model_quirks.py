no_function_call = ["o1-preview"]  # supports no function calling at all
tool_call = ["deepseek-"]  # uses "tools" instead of "functions"
...
no_temperature = ["o1", "o3"]  # has no temperature setting
