...
def correctness(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.CORRECTNESS)(
        request=request,
        response=response,
...
def groundedness(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.GROUNDEDNESS)(
        request=request,
        response=response,
...
def safety(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.HARMFULNESS)(
        request=request,
        response=response,
    )
...
def relevance_to_query(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.RELEVANCE_TO_QUERY)(
        request=request,
        response=response,
    )
...
def chunk_relevance(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.CHUNK_RELEVANCE)(
        request=request,
        retrieved_context=retrieved_context,
    )
...
def context_sufficiency(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.CONTEXT_SUFFICIENCY)(
        request=request,
        retrieved_context=retrieved_context,
        expected_response=expected_response,
        expected_facts=expected_facts,
...
def guideline_adherence(
    ...
    """
    return CallableBuiltinJudge(config=assessment_config.GUIDELINE_ADHERENCE)(
        request=request,
        response=response,
