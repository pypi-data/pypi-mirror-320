...
class Validation:
    ...
    def __init__(self, account_id, license_key):    
    ...
    def activate_license(self, license_key):
        ...
        validation = requests.post(
            "https://api.keygen.sh/v1/accounts/{}/licenses/actions/validate-key".format(self.account_id),
            headers={
        ...
        activation = requests.post(
            "https://api.keygen.sh/v1/accounts/{}/machines".format(self.account_id),
            headers={
            "Authorization": "License {}".format(license_key),
            "Content-Type": "application/vnd.api+json",
            "Accept": "application/vnd.api+json"
