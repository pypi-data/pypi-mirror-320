...
class PwpInstallerUi(PwpGui):
    ...
    def from_python_to_ui(self):
        ...
        if self.installer.installer_version:
            ...
            self.installer_button['text'] = "re install" if self.installer.piwipre_exists else "install"
...
class Installer:
    ...
    def compute_default_values(self):
        ...
        installer = f"{self.piwipre_path}\\pwpInstaller.exe"
    ...
    def install_installer(self):
        ...
        self.build_lnk(installer_abs, installer_lnk, '--gui true')
        ...
        menu = self.get_menu()
        self.build_lnk(installer_abs, menu + '/pwpInstaller.lnk',
