...
Mind the **optional dependencies** for using deep learning models, built-in datasets or for development (see [pyproject.toml](https://github.com/OliverHennhoefer/unquad/blob/main/pyproject.toml)).
