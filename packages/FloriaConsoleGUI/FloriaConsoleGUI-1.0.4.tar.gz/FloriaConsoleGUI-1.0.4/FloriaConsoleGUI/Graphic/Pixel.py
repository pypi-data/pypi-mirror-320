...
class Pixels:
    f_white = Pixel(Vec3(255, 255, 255), None)
    b_white = Pixel(None, Vec3(255, 255, 255))
    f_green = Pixel(Vec3(0, 255, 0), None)
    b_green = Pixel(None, Vec3(0, 255, 0))
    f_gray = Pixel(Vec3(125, 125, 125), None)
    b_gray = Pixel(None, Vec3(125, 125, 125))
    f_black = Pixel(Vec3(0, 0, 0), None)
    b_black = Pixel(None, Vec3(0, 0, 0))
    f_red = Pixel(Vec3(255, 0, 0), None)
    b_red = Pixel(None, Vec3(255, 0, 0))
    f_blue = Pixel(Vec3(0, 0, 255), None)
    f_yellow = Pixel(Vec3(255, 255, 0), None)
