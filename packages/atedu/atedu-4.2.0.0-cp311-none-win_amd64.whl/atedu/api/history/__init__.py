...
from atedu.tframe.convertor import convert_internal_fq_to_atcore
from atedu.tframe.sysclsbase import gv
from atedu.tframe.ufuncs import (todict, todictmc, convert_str_or_datetime_to_int_date, check_target)
from atedu.tframe.language import text
from atedu.tframe.utils.datetimefunc import to_int_now_date
...
def get_trading_time(target_list: 'list',
    ...
    if gv.frequency_to_int(frequency) >= gv.KFreq_Day:
        d = np.arange(0, t.size, 1, dtype=np.int32)
    else:
        d -= 1
