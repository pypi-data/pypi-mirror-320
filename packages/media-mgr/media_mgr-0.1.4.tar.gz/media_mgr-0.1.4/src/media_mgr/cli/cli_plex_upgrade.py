...
from ..plex_upgrade import get_available_plex_server_package_name
from ..plex_upgrade import show_running_and_available_plex_server_versions
from ..plex_upgrade import download_new_plex_server_archive

from ..plex_upgrade import upgrade_plex_server, upgrade_all_plex_servers
    ...
    try:
        ...
        if args.cmd == 'show.avail.installer':
            ...
            download_new_plex_server_archive(ipv4 = args.ipv4,
                    downloadDir = args.dir, debug = args.debug)
