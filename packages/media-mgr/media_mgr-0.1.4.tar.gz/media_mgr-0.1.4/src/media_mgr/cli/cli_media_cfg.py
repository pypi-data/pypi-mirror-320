...
from ..media_cfg import MediaConfig, mediaCategoryLkup, colorTypeLkup
...
def cli():
    try:
        ...
        parser.add_argument('-d', '--debug', action="store_true", help='run with debug hooks enabled')
        ...
        exception_details(e, "Media Manager - Media Configuration CLI", raw=True)
