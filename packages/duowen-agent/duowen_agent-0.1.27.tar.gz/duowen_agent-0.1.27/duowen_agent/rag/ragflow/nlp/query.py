...
from duowen_agent.rag.ragflow.utils import MatchTextExpr, tradi2simp, strQ2B
...
if __name__ == "__main__":
    fq = FulltextQueryer(
        RagTokenizer(), TermWeightDealer(RagTokenizer()), SynonymDealer()
    )

    m, k = fq.question("武汉的昨天是几点")
    print(m.matching_text)
    print(k)
