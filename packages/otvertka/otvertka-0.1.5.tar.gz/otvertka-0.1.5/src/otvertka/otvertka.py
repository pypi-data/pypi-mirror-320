...
def get_table_info(table_name: str, database: str = "default") -> None:
    """
    ...
    partition_info = fetch_data(partition_query)
    pt(partition_info)

    describe_query = f"""describe table '{table_name}'"""

    describe_info = fetch_data(describe_query)
...
def handle_outliers(
    ...
    handling_method : str, optional
        ...
        - "drop": Remove rows containing outliers. Default is "replace_max".
