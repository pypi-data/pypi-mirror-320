...
def convert(*args, target: str = 'MESH', keep_original: bool = False, merge_customdata: bool = True, angle: float = 1.22173, thickness: int = 5, seams: bool = False, faces: bool = True, offset: float = 0.01) -> None:
