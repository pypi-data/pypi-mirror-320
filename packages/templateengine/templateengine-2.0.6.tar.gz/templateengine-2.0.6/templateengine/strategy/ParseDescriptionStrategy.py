...
class ParseDescriptionStrategy(CommonStrategy):
    _dependencyResolver: DependencyResolver = None
    params: InputParams = None

    def __init__(self):
        super().__init__()
        self._dependencyResolver.put("planner", Descriptor("templateengine-v2", "planner", "*", "parse-description", "1.0"))
    ...
    def set_goals(self):
        ...
        goal.set(self.params, 
                 (f"Parse the description, analyze the contents and tasks described inside. \n"
                  "Based on the description, create a new component, subcomponent or update existing component and fill the files with the necessary content.\n"
