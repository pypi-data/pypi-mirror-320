...
class RandomSampler:
    ...
    def __init__(self, video_clips: Union[List[np.ndarray], List[int]], max_clips_per_video: int, seed: int) -> None:
...
class UniformSampler:
    ...
    def __init__(self, video_clips: Union[List[np.ndarray], List[int]], num_clips_per_video: int) -> None:
