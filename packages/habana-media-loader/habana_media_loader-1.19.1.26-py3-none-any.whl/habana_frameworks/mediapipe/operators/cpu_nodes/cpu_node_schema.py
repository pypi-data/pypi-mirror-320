...
schema.add_operator_cpu("Reshape", "reshape",
                        1, 1, generic_in1_keys, 1, reshape_params, mpn.ReshapeParams_t, cpu_ops_node, dt.NDT)

schema.add_operator_cpu("FileLoader", "file_loader",
                        1, 1, generic_in1_keys, 1, empty_params, mpn.EmptyParams_t, cpu_ops_node, dt.STRING)
