...
class legacy:
    ...
    def run_hpu(self, pipeManager, input_list, input_type, rand_crp, is_crp_after_resize, vid_offset, resample_idx, host_buffer, bypass_host_buffers, out_dev_buffer_list, is_gather):
        """
